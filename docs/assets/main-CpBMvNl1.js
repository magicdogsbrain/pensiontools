 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oe(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Zf(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Oe())}function ep(){var n;const e=(n=fs())===null||n===void 0?void 0:n.forceEnvironment;if(e==="node")return!0;if(e==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function tp(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function np(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function rp(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function ip(){const n=Oe();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function sp(){return!ep()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function op(){try{return typeof indexedDB=="object"}catch{return!1}}function ap(){return new Promise((n,e)=>{try{let t=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),t||self.indexedDB.deleteDatabase(r),n(!0)},i.onupgradeneeded=()=>{t=!1},i.onerror=()=>{var s;e(((s=i.error)===null||s===void 0?void 0:s.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tt(n,...e){throw ia(n,...e)}function st(n,...e){return ia(n,...e)}function ra(n,e,t){const r=Object.assign(Object.assign({},bm()),{[e]:t});return new Kr("auth","Firebase",r).create(e,{appName:n.name})}function bt(n){return ra(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Sm(n,e,t){const r=t;if(!(e instanceof r))throw r.name!==e.constructor.name&&tt(n,"argument-error"),ra(n,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function ia(n,...e){if(typeof n!="string"){const t=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=n.name),n._errorFactory.create(t,...r)}return Uu.create(n,...e)}function q(n,e,...t){if(!n)throw ia(e,...t)}function wt(n){const e="INTERNAL ASSERTION FAILED: "+n;throw Oi(e),new Error(e)}function Rt(n,e){n||wt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Om(n,e){return pt(n,"POST","/v1/accounts:delete",e)}async function ju(n,e){return pt(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xi(n){var e;const t=n.auth,r=await n.getIdToken(),i=await Kn(n,ju(t,{idToken:r}));q(i==null?void 0:i.users.length,t,"internal-error");const s=i.users[0];n._notifyReloadListener(s);const a=!((e=s.providerUserInfo)===null||e===void 0)&&e.length?Hu(s.providerUserInfo):[],l=zm(n.providerData,a),u=n.isAnonymous,h=!(n.email&&s.passwordHash)&&!(l!=null&&l.length),f=u?h:!1,g={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:l,metadata:new Do(s.createdAt,s.lastLoginAt),isAnonymous:f};Object.assign(n,g)}async function Um(n){const e=me(n);await Xi(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function zm(n,e){return[...n.filter(r=>!e.some(i=>i.providerId===r.providerId)),...e]}function Hu(n){return n.map(e=>{var{providerId:t}=e,r=na(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){q(e.idToken,"internal-error"),q(typeof e.idToken<"u","internal-error"),q(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):yc(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){q(e.length!==0,"internal-error");const t=yc(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(q(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:r,refreshToken:i,expiresIn:s}=await $m(e,t);this.updateTokensAndExpiration(r,i,Number(s))}updateTokensAndExpiration(e,t,r){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,t){const{refreshToken:r,accessToken:i,expirationTime:s}=t,a=new zn;return r&&(q(typeof r=="string","internal-error",{appName:e}),a.refreshToken=r),i&&(q(typeof i=="string","internal-error",{appName:e}),a.accessToken=i),s&&(q(typeof s=="number","internal-error",{appName:e}),a.expirationTime=s),a}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new zn,this.toJSON())}_performRefresh(){return wt("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ec(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Qu(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Gu(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Ju(e))return"Blackberry";if(Zu(e))return"Webos";if(Yu(e))return"Safari";if((e.includes("chrome/")||Ku(e))&&!e.includes("edge/"))return"Chrome";if(Xu(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Gu(n=Oe()){return/firefox\//i.test(n)}function Yu(n=Oe()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Ku(n=Oe()){return/crios\//i.test(n)}function Qu(n=Oe()){return/iemobile/i.test(n)}function Xu(n=Oe()){return/android/i.test(n)}function Ju(n=Oe()){return/blackberry/i.test(n)}function Zu(n=Oe()){return/webos/i.test(n)}function aa(n=Oe()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function jm(n=Oe()){var e;return aa(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Hm(){return ip()&&document.documentMode===10}function ed(n=Oe()){return aa(n)||Xu(n)||Zu(n)||Ju(n)||/windows phone/i.test(n)||Qu(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function td(n,e=[]){let t;switch(n){case"Browser":t=Ec(Oe());break;case"Worker":t=`${Ec(Oe())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${rr}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gm(n,e={}){return pt(n,"GET","/v2/passwordPolicy",Dt(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ig(n,e){const t=ta(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),s=t.getOptions();if(Yi(s,e??{}))return i;tt(i,"already-initialized")}return t.initialize({options:e})}function sg(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(Tt);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function og(n,e,t){const r=Mt(n);q(r._canInitEmulator,r,"emulator-config-failed"),q(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,s=rd(e),{host:a,port:l}=ag(e),u=l===null?"":`:${l}`;r.config.emulator={url:`${s}//${a}${u}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:l,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})}),lg()}function rd(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function ag(n){const e=rd(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const s=i[1];return{host:s,port:Tc(r.substr(s.length+1))}}else{const[s,a]=r.split(":");return{host:s,port:Tc(a)}}}function Tc(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function lg(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class la{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return wt("not implemented")}_getIdTokenResponse(e){return wt("not implemented")}_linkToIdToken(e,t){return wt("not implemented")}_getReauthenticationResolver(e){return wt("not implemented")}}async function cg(n,e){return pt(n,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ug(n,e){return Jr(n,"POST","/v1/accounts:signInWithPassword",Dt(n,e))}async function dg(n,e){return pt(n,"POST","/v1/accounts:sendOobCode",Dt(n,e))}async function hg(n,e){return dg(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gg(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function yg(n){const e=Sr(Rr(n)).link,t=e?Sr(Rr(e)).deep_link_id:null,r=Sr(Rr(n)).deep_link_id;return(r?Sr(Rr(r)).link:null)||r||t||e||n}class ca{constructor(e){var t,r,i,s,a,l;const u=Sr(Rr(e)),h=(t=u.apiKey)!==null&&t!==void 0?t:null,f=(r=u.oobCode)!==null&&r!==void 0?r:null,g=gg((i=u.mode)!==null&&i!==void 0?i:null);q(h&&f&&g,"argument-error"),this.apiKey=h,this.operation=g,this.code=f,this.continueUrl=(s=u.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(a=u.languageCode)!==null&&a!==void 0?a:null,this.tenantId=(l=u.tenantId)!==null&&l!==void 0?l:null}static parseLink(e){const t=yg(e);try{return new ca(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Eg(n,e,t=!1){const{auth:r}=n;if(it(r.app))return Promise.reject(bt(r));const i="reauthenticate";try{const s=await Kn(n,id(r,i,e,n),t);q(s.idToken,r,"internal-error");const a=oa(s.idToken);q(a,r,"internal-error");const{sub:l}=a;return q(n.uid===l,r,"user-mismatch"),In._forOperation(n,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&tt(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sd(n,e,t=!1){if(it(n.app))return Promise.reject(bt(n));const r="signIn",i=await id(n,r,e),s=await In._fromIdTokenResponse(n,r,i);return t||await n._updateCurrentUser(s.user),s}async function wg(n,e){return sd(Mt(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function od(n){const e=Mt(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Ig(n,e,t){const r=Mt(n);await Ji(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",hg)}async function Tg(n,e,t){if(it(n.app))return Promise.reject(bt(n));const r=Mt(n),a=await Ji(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",vg).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&od(n),u}),l=await In._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(l.user),l}function bg(n,e,t){return it(n.app)?Promise.reject(bt(n)):wg(me(n),ir.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&od(n),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dd(){return typeof ct().WorkerGlobalScope<"u"&&typeof ct().importScripts=="function"}async function Lg(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Bg(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function Fg(){return dd()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function md(n,e){return e?Tt(e):(q(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gd{constructor(e,t,r,i,s=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:i,tenantId:s,error:a,type:l}=e;if(a){this.reject(a);return}const u={auth:this.auth,requestUri:t,sessionId:r,tenantId:s||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(u))}catch(h){this.reject(h)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Wg;case"linkViaPopup":case"linkViaRedirect":return Yg;case"reauthViaPopup":case"reauthViaRedirect":return Gg;default:tt(this.auth,"internal-error")}}resolve(e){Rt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Rt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hy=new Xr(3e4,6e4);function Pc(){const n=ct().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function fy(n){return new Promise((e,t)=>{var r,i,s;function a(){Pc(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Pc(),t(st(n,"network-request-failed"))},timeout:hy.get()})}if(!((i=(r=ct().gapi)===null||r===void 0?void 0:r.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((s=ct().gapi)===null||s===void 0)&&s.load)a();else{const l=eg("iframefcb");return ct()[l]=()=>{gapi.load?a():t(st(n,"network-request-failed"))},nd(`${Zm()}?onload=${l}`).catch(u=>t(u))}}).catch(e=>{throw Fi=null,e})}let Fi=null;function py(n){return Fi=Fi||fy(n),Fi}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cy="__/auth/handler",xy="emulator/auth/handler",ky=encodeURIComponent("fac");async function xc(n,e,t,r,i,s){q(n.config.authDomain,n,"auth-domain-config-required"),q(n.config.apiKey,n,"invalid-api-key");const a={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:rr,eventId:i};if(e instanceof ua){e.setDefaultLanguage(n.languageCode),a.providerId=e.providerId||"",dp(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,g]of Object.entries({}))a[f]=g}if(e instanceof Zr){const f=e.getScopes().filter(g=>g!=="");f.length>0&&(a.scopes=f.join(","))}n.tenantId&&(a.tid=n.tenantId);const l=a;for(const f of Object.keys(l))l[f]===void 0&&delete l[f];const u=await n._getAppCheckToken(),h=u?`#${ky}=${encodeURIComponent(u)}`:"";return`${Dy(n)}?${Qr(l).slice(1)}${h}`}function Dy({config:n}){return n.emulator?sa(n,xy):`https://${n.authDomain}/${Cy}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const po="webStorageSupport";class My{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=ud,this._completeRedirectFn=ry,this._overrideRedirectResult=ey}async _openPopup(e,t,r,i){var s;Rt((s=this.eventManagers[e._key()])===null||s===void 0?void 0:s.manager,"_initialize() not called before _openPopup()");const a=await xc(e,t,r,ko(),i);return Ry(e,a,da())}async _openRedirect(e,t,r,i){await this._originValidation(e);const s=await xc(e,t,r,ko(),i);return Og(s),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:i,promise:s}=this.eventManagers[t];return i?Promise.resolve(i):(Rt(s,"If manager is not set, promise should be"),s)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await wy(e),r=new sy(e);return t.register("authEvent",i=>(q(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:r.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(po,{type:po},i=>{var s;const a=(s=i==null?void 0:i[0])===null||s===void 0?void 0:s[po];a!==void 0&&t(!!a),tt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=uy(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return ed()||Yu()||aa()}}const Ny=My;var kc="@firebase/auth",Dc="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var yn,vd;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(E,m){function y(){}y.prototype=m.prototype,E.D=m.prototype,E.prototype=new y,E.prototype.constructor=E,E.C=function(w,I,A){for(var v=Array(arguments.length-2),Le=2;Le<arguments.length;Le++)v[Le-2]=arguments[Le];return m.prototype[I].apply(w,v)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,t),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(E,m,y){y||(y=0);var w=Array(16);if(typeof m=="string")for(var I=0;16>I;++I)w[I]=m.charCodeAt(y++)|m.charCodeAt(y++)<<8|m.charCodeAt(y++)<<16|m.charCodeAt(y++)<<24;else for(I=0;16>I;++I)w[I]=m[y++]|m[y++]<<8|m[y++]<<16|m[y++]<<24;m=E.g[0],y=E.g[1],I=E.g[2];var A=E.g[3],v=m+(A^y&(I^A))+w[0]+3614090360&4294967295;m=y+(v<<7&4294967295|v>>>25),v=A+(I^m&(y^I))+w[1]+3905402710&4294967295,A=m+(v<<12&4294967295|v>>>20),v=I+(y^A&(m^y))+w[2]+606105819&4294967295,I=A+(v<<17&4294967295|v>>>15),v=y+(m^I&(A^m))+w[3]+3250441966&4294967295,y=I+(v<<22&4294967295|v>>>10),v=m+(A^y&(I^A))+w[4]+4118548399&4294967295,m=y+(v<<7&4294967295|v>>>25),v=A+(I^m&(y^I))+w[5]+1200080426&4294967295,A=m+(v<<12&4294967295|v>>>20),v=I+(y^A&(m^y))+w[6]+2821735955&4294967295,I=A+(v<<17&4294967295|v>>>15),v=y+(m^I&(A^m))+w[7]+4249261313&4294967295,y=I+(v<<22&4294967295|v>>>10),v=m+(A^y&(I^A))+w[8]+1770035416&4294967295,m=y+(v<<7&4294967295|v>>>25),v=A+(I^m&(y^I))+w[9]+2336552879&4294967295,A=m+(v<<12&4294967295|v>>>20),v=I+(y^A&(m^y))+w[10]+4294925233&4294967295,I=A+(v<<17&4294967295|v>>>15),v=y+(m^I&(A^m))+w[11]+2304563134&4294967295,y=I+(v<<22&4294967295|v>>>10),v=m+(A^y&(I^A))+w[12]+1804603682&4294967295,m=y+(v<<7&4294967295|v>>>25),v=A+(I^m&(y^I))+w[13]+4254626195&4294967295,A=m+(v<<12&4294967295|v>>>20),v=I+(y^A&(m^y))+w[14]+2792965006&4294967295,I=A+(v<<17&4294967295|v>>>15),v=y+(m^I&(A^m))+w[15]+1236535329&4294967295,y=I+(v<<22&4294967295|v>>>10),v=m+(I^A&(y^I))+w[1]+4129170786&4294967295,m=y+(v<<5&4294967295|v>>>27),v=A+(y^I&(m^y))+w[6]+3225465664&4294967295,A=m+(v<<9&4294967295|v>>>23),v=I+(m^y&(A^m))+w[11]+643717713&4294967295,I=A+(v<<14&4294967295|v>>>18),v=y+(A^m&(I^A))+w[0]+3921069994&4294967295,y=I+(v<<20&4294967295|v>>>12),v=m+(I^A&(y^I))+w[5]+3593408605&4294967295,m=y+(v<<5&4294967295|v>>>27),v=A+(y^I&(m^y))+w[10]+38016083&4294967295,A=m+(v<<9&4294967295|v>>>23),v=I+(m^y&(A^m))+w[15]+3634488961&4294967295,I=A+(v<<14&4294967295|v>>>18),v=y+(A^m&(I^A))+w[4]+3889429448&4294967295,y=I+(v<<20&4294967295|v>>>12),v=m+(I^A&(y^I))+w[9]+568446438&4294967295,m=y+(v<<5&4294967295|v>>>27),v=A+(y^I&(m^y))+w[14]+3275163606&4294967295,A=m+(v<<9&4294967295|v>>>23),v=I+(m^y&(A^m))+w[3]+4107603335&4294967295,I=A+(v<<14&4294967295|v>>>18),v=y+(A^m&(I^A))+w[8]+1163531501&4294967295,y=I+(v<<20&4294967295|v>>>12),v=m+(I^A&(y^I))+w[13]+2850285829&4294967295,m=y+(v<<5&4294967295|v>>>27),v=A+(y^I&(m^y))+w[2]+4243563512&4294967295,A=m+(v<<9&4294967295|v>>>23),v=I+(m^y&(A^m))+w[7]+1735328473&4294967295,I=A+(v<<14&4294967295|v>>>18),v=y+(A^m&(I^A))+w[12]+2368359562&4294967295,y=I+(v<<20&4294967295|v>>>12),v=m+(y^I^A)+w[5]+4294588738&4294967295,m=y+(v<<4&4294967295|v>>>28),v=A+(m^y^I)+w[8]+2272392833&4294967295,A=m+(v<<11&4294967295|v>>>21),v=I+(A^m^y)+w[11]+1839030562&4294967295,I=A+(v<<16&4294967295|v>>>16),v=y+(I^A^m)+w[14]+4259657740&4294967295,y=I+(v<<23&4294967295|v>>>9),v=m+(y^I^A)+w[1]+2763975236&4294967295,m=y+(v<<4&4294967295|v>>>28),v=A+(m^y^I)+w[4]+1272893353&4294967295,A=m+(v<<11&4294967295|v>>>21),v=I+(A^m^y)+w[7]+4139469664&4294967295,I=A+(v<<16&4294967295|v>>>16),v=y+(I^A^m)+w[10]+3200236656&4294967295,y=I+(v<<23&4294967295|v>>>9),v=m+(y^I^A)+w[13]+681279174&4294967295,m=y+(v<<4&4294967295|v>>>28),v=A+(m^y^I)+w[0]+3936430074&4294967295,A=m+(v<<11&4294967295|v>>>21),v=I+(A^m^y)+w[3]+3572445317&4294967295,I=A+(v<<16&4294967295|v>>>16),v=y+(I^A^m)+w[6]+76029189&4294967295,y=I+(v<<23&4294967295|v>>>9),v=m+(y^I^A)+w[9]+3654602809&4294967295,m=y+(v<<4&4294967295|v>>>28),v=A+(m^y^I)+w[12]+3873151461&4294967295,A=m+(v<<11&4294967295|v>>>21),v=I+(A^m^y)+w[15]+530742520&4294967295,I=A+(v<<16&4294967295|v>>>16),v=y+(I^A^m)+w[2]+3299628645&4294967295,y=I+(v<<23&4294967295|v>>>9),v=m+(I^(y|~A))+w[0]+4096336452&4294967295,m=y+(v<<6&4294967295|v>>>26),v=A+(y^(m|~I))+w[7]+1126891415&4294967295,A=m+(v<<10&4294967295|v>>>22),v=I+(m^(A|~y))+w[14]+2878612391&4294967295,I=A+(v<<15&4294967295|v>>>17),v=y+(A^(I|~m))+w[5]+4237533241&4294967295,y=I+(v<<21&4294967295|v>>>11),v=m+(I^(y|~A))+w[12]+1700485571&4294967295,m=y+(v<<6&4294967295|v>>>26),v=A+(y^(m|~I))+w[3]+2399980690&4294967295,A=m+(v<<10&4294967295|v>>>22),v=I+(m^(A|~y))+w[10]+4293915773&4294967295,I=A+(v<<15&4294967295|v>>>17),v=y+(A^(I|~m))+w[1]+2240044497&4294967295,y=I+(v<<21&4294967295|v>>>11),v=m+(I^(y|~A))+w[8]+1873313359&4294967295,m=y+(v<<6&4294967295|v>>>26),v=A+(y^(m|~I))+w[15]+4264355552&4294967295,A=m+(v<<10&4294967295|v>>>22),v=I+(m^(A|~y))+w[6]+2734768916&4294967295,I=A+(v<<15&4294967295|v>>>17),v=y+(A^(I|~m))+w[13]+1309151649&4294967295,y=I+(v<<21&4294967295|v>>>11),v=m+(I^(y|~A))+w[4]+4149444226&4294967295,m=y+(v<<6&4294967295|v>>>26),v=A+(y^(m|~I))+w[11]+3174756917&4294967295,A=m+(v<<10&4294967295|v>>>22),v=I+(m^(A|~y))+w[2]+718787259&4294967295,I=A+(v<<15&4294967295|v>>>17),v=y+(A^(I|~m))+w[9]+3951481745&4294967295,E.g[0]=E.g[0]+m&4294967295,E.g[1]=E.g[1]+(I+(v<<21&4294967295|v>>>11))&4294967295,E.g[2]=E.g[2]+I&4294967295,E.g[3]=E.g[3]+A&4294967295}r.prototype.u=function(E,m){m===void 0&&(m=E.length);for(var y=m-this.blockSize,w=this.B,I=this.h,A=0;A<m;){if(I==0)for(;A<=y;)i(this,E,A),A+=this.blockSize;if(typeof E=="string"){for(;A<m;)if(w[I++]=E.charCodeAt(A++),I==this.blockSize){i(this,w),I=0;break}}else for(;A<m;)if(w[I++]=E[A++],I==this.blockSize){i(this,w),I=0;break}}this.h=I,this.o+=m},r.prototype.v=function(){var E=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);E[0]=128;for(var m=1;m<E.length-8;++m)E[m]=0;var y=8*this.o;for(m=E.length-8;m<E.length;++m)E[m]=y&255,y/=256;for(this.u(E),E=Array(16),m=y=0;4>m;++m)for(var w=0;32>w;w+=8)E[y++]=this.g[m]>>>w&255;return E};function s(E,m){var y=l;return Object.prototype.hasOwnProperty.call(y,E)?y[E]:y[E]=m(E)}function a(E,m){this.h=m;for(var y=[],w=!0,I=E.length-1;0<=I;I--){var A=E[I]|0;w&&A==m||(y[I]=A,w=!1)}this.g=y}var l={};function u(E){return-128<=E&&128>E?s(E,function(m){return new a([m|0],0>m?-1:0)}):new a([E|0],0>E?-1:0)}function h(E){if(isNaN(E)||!isFinite(E))return g;if(0>E)return P(h(-E));for(var m=[],y=1,w=0;E>=y;w++)m[w]=E/y|0,y*=4294967296;return new a(m,0)}function f(E,m){if(E.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(E.charAt(0)=="-")return P(f(E.substring(1),m));if(0<=E.indexOf("-"))throw Error('number format error: interior "-" character');for(var y=h(Math.pow(m,8)),w=g,I=0;I<E.length;I+=8){var A=Math.min(8,E.length-I),v=parseInt(E.substring(I,I+A),m);8>A?(A=h(Math.pow(m,A)),w=w.j(A).add(h(v))):(w=w.j(y),w=w.add(h(v)))}return w}var g=u(0),_=u(1),T=u(16777216);n=a.prototype,n.m=function(){if(D(this))return-P(this).m();for(var E=0,m=1,y=0;y<this.g.length;y++){var w=this.i(y);E+=(0<=w?w:4294967296+w)*m,m*=4294967296}return E},n.toString=function(E){if(E=E||10,2>E||36<E)throw Error("radix out of range: "+E);if(R(this))return"0";if(D(this))return"-"+P(this).toString(E);for(var m=h(Math.pow(E,6)),y=this,w="";;){var I=B(y,m).g;y=C(y,I.j(m));var A=((0<y.g.length?y.g[0]:y.h)>>>0).toString(E);if(y=I,R(y))return A+w;for(;6>A.length;)A="0"+A;w=A+w}},n.i=function(E){return 0>E?0:E<this.g.length?this.g[E]:this.h};function R(E){if(E.h!=0)return!1;for(var m=0;m<E.g.length;m++)if(E.g[m]!=0)return!1;return!0}function D(E){return E.h==-1}n.l=function(E){return E=C(this,E),D(E)?-1:R(E)?0:1};function P(E){for(var m=E.g.length,y=[],w=0;w<m;w++)y[w]=~E.g[w];return new a(y,~E.h).add(_)}n.abs=function(){return D(this)?P(this):this},n.add=function(E){for(var m=Math.max(this.g.length,E.g.length),y=[],w=0,I=0;I<=m;I++){var A=w+(this.i(I)&65535)+(E.i(I)&65535),v=(A>>>16)+(this.i(I)>>>16)+(E.i(I)>>>16);w=v>>>16,A&=65535,v&=65535,y[I]=v<<16|A}return new a(y,y[y.length-1]&-2147483648?-1:0)};function C(E,m){return E.add(P(m))}n.j=function(E){if(R(this)||R(E))return g;if(D(this))return D(E)?P(this).j(P(E)):P(P(this).j(E));if(D(E))return P(this.j(P(E)));if(0>this.l(T)&&0>E.l(T))return h(this.m()*E.m());for(var m=this.g.length+E.g.length,y=[],w=0;w<2*m;w++)y[w]=0;for(w=0;w<this.g.length;w++)for(var I=0;I<E.g.length;I++){var A=this.i(w)>>>16,v=this.i(w)&65535,Le=E.i(I)>>>16,Ge=E.i(I)&65535;y[2*w+2*I]+=v*Ge,x(y,2*w+2*I),y[2*w+2*I+1]+=A*Ge,x(y,2*w+2*I+1),y[2*w+2*I+1]+=v*Le,x(y,2*w+2*I+1),y[2*w+2*I+2]+=A*Le,x(y,2*w+2*I+2)}for(w=0;w<m;w++)y[w]=y[2*w+1]<<16|y[2*w];for(w=m;w<2*m;w++)y[w]=0;return new a(y,0)};function x(E,m){for(;(E[m]&65535)!=E[m];)E[m+1]+=E[m]>>>16,E[m]&=65535,m++}function M(E,m){this.g=E,this.h=m}function B(E,m){if(R(m))throw Error("division by zero");if(R(E))return new M(g,g);if(D(E))return m=B(P(E),m),new M(P(m.g),P(m.h));if(D(m))return m=B(E,P(m)),new M(P(m.g),m.h);if(30<E.g.length){if(D(E)||D(m))throw Error("slowDivide_ only works with positive integers.");for(var y=_,w=m;0>=w.l(E);)y=G(y),w=G(w);var I=z(y,1),A=z(w,1);for(w=z(w,2),y=z(y,2);!R(w);){var v=A.add(w);0>=v.l(E)&&(I=I.add(y),A=v),w=z(w,1),y=z(y,1)}return m=C(E,I.j(m)),new M(I,m)}for(I=g;0<=E.l(m);){for(y=Math.max(1,Math.floor(E.m()/m.m())),w=Math.ceil(Math.log(y)/Math.LN2),w=48>=w?1:Math.pow(2,w-48),A=h(y),v=A.j(m);D(v)||0<v.l(E);)y-=w,A=h(y),v=A.j(m);R(A)&&(A=_),I=I.add(A),E=C(E,v)}return new M(I,E)}n.A=function(E){return B(this,E).h},n.and=function(E){for(var m=Math.max(this.g.length,E.g.length),y=[],w=0;w<m;w++)y[w]=this.i(w)&E.i(w);return new a(y,this.h&E.h)},n.or=function(E){for(var m=Math.max(this.g.length,E.g.length),y=[],w=0;w<m;w++)y[w]=this.i(w)|E.i(w);return new a(y,this.h|E.h)},n.xor=function(E){for(var m=Math.max(this.g.length,E.g.length),y=[],w=0;w<m;w++)y[w]=this.i(w)^E.i(w);return new a(y,this.h^E.h)};function G(E){for(var m=E.g.length+1,y=[],w=0;w<m;w++)y[w]=E.i(w)<<1|E.i(w-1)>>>31;return new a(y,E.h)}function z(E,m){var y=m>>5;m%=32;for(var w=E.g.length-y,I=[],A=0;A<w;A++)I[A]=0<m?E.i(A+y)>>>m|E.i(A+y+1)<<32-m:E.i(A+y);return new a(I,E.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,vd=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=h,a.fromString=f,yn=a}).apply(typeof Nc<"u"?Nc:typeof self<"u"?self:typeof window<"u"?window:{});var ki=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var _d,Pr,Ed,Ui,No,wd,Id,Td;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(o,c,d){return o==Array.prototype||o==Object.prototype||(o[c]=d.value),o};function t(o){o=[typeof globalThis=="object"&&globalThis,o,typeof window=="object"&&window,typeof self=="object"&&self,typeof ki=="object"&&ki];for(var c=0;c<o.length;++c){var d=o[c];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var r=t(this);function i(o,c){if(c)e:{var d=r;o=o.split(".");for(var p=0;p<o.length-1;p++){var b=o[p];if(!(b in d))break e;d=d[b]}o=o[o.length-1],p=d[o],c=c(p),c!=p&&c!=null&&e(d,o,{configurable:!0,writable:!0,value:c})}}function s(o,c){o instanceof String&&(o+="");var d=0,p=!1,b={next:function(){if(!p&&d<o.length){var S=d++;return{value:c(S,o[S]),done:!1}}return p=!0,{done:!0,value:void 0}}};return b[Symbol.iterator]=function(){return b},b}i("Array.prototype.values",function(o){return o||function(){return s(this,function(c,d){return d})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var a=a||{},l=this||self;function u(o){var c=typeof o;return c=c!="object"?c:o?Array.isArray(o)?"array":c:"null",c=="array"||c=="object"&&typeof o.length=="number"}function h(o){var c=typeof o;return c=="object"&&o!=null||c=="function"}function f(o,c,d){return o.call.apply(o.bind,arguments)}function g(o,c,d){if(!o)throw Error();if(2<arguments.length){var p=Array.prototype.slice.call(arguments,2);return function(){var b=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(b,p),o.apply(c,b)}}return function(){return o.apply(c,arguments)}}function _(o,c,d){return _=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?f:g,_.apply(null,arguments)}function T(o,c){var d=Array.prototype.slice.call(arguments,1);return function(){var p=d.slice();return p.push.apply(p,arguments),o.apply(this,p)}}function R(o,c){function d(){}d.prototype=c.prototype,o.aa=c.prototype,o.prototype=new d,o.prototype.constructor=o,o.Qb=function(p,b,S){for(var V=Array(arguments.length-2),ne=2;ne<arguments.length;ne++)V[ne-2]=arguments[ne];return c.prototype[b].apply(p,V)}}function D(o){const c=o.length;if(0<c){const d=Array(c);for(let p=0;p<c;p++)d[p]=o[p];return d}return[]}function P(o,c){for(let d=1;d<arguments.length;d++){const p=arguments[d];if(u(p)){const b=o.length||0,S=p.length||0;o.length=b+S;for(let V=0;V<S;V++)o[b+V]=p[V]}else o.push(p)}}class C{constructor(c,d){this.i=c,this.j=d,this.h=0,this.g=null}get(){let c;return 0<this.h?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function x(o){return/^[\s\xa0]*$/.test(o)}function M(){var o=l.navigator;return o&&(o=o.userAgent)?o:""}function B(o){return B[" "](o),o}B[" "]=function(){};var G=M().indexOf("Gecko")!=-1&&!(M().toLowerCase().indexOf("webkit")!=-1&&M().indexOf("Edge")==-1)&&!(M().indexOf("Trident")!=-1||M().indexOf("MSIE")!=-1)&&M().indexOf("Edge")==-1;function z(o,c,d){for(const p in o)c.call(d,o[p],p,o)}function E(o,c){for(const d in o)c.call(void 0,o[d],d,o)}function m(o){const c={};for(const d in o)c[d]=o[d];return c}const y="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function w(o,c){let d,p;for(let b=1;b<arguments.length;b++){p=arguments[b];for(d in p)o[d]=p[d];for(let S=0;S<y.length;S++)d=y[S],Object.prototype.hasOwnProperty.call(p,d)&&(o[d]=p[d])}}function I(o){var c=1;o=o.split(":");const d=[];for(;0<c&&o.length;)d.push(o.shift()),c--;return o.length&&d.push(o.join(":")),d}function A(o){l.setTimeout(()=>{throw o},0)}function v(){var o=de;let c=null;return o.g&&(c=o.g,o.g=o.g.next,o.g||(o.h=null),c.next=null),c}class Le{constructor(){this.h=this.g=null}add(c,d){const p=Ge.get();p.set(c,d),this.h?this.h.next=p:this.g=p,this.h=p}}var Ge=new C(()=>new an,o=>o.reset());class an{constructor(){this.next=this.g=this.h=null}set(c,d){this.h=c,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let nt,ue=!1,de=new Le,at=()=>{const o=l.Promise.resolve(void 0);nt=()=>{o.then(Ye)}};var Ye=()=>{for(var o;o=v();){try{o.h.call(o.g)}catch(d){A(d)}var c=Ge;c.j(o),100>c.h&&(c.h++,o.next=c.g,c.g=o)}ue=!1};function Ce(){this.s=this.s,this.C=this.C}Ce.prototype.s=!1,Ce.prototype.ma=function(){this.s||(this.s=!0,this.N())},Ce.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function te(o,c){this.type=o,this.g=this.target=c,this.defaultPrevented=!1}te.prototype.h=function(){this.defaultPrevented=!0};var Ke=function(){if(!l.addEventListener||!Object.defineProperty)return!1;var o=!1,c=Object.defineProperty({},"passive",{get:function(){o=!0}});try{const d=()=>{};l.addEventListener("test",d,c),l.removeEventListener("test",d,c)}catch{}return o}();function xe(o,c){if(te.call(this,o?o.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,o){var d=this.type=o.type,p=o.changedTouches&&o.changedTouches.length?o.changedTouches[0]:null;if(this.target=o.target||o.srcElement,this.g=c,c=o.relatedTarget){if(G){e:{try{B(c.nodeName);var b=!0;break e}catch{}b=!1}b||(c=null)}}else d=="mouseover"?c=o.fromElement:d=="mouseout"&&(c=o.toElement);this.relatedTarget=c,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=o.clientX!==void 0?o.clientX:o.pageX,this.clientY=o.clientY!==void 0?o.clientY:o.pageY,this.screenX=o.screenX||0,this.screenY=o.screenY||0),this.button=o.button,this.key=o.key||"",this.ctrlKey=o.ctrlKey,this.altKey=o.altKey,this.shiftKey=o.shiftKey,this.metaKey=o.metaKey,this.pointerId=o.pointerId||0,this.pointerType=typeof o.pointerType=="string"?o.pointerType:re[o.pointerType]||"",this.state=o.state,this.i=o,o.defaultPrevented&&xe.aa.h.call(this)}}R(xe,te);var re={2:"touch",3:"pen",4:"mouse"};xe.prototype.h=function(){xe.aa.h.call(this);var o=this.i;o.preventDefault?o.preventDefault():o.returnValue=!1};var Be="closure_listenable_"+(1e6*Math.random()|0),Fe=0;function ve(o,c,d,p,b){this.listener=o,this.proxy=null,this.src=c,this.type=d,this.capture=!!p,this.ha=b,this.key=++Fe,this.da=this.fa=!1}function Ie(o){o.da=!0,o.listener=null,o.proxy=null,o.src=null,o.ha=null}function mt(o){this.src=o,this.g={},this.h=0}mt.prototype.add=function(o,c,d,p,b){var S=o.toString();o=this.g[S],o||(o=this.g[S]=[],this.h++);var V=Pn(o,c,p,b);return-1<V?(c=o[V],d||(c.fa=!1)):(c=new ve(c,this.src,S,!!p,b),c.fa=d,o.push(c)),c};function ln(o,c){var d=c.type;if(d in o.g){var p=o.g[d],b=Array.prototype.indexOf.call(p,c,void 0),S;(S=0<=b)&&Array.prototype.splice.call(p,b,1),S&&(Ie(c),o.g[d].length==0&&(delete o.g[d],o.h--))}}function Pn(o,c,d,p){for(var b=0;b<o.length;++b){var S=o[b];if(!S.da&&S.listener==c&&S.capture==!!d&&S.ha==p)return b}return-1}var gt="closure_lm_"+(1e6*Math.random()|0),Cn={};function yt(o,c,d,p,b){if(Array.isArray(c)){for(var S=0;S<c.length;S++)yt(o,c[S],d,p,b);return null}return d=cn(d),o&&o[Be]?o.K(c,d,h(p)?!!p.capture:!1,b):xn(o,c,d,!1,p,b)}function xn(o,c,d,p,b,S){if(!c)throw Error("Invalid event type");var V=h(b)?!!b.capture:!!b,ne=le(o);if(ne||(o[gt]=ne=new mt(o)),d=ne.add(c,d,p,V,S),d.proxy)return d;if(p=di(),d.proxy=p,p.src=o,p.listener=d,o.addEventListener)Ke||(b=V),b===void 0&&(b=!1),o.addEventListener(c.toString(),p,b);else if(o.attachEvent)o.attachEvent(Ue(c.toString()),p);else if(o.addListener&&o.removeListener)o.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return d}function di(){function o(d){return c.call(o.src,o.listener,d)}const c=hi;return o}function Z(o,c,d,p,b){if(Array.isArray(c))for(var S=0;S<c.length;S++)Z(o,c[S],d,p,b);else p=h(p)?!!p.capture:!!p,d=cn(d),o&&o[Be]?(o=o.i,c=String(c).toString(),c in o.g&&(S=o.g[c],d=Pn(S,d,p,b),-1<d&&(Ie(S[d]),Array.prototype.splice.call(S,d,1),S.length==0&&(delete o.g[c],o.h--)))):o&&(o=le(o))&&(c=o.g[c.toString()],o=-1,c&&(o=Pn(c,d,p,b)),(d=-1<o?c[o]:null)&&_e(d))}function _e(o){if(typeof o!="number"&&o&&!o.da){var c=o.src;if(c&&c[Be])ln(c.i,o);else{var d=o.type,p=o.proxy;c.removeEventListener?c.removeEventListener(d,p,o.capture):c.detachEvent?c.detachEvent(Ue(d),p):c.addListener&&c.removeListener&&c.removeListener(p),(d=le(c))?(ln(d,o),d.h==0&&(d.src=null,c[gt]=null)):Ie(o)}}}function Ue(o){return o in Cn?Cn[o]:Cn[o]="on"+o}function hi(o,c){if(o.da)o=!0;else{c=new xe(c,this);var d=o.listener,p=o.ha||o.src;o.fa&&_e(o),o=d.call(p,c)}return o}function le(o){return o=o[gt],o instanceof mt?o:null}var Nt="__closure_events_fn_"+(1e9*Math.random()>>>0);function cn(o){return typeof o=="function"?o:(o[Nt]||(o[Nt]=function(c){return o.handleEvent(c)}),o[Nt])}function he(){Ce.call(this),this.i=new mt(this),this.M=this,this.F=null}R(he,Ce),he.prototype[Be]=!0,he.prototype.removeEventListener=function(o,c,d,p){Z(this,o,c,d,p)};function Te(o,c){var d,p=o.F;if(p)for(d=[];p;p=p.F)d.push(p);if(o=o.M,p=c.type||c,typeof c=="string")c=new te(c,o);else if(c instanceof te)c.target=c.target||o;else{var b=c;c=new te(p,o),w(c,b)}if(b=!0,d)for(var S=d.length-1;0<=S;S--){var V=c.g=d[S];b=kn(V,p,!0,c)&&b}if(V=c.g=o,b=kn(V,p,!0,c)&&b,b=kn(V,p,!1,c)&&b,d)for(S=0;S<d.length;S++)V=c.g=d[S],b=kn(V,p,!1,c)&&b}he.prototype.N=function(){if(he.aa.N.call(this),this.i){var o=this.i,c;for(c in o.g){for(var d=o.g[c],p=0;p<d.length;p++)Ie(d[p]);delete o.g[c],o.h--}}this.F=null},he.prototype.K=function(o,c,d,p){return this.i.add(String(o),c,!1,d,p)},he.prototype.L=function(o,c,d,p){return this.i.add(String(o),c,!0,d,p)};function kn(o,c,d,p){if(c=o.i.g[String(c)],!c)return!0;c=c.concat();for(var b=!0,S=0;S<c.length;++S){var V=c[S];if(V&&!V.da&&V.capture==d){var ne=V.listener,be=V.ha||V.src;V.fa&&ln(o.i,V),b=ne.call(be,p)!==!1&&b}}return b&&!p.defaultPrevented}function fi(o,c,d){if(typeof o=="function")d&&(o=_(o,d));else if(o&&typeof o.handleEvent=="function")o=_(o.handleEvent,o);else throw Error("Invalid listener argument");return 2147483647<Number(c)?-1:l.setTimeout(o,c||0)}function dl(o){o.g=fi(()=>{o.g=null,o.i&&(o.i=!1,dl(o))},o.l);const c=o.h;o.h=null,o.m.apply(null,c)}class lf extends Ce{constructor(c,d){super(),this.m=c,this.l=d,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:dl(this)}N(){super.N(),this.g&&(l.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function dr(o){Ce.call(this),this.h=o,this.g={}}R(dr,Ce);var hl=[];function fl(o){z(o.g,function(c,d){this.g.hasOwnProperty(d)&&_e(c)},o),o.g={}}dr.prototype.N=function(){dr.aa.N.call(this),fl(this)},dr.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var js=l.JSON.stringify,cf=l.JSON.parse,uf=class{stringify(o){return l.JSON.stringify(o,void 0)}parse(o){return l.JSON.parse(o,void 0)}};function Hs(){}Hs.prototype.h=null;function pl(o){return o.h||(o.h=o.i())}function ml(){}var hr={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Ws(){te.call(this,"d")}R(Ws,te);function Gs(){te.call(this,"c")}R(Gs,te);var un={},gl=null;function pi(){return gl=gl||new he}un.La="serverreachability";function yl(o){te.call(this,un.La,o)}R(yl,te);function fr(o){const c=pi();Te(c,new yl(c))}un.STAT_EVENT="statevent";function vl(o,c){te.call(this,un.STAT_EVENT,o),this.stat=c}R(vl,te);function ze(o){const c=pi();Te(c,new vl(c,o))}un.Ma="timingevent";function _l(o,c){te.call(this,un.Ma,o),this.size=c}R(_l,te);function pr(o,c){if(typeof o!="function")throw Error("Fn must not be null and must be a function");return l.setTimeout(function(){o()},c)}function mr(){this.g=!0}mr.prototype.xa=function(){this.g=!1};function df(o,c,d,p,b,S){o.info(function(){if(o.g)if(S)for(var V="",ne=S.split("&"),be=0;be<ne.length;be++){var X=ne[be].split("=");if(1<X.length){var ke=X[0];X=X[1];var De=ke.split("_");V=2<=De.length&&De[1]=="type"?V+(ke+"="+X+"&"):V+(ke+"=redacted&")}}else V=null;else V=S;return"XMLHTTP REQ ("+p+") [attempt "+b+"]: "+c+`
`+d+`
`+V})}function hf(o,c,d,p,b,S,V){o.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+b+"]: "+c+`
`+d+`
`+S+" "+V})}function Dn(o,c,d,p){o.info(function(){return"XMLHTTP TEXT ("+c+"): "+pf(o,d)+(p?" "+p:"")})}function ff(o,c){o.info(function(){return"TIMEOUT: "+c})}mr.prototype.info=function(){};function pf(o,c){if(!o.g)return c;if(!c)return null;try{var d=JSON.parse(c);if(d){for(o=0;o<d.length;o++)if(Array.isArray(d[o])){var p=d[o];if(!(2>p.length)){var b=p[1];if(Array.isArray(b)&&!(1>b.length)){var S=b[0];if(S!="noop"&&S!="stop"&&S!="close")for(var V=1;V<b.length;V++)b[V]=""}}}}return js(d)}catch{return c}}var mi={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},El={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Ys;function gi(){}R(gi,Hs),gi.prototype.g=function(){return new XMLHttpRequest},gi.prototype.i=function(){return{}},Ys=new gi;function Vt(o,c,d,p){this.j=o,this.i=c,this.l=d,this.R=p||1,this.U=new dr(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new wl}function wl(){this.i=null,this.g="",this.h=!1}var Il={},Ks={};function Qs(o,c,d){o.L=1,o.v=Ei(vt(c)),o.m=d,o.P=!0,Tl(o,null)}function Tl(o,c){o.F=Date.now(),yi(o),o.A=vt(o.v);var d=o.A,p=o.R;Array.isArray(p)||(p=[String(p)]),Ll(d.i,"t",p),o.C=0,d=o.j.J,o.h=new wl,o.g=tc(o.j,d?c:null,!o.m),0<o.O&&(o.M=new lf(_(o.Y,o,o.g),o.O)),c=o.U,d=o.g,p=o.ca;var b="readystatechange";Array.isArray(b)||(b&&(hl[0]=b.toString()),b=hl);for(var S=0;S<b.length;S++){var V=yt(d,b[S],p||c.handleEvent,!1,c.h||c);if(!V)break;c.g[V.key]=V}c=o.H?m(o.H):{},o.m?(o.u||(o.u="POST"),c["Content-Type"]="application/x-www-form-urlencoded",o.g.ea(o.A,o.u,o.m,c)):(o.u="GET",o.g.ea(o.A,o.u,null,c)),fr(),df(o.i,o.u,o.A,o.l,o.R,o.m)}Vt.prototype.ca=function(o){o=o.target;const c=this.M;c&&_t(o)==3?c.j():this.Y(o)},Vt.prototype.Y=function(o){try{if(o==this.g)e:{const De=_t(this.g);var c=this.g.Ba();const Vn=this.g.Z();if(!(3>De)&&(De!=3||this.g&&(this.h.h||this.g.oa()||jl(this.g)))){this.J||De!=4||c==7||(c==8||0>=Vn?fr(3):fr(2)),Xs(this);var d=this.g.Z();this.X=d;t:if(bl(this)){var p=jl(this.g);o="";var b=p.length,S=_t(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){dn(this),gr(this);var V="";break t}this.h.i=new l.TextDecoder}for(c=0;c<b;c++)this.h.h=!0,o+=this.h.i.decode(p[c],{stream:!(S&&c==b-1)});p.length=0,this.h.g+=o,this.C=0,V=this.h.g}else V=this.g.oa();if(this.o=d==200,hf(this.i,this.u,this.A,this.l,this.R,De,d),this.o){if(this.T&&!this.K){t:{if(this.g){var ne,be=this.g;if((ne=be.g?be.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!x(ne)){var X=ne;break t}}X=null}if(d=X)Dn(this.i,this.l,d,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Js(this,d);else{this.o=!1,this.s=3,ze(12),dn(this),gr(this);break e}}if(this.P){d=!0;let rt;for(;!this.J&&this.C<V.length;)if(rt=mf(this,V),rt==Ks){De==4&&(this.s=4,ze(14),d=!1),Dn(this.i,this.l,null,"[Incomplete Response]");break}else if(rt==Il){this.s=4,ze(15),Dn(this.i,this.l,V,"[Invalid Chunk]"),d=!1;break}else Dn(this.i,this.l,rt,null),Js(this,rt);if(bl(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),De!=4||V.length!=0||this.h.h||(this.s=1,ze(16),d=!1),this.o=this.o&&d,!d)Dn(this.i,this.l,V,"[Invalid Chunked Response]"),dn(this),gr(this);else if(0<V.length&&!this.W){this.W=!0;var ke=this.j;ke.g==this&&ke.ba&&!ke.M&&(ke.j.info("Great, no buffering proxy detected. Bytes received: "+V.length),io(ke),ke.M=!0,ze(11))}}else Dn(this.i,this.l,V,null),Js(this,V);De==4&&dn(this),this.o&&!this.J&&(De==4?Xl(this.j,this):(this.o=!1,yi(this)))}else Df(this.g),d==400&&0<V.indexOf("Unknown SID")?(this.s=3,ze(12)):(this.s=0,ze(13)),dn(this),gr(this)}}}catch{}finally{}};function bl(o){return o.g?o.u=="GET"&&o.L!=2&&o.j.Ca:!1}function mf(o,c){var d=o.C,p=c.indexOf(`
`,d);return p==-1?Ks:(d=Number(c.substring(d,p)),isNaN(d)?Il:(p+=1,p+d>c.length?Ks:(c=c.slice(p,p+d),o.C=p+d,c)))}Vt.prototype.cancel=function(){this.J=!0,dn(this)};function yi(o){o.S=Date.now()+o.I,Al(o,o.I)}function Al(o,c){if(o.B!=null)throw Error("WatchDog timer not null");o.B=pr(_(o.ba,o),c)}function Xs(o){o.B&&(l.clearTimeout(o.B),o.B=null)}Vt.prototype.ba=function(){this.B=null;const o=Date.now();0<=o-this.S?(ff(this.i,this.A),this.L!=2&&(fr(),ze(17)),dn(this),this.s=2,gr(this)):Al(this,this.S-o)};function gr(o){o.j.G==0||o.J||Xl(o.j,o)}function dn(o){Xs(o);var c=o.M;c&&typeof c.ma=="function"&&c.ma(),o.M=null,fl(o.U),o.g&&(c=o.g,o.g=null,c.abort(),c.ma())}function Js(o,c){try{var d=o.j;if(d.G!=0&&(d.g==o||Zs(d.h,o))){if(!o.K&&Zs(d.h,o)&&d.G==3){try{var p=d.Da.g.parse(c)}catch{p=null}if(Array.isArray(p)&&p.length==3){var b=p;if(b[0]==0){e:if(!d.u){if(d.g)if(d.g.F+3e3<o.F)Si(d),bi(d);else break e;ro(d),ze(18)}}else d.za=b[1],0<d.za-d.T&&37500>b[2]&&d.F&&d.v==0&&!d.C&&(d.C=pr(_(d.Za,d),6e3));if(1>=Pl(d.h)&&d.ca){try{d.ca()}catch{}d.ca=void 0}}else fn(d,11)}else if((o.K||d.g==o)&&Si(d),!x(c))for(b=d.Da.g.parse(c),c=0;c<b.length;c++){let X=b[c];if(d.T=X[0],X=X[1],d.G==2)if(X[0]=="c"){d.K=X[1],d.ia=X[2];const ke=X[3];ke!=null&&(d.la=ke,d.j.info("VER="+d.la));const De=X[4];De!=null&&(d.Aa=De,d.j.info("SVER="+d.Aa));const Vn=X[5];Vn!=null&&typeof Vn=="number"&&0<Vn&&(p=1.5*Vn,d.L=p,d.j.info("backChannelRequestTimeoutMs_="+p)),p=d;const rt=o.g;if(rt){const Pi=rt.g?rt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Pi){var S=p.h;S.g||Pi.indexOf("spdy")==-1&&Pi.indexOf("quic")==-1&&Pi.indexOf("h2")==-1||(S.j=S.l,S.g=new Set,S.h&&(eo(S,S.h),S.h=null))}if(p.D){const so=rt.g?rt.g.getResponseHeader("X-HTTP-Session-Id"):null;so&&(p.ya=so,ie(p.I,p.D,so))}}d.G=3,d.l&&d.l.ua(),d.ba&&(d.R=Date.now()-o.F,d.j.info("Handshake RTT: "+d.R+"ms")),p=d;var V=o;if(p.qa=ec(p,p.J?p.ia:null,p.W),V.K){Cl(p.h,V);var ne=V,be=p.L;be&&(ne.I=be),ne.B&&(Xs(ne),yi(ne)),p.g=V}else Kl(p);0<d.i.length&&Ai(d)}else X[0]!="stop"&&X[0]!="close"||fn(d,7);else d.G==3&&(X[0]=="stop"||X[0]=="close"?X[0]=="stop"?fn(d,7):no(d):X[0]!="noop"&&d.l&&d.l.ta(X),d.v=0)}}fr(4)}catch{}}var gf=class{constructor(o,c){this.g=o,this.map=c}};function Sl(o){this.l=o||10,l.PerformanceNavigationTiming?(o=l.performance.getEntriesByType("navigation"),o=0<o.length&&(o[0].nextHopProtocol=="hq"||o[0].nextHopProtocol=="h2")):o=!!(l.chrome&&l.chrome.loadTimes&&l.chrome.loadTimes()&&l.chrome.loadTimes().wasFetchedViaSpdy),this.j=o?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Rl(o){return o.h?!0:o.g?o.g.size>=o.j:!1}function Pl(o){return o.h?1:o.g?o.g.size:0}function Zs(o,c){return o.h?o.h==c:o.g?o.g.has(c):!1}function eo(o,c){o.g?o.g.add(c):o.h=c}function Cl(o,c){o.h&&o.h==c?o.h=null:o.g&&o.g.has(c)&&o.g.delete(c)}Sl.prototype.cancel=function(){if(this.i=xl(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const o of this.g.values())o.cancel();this.g.clear()}};function xl(o){if(o.h!=null)return o.i.concat(o.h.D);if(o.g!=null&&o.g.size!==0){let c=o.i;for(const d of o.g.values())c=c.concat(d.D);return c}return D(o.i)}function yf(o){if(o.V&&typeof o.V=="function")return o.V();if(typeof Map<"u"&&o instanceof Map||typeof Set<"u"&&o instanceof Set)return Array.from(o.values());if(typeof o=="string")return o.split("");if(u(o)){for(var c=[],d=o.length,p=0;p<d;p++)c.push(o[p]);return c}c=[],d=0;for(p in o)c[d++]=o[p];return c}function vf(o){if(o.na&&typeof o.na=="function")return o.na();if(!o.V||typeof o.V!="function"){if(typeof Map<"u"&&o instanceof Map)return Array.from(o.keys());if(!(typeof Set<"u"&&o instanceof Set)){if(u(o)||typeof o=="string"){var c=[];o=o.length;for(var d=0;d<o;d++)c.push(d);return c}c=[],d=0;for(const p in o)c[d++]=p;return c}}}function kl(o,c){if(o.forEach&&typeof o.forEach=="function")o.forEach(c,void 0);else if(u(o)||typeof o=="string")Array.prototype.forEach.call(o,c,void 0);else for(var d=vf(o),p=yf(o),b=p.length,S=0;S<b;S++)c.call(void 0,p[S],d&&d[S],o)}var Dl=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function _f(o,c){if(o){o=o.split("&");for(var d=0;d<o.length;d++){var p=o[d].indexOf("="),b=null;if(0<=p){var S=o[d].substring(0,p);b=o[d].substring(p+1)}else S=o[d];c(S,b?decodeURIComponent(b.replace(/\+/g," ")):"")}}}function hn(o){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,o instanceof hn){this.h=o.h,vi(this,o.j),this.o=o.o,this.g=o.g,_i(this,o.s),this.l=o.l;var c=o.i,d=new _r;d.i=c.i,c.g&&(d.g=new Map(c.g),d.h=c.h),Ml(this,d),this.m=o.m}else o&&(c=String(o).match(Dl))?(this.h=!1,vi(this,c[1]||"",!0),this.o=yr(c[2]||""),this.g=yr(c[3]||"",!0),_i(this,c[4]),this.l=yr(c[5]||"",!0),Ml(this,c[6]||"",!0),this.m=yr(c[7]||"")):(this.h=!1,this.i=new _r(null,this.h))}hn.prototype.toString=function(){var o=[],c=this.j;c&&o.push(vr(c,Nl,!0),":");var d=this.g;return(d||c=="file")&&(o.push("//"),(c=this.o)&&o.push(vr(c,Nl,!0),"@"),o.push(encodeURIComponent(String(d)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.s,d!=null&&o.push(":",String(d))),(d=this.l)&&(this.g&&d.charAt(0)!="/"&&o.push("/"),o.push(vr(d,d.charAt(0)=="/"?If:wf,!0))),(d=this.i.toString())&&o.push("?",d),(d=this.m)&&o.push("#",vr(d,bf)),o.join("")};function vt(o){return new hn(o)}function vi(o,c,d){o.j=d?yr(c,!0):c,o.j&&(o.j=o.j.replace(/:$/,""))}function _i(o,c){if(c){if(c=Number(c),isNaN(c)||0>c)throw Error("Bad port number "+c);o.s=c}else o.s=null}function Ml(o,c,d){c instanceof _r?(o.i=c,Af(o.i,o.h)):(d||(c=vr(c,Tf)),o.i=new _r(c,o.h))}function ie(o,c,d){o.i.set(c,d)}function Ei(o){return ie(o,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),o}function yr(o,c){return o?c?decodeURI(o.replace(/%25/g,"%2525")):decodeURIComponent(o):""}function vr(o,c,d){return typeof o=="string"?(o=encodeURI(o).replace(c,Ef),d&&(o=o.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),o):null}function Ef(o){return o=o.charCodeAt(0),"%"+(o>>4&15).toString(16)+(o&15).toString(16)}var Nl=/[#\/\?@]/g,wf=/[#\?:]/g,If=/[#\?]/g,Tf=/[#\?@]/g,bf=/#/g;function _r(o,c){this.h=this.g=null,this.i=o||null,this.j=!!c}function Ot(o){o.g||(o.g=new Map,o.h=0,o.i&&_f(o.i,function(c,d){o.add(decodeURIComponent(c.replace(/\+/g," ")),d)}))}n=_r.prototype,n.add=function(o,c){Ot(this),this.i=null,o=Mn(this,o);var d=this.g.get(o);return d||this.g.set(o,d=[]),d.push(c),this.h+=1,this};function Vl(o,c){Ot(o),c=Mn(o,c),o.g.has(c)&&(o.i=null,o.h-=o.g.get(c).length,o.g.delete(c))}function Ol(o,c){return Ot(o),c=Mn(o,c),o.g.has(c)}n.forEach=function(o,c){Ot(this),this.g.forEach(function(d,p){d.forEach(function(b){o.call(c,b,p,this)},this)},this)},n.na=function(){Ot(this);const o=Array.from(this.g.values()),c=Array.from(this.g.keys()),d=[];for(let p=0;p<c.length;p++){const b=o[p];for(let S=0;S<b.length;S++)d.push(c[p])}return d},n.V=function(o){Ot(this);let c=[];if(typeof o=="string")Ol(this,o)&&(c=c.concat(this.g.get(Mn(this,o))));else{o=Array.from(this.g.values());for(let d=0;d<o.length;d++)c=c.concat(o[d])}return c},n.set=function(o,c){return Ot(this),this.i=null,o=Mn(this,o),Ol(this,o)&&(this.h-=this.g.get(o).length),this.g.set(o,[c]),this.h+=1,this},n.get=function(o,c){return o?(o=this.V(o),0<o.length?String(o[0]):c):c};function Ll(o,c,d){Vl(o,c),0<d.length&&(o.i=null,o.g.set(Mn(o,c),D(d)),o.h+=d.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const o=[],c=Array.from(this.g.keys());for(var d=0;d<c.length;d++){var p=c[d];const S=encodeURIComponent(String(p)),V=this.V(p);for(p=0;p<V.length;p++){var b=S;V[p]!==""&&(b+="="+encodeURIComponent(String(V[p]))),o.push(b)}}return this.i=o.join("&")};function Mn(o,c){return c=String(c),o.j&&(c=c.toLowerCase()),c}function Af(o,c){c&&!o.j&&(Ot(o),o.i=null,o.g.forEach(function(d,p){var b=p.toLowerCase();p!=b&&(Vl(this,p),Ll(this,b,d))},o)),o.j=c}function Sf(o,c){const d=new mr;if(l.Image){const p=new Image;p.onload=T(Lt,d,"TestLoadImage: loaded",!0,c,p),p.onerror=T(Lt,d,"TestLoadImage: error",!1,c,p),p.onabort=T(Lt,d,"TestLoadImage: abort",!1,c,p),p.ontimeout=T(Lt,d,"TestLoadImage: timeout",!1,c,p),l.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=o}else c(!1)}function Rf(o,c){const d=new mr,p=new AbortController,b=setTimeout(()=>{p.abort(),Lt(d,"TestPingServer: timeout",!1,c)},1e4);fetch(o,{signal:p.signal}).then(S=>{clearTimeout(b),S.ok?Lt(d,"TestPingServer: ok",!0,c):Lt(d,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(b),Lt(d,"TestPingServer: error",!1,c)})}function Lt(o,c,d,p,b){try{b&&(b.onload=null,b.onerror=null,b.onabort=null,b.ontimeout=null),p(d)}catch{}}function Pf(){this.g=new uf}function Cf(o,c,d){const p=d||"";try{kl(o,function(b,S){let V=b;h(b)&&(V=js(b)),c.push(p+S+"="+encodeURIComponent(V))})}catch(b){throw c.push(p+"type="+encodeURIComponent("_badmap")),b}}function wi(o){this.l=o.Ub||null,this.j=o.eb||!1}R(wi,Hs),wi.prototype.g=function(){return new Ii(this.l,this.j)},wi.prototype.i=function(o){return function(){return o}}({});function Ii(o,c){he.call(this),this.D=o,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}R(Ii,he),n=Ii.prototype,n.open=function(o,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=o,this.A=c,this.readyState=1,wr(this)},n.send=function(o){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const c={headers:this.u,method:this.B,credentials:this.m,cache:void 0};o&&(c.body=o),(this.D||l).fetch(new Request(this.A,c)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Er(this)),this.readyState=0},n.Sa=function(o){if(this.g&&(this.l=o,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=o.headers,this.readyState=2,wr(this)),this.g&&(this.readyState=3,wr(this),this.g)))if(this.responseType==="arraybuffer")o.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof l.ReadableStream<"u"&&"body"in o){if(this.j=o.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Bl(this)}else o.text().then(this.Ra.bind(this),this.ga.bind(this))};function Bl(o){o.j.read().then(o.Pa.bind(o)).catch(o.ga.bind(o))}n.Pa=function(o){if(this.g){if(this.o&&o.value)this.response.push(o.value);else if(!this.o){var c=o.value?o.value:new Uint8Array(0);(c=this.v.decode(c,{stream:!o.done}))&&(this.response=this.responseText+=c)}o.done?Er(this):wr(this),this.readyState==3&&Bl(this)}},n.Ra=function(o){this.g&&(this.response=this.responseText=o,Er(this))},n.Qa=function(o){this.g&&(this.response=o,Er(this))},n.ga=function(){this.g&&Er(this)};function Er(o){o.readyState=4,o.l=null,o.j=null,o.v=null,wr(o)}n.setRequestHeader=function(o,c){this.u.append(o,c)},n.getResponseHeader=function(o){return this.h&&this.h.get(o.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const o=[],c=this.h.entries();for(var d=c.next();!d.done;)d=d.value,o.push(d[0]+": "+d[1]),d=c.next();return o.join(`\r
`)};function wr(o){o.onreadystatechange&&o.onreadystatechange.call(o)}Object.defineProperty(Ii.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(o){this.m=o?"include":"same-origin"}});function Fl(o){let c="";return z(o,function(d,p){c+=p,c+=":",c+=d,c+=`\r
`}),c}function to(o,c,d){e:{for(p in d){var p=!1;break e}p=!0}p||(d=Fl(d),typeof o=="string"?d!=null&&encodeURIComponent(String(d)):ie(o,c,d))}function ae(o){he.call(this),this.headers=new Map,this.o=o||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}R(ae,he);var xf=/^https?$/i,kf=["POST","PUT"];n=ae.prototype,n.Ha=function(o){this.J=o},n.ea=function(o,c,d,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+o);c=c?c.toUpperCase():"GET",this.D=o,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Ys.g(),this.v=this.o?pl(this.o):pl(Ys),this.g.onreadystatechange=_(this.Ea,this);try{this.B=!0,this.g.open(c,String(o),!0),this.B=!1}catch(S){Ul(this,S);return}if(o=d||"",d=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var b in p)d.set(b,p[b]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const S of p.keys())d.set(S,p.get(S));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(d.keys()).find(S=>S.toLowerCase()=="content-type"),b=l.FormData&&o instanceof l.FormData,!(0<=Array.prototype.indexOf.call(kf,c,void 0))||p||b||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[S,V]of d)this.g.setRequestHeader(S,V);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{ql(this),this.u=!0,this.g.send(o),this.u=!1}catch(S){Ul(this,S)}};function Ul(o,c){o.h=!1,o.g&&(o.j=!0,o.g.abort(),o.j=!1),o.l=c,o.m=5,zl(o),Ti(o)}function zl(o){o.A||(o.A=!0,Te(o,"complete"),Te(o,"error"))}n.abort=function(o){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=o||7,Te(this,"complete"),Te(this,"abort"),Ti(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Ti(this,!0)),ae.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?$l(this):this.bb())},n.bb=function(){$l(this)};function $l(o){if(o.h&&typeof a<"u"&&(!o.v[1]||_t(o)!=4||o.Z()!=2)){if(o.u&&_t(o)==4)fi(o.Ea,0,o);else if(Te(o,"readystatechange"),_t(o)==4){o.h=!1;try{const V=o.Z();e:switch(V){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break e;default:c=!1}var d;if(!(d=c)){var p;if(p=V===0){var b=String(o.D).match(Dl)[1]||null;!b&&l.self&&l.self.location&&(b=l.self.location.protocol.slice(0,-1)),p=!xf.test(b?b.toLowerCase():"")}d=p}if(d)Te(o,"complete"),Te(o,"success");else{o.m=6;try{var S=2<_t(o)?o.g.statusText:""}catch{S=""}o.l=S+" ["+o.Z()+"]",zl(o)}}finally{Ti(o)}}}}function Ti(o,c){if(o.g){ql(o);const d=o.g,p=o.v[0]?()=>{}:null;o.g=null,o.v=null,c||Te(o,"ready");try{d.onreadystatechange=p}catch{}}}function ql(o){o.I&&(l.clearTimeout(o.I),o.I=null)}n.isActive=function(){return!!this.g};function _t(o){return o.g?o.g.readyState:0}n.Z=function(){try{return 2<_t(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(o){if(this.g){var c=this.g.responseText;return o&&c.indexOf(o)==0&&(c=c.substring(o.length)),cf(c)}};function jl(o){try{if(!o.g)return null;if("response"in o.g)return o.g.response;switch(o.H){case"":case"text":return o.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in o.g)return o.g.mozResponseArrayBuffer}return null}catch{return null}}function Df(o){const c={};o=(o.g&&2<=_t(o)&&o.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<o.length;p++){if(x(o[p]))continue;var d=I(o[p]);const b=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const S=c[b]||[];c[b]=S,S.push(d)}E(c,function(p){return p.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Ir(o,c,d){return d&&d.internalChannelParams&&d.internalChannelParams[o]||c}function Hl(o){this.Aa=0,this.i=[],this.j=new mr,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Ir("failFast",!1,o),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Ir("baseRetryDelayMs",5e3,o),this.cb=Ir("retryDelaySeedMs",1e4,o),this.Wa=Ir("forwardChannelMaxRetries",2,o),this.wa=Ir("forwardChannelRequestTimeoutMs",2e4,o),this.pa=o&&o.xmlHttpFactory||void 0,this.Xa=o&&o.Tb||void 0,this.Ca=o&&o.useFetchStreams||!1,this.L=void 0,this.J=o&&o.supportsCrossDomainXhr||!1,this.K="",this.h=new Sl(o&&o.concurrentRequestLimit),this.Da=new Pf,this.P=o&&o.fastHandshake||!1,this.O=o&&o.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=o&&o.Rb||!1,o&&o.xa&&this.j.xa(),o&&o.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&o&&o.detectBufferingProxy||!1,this.ja=void 0,o&&o.longPollingTimeout&&0<o.longPollingTimeout&&(this.ja=o.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=Hl.prototype,n.la=8,n.G=1,n.connect=function(o,c,d,p){ze(0),this.W=o,this.H=c||{},d&&p!==void 0&&(this.H.OSID=d,this.H.OAID=p),this.F=this.X,this.I=ec(this,null,this.W),Ai(this)};function no(o){if(Wl(o),o.G==3){var c=o.U++,d=vt(o.I);if(ie(d,"SID",o.K),ie(d,"RID",c),ie(d,"TYPE","terminate"),Tr(o,d),c=new Vt(o,o.j,c),c.L=2,c.v=Ei(vt(d)),d=!1,l.navigator&&l.navigator.sendBeacon)try{d=l.navigator.sendBeacon(c.v.toString(),"")}catch{}!d&&l.Image&&(new Image().src=c.v,d=!0),d||(c.g=tc(c.j,null),c.g.ea(c.v)),c.F=Date.now(),yi(c)}Zl(o)}function bi(o){o.g&&(io(o),o.g.cancel(),o.g=null)}function Wl(o){bi(o),o.u&&(l.clearTimeout(o.u),o.u=null),Si(o),o.h.cancel(),o.s&&(typeof o.s=="number"&&l.clearTimeout(o.s),o.s=null)}function Ai(o){if(!Rl(o.h)&&!o.s){o.s=!0;var c=o.Ga;nt||at(),ue||(nt(),ue=!0),de.add(c,o),o.B=0}}function Mf(o,c){return Pl(o.h)>=o.h.j-(o.s?1:0)?!1:o.s?(o.i=c.D.concat(o.i),!0):o.G==1||o.G==2||o.B>=(o.Va?0:o.Wa)?!1:(o.s=pr(_(o.Ga,o,c),Jl(o,o.B)),o.B++,!0)}n.Ga=function(o){if(this.s)if(this.s=null,this.G==1){if(!o){this.U=Math.floor(1e5*Math.random()),o=this.U++;const b=new Vt(this,this.j,o);let S=this.o;if(this.S&&(S?(S=m(S),w(S,this.S)):S=this.S),this.m!==null||this.O||(b.H=S,S=null),this.P)e:{for(var c=0,d=0;d<this.i.length;d++){t:{var p=this.i[d];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break t}p=void 0}if(p===void 0)break;if(c+=p,4096<c){c=d;break e}if(c===4096||d===this.i.length-1){c=d+1;break e}}c=1e3}else c=1e3;c=Yl(this,b,c),d=vt(this.I),ie(d,"RID",o),ie(d,"CVER",22),this.D&&ie(d,"X-HTTP-Session-Id",this.D),Tr(this,d),S&&(this.O?c="headers="+encodeURIComponent(String(Fl(S)))+"&"+c:this.m&&to(d,this.m,S)),eo(this.h,b),this.Ua&&ie(d,"TYPE","init"),this.P?(ie(d,"$req",c),ie(d,"SID","null"),b.T=!0,Qs(b,d,null)):Qs(b,d,c),this.G=2}}else this.G==3&&(o?Gl(this,o):this.i.length==0||Rl(this.h)||Gl(this))};function Gl(o,c){var d;c?d=c.l:d=o.U++;const p=vt(o.I);ie(p,"SID",o.K),ie(p,"RID",d),ie(p,"AID",o.T),Tr(o,p),o.m&&o.o&&to(p,o.m,o.o),d=new Vt(o,o.j,d,o.B+1),o.m===null&&(d.H=o.o),c&&(o.i=c.D.concat(o.i)),c=Yl(o,d,1e3),d.I=Math.round(.5*o.wa)+Math.round(.5*o.wa*Math.random()),eo(o.h,d),Qs(d,p,c)}function Tr(o,c){o.H&&z(o.H,function(d,p){ie(c,p,d)}),o.l&&kl({},function(d,p){ie(c,p,d)})}function Yl(o,c,d){d=Math.min(o.i.length,d);var p=o.l?_(o.l.Na,o.l,o):null;e:{var b=o.i;let S=-1;for(;;){const V=["count="+d];S==-1?0<d?(S=b[0].g,V.push("ofs="+S)):S=0:V.push("ofs="+S);let ne=!0;for(let be=0;be<d;be++){let X=b[be].g;const ke=b[be].map;if(X-=S,0>X)S=Math.max(0,b[be].g-100),ne=!1;else try{Cf(ke,V,"req"+X+"_")}catch{p&&p(ke)}}if(ne){p=V.join("&");break e}}}return o=o.i.splice(0,d),c.D=o,p}function Kl(o){if(!o.g&&!o.u){o.Y=1;var c=o.Fa;nt||at(),ue||(nt(),ue=!0),de.add(c,o),o.v=0}}function ro(o){return o.g||o.u||3<=o.v?!1:(o.Y++,o.u=pr(_(o.Fa,o),Jl(o,o.v)),o.v++,!0)}n.Fa=function(){if(this.u=null,Ql(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var o=2*this.R;this.j.info("BP detection timer enabled: "+o),this.A=pr(_(this.ab,this),o)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,ze(10),bi(this),Ql(this))};function io(o){o.A!=null&&(l.clearTimeout(o.A),o.A=null)}function Ql(o){o.g=new Vt(o,o.j,"rpc",o.Y),o.m===null&&(o.g.H=o.o),o.g.O=0;var c=vt(o.qa);ie(c,"RID","rpc"),ie(c,"SID",o.K),ie(c,"AID",o.T),ie(c,"CI",o.F?"0":"1"),!o.F&&o.ja&&ie(c,"TO",o.ja),ie(c,"TYPE","xmlhttp"),Tr(o,c),o.m&&o.o&&to(c,o.m,o.o),o.L&&(o.g.I=o.L);var d=o.g;o=o.ia,d.L=1,d.v=Ei(vt(c)),d.m=null,d.P=!0,Tl(d,o)}n.Za=function(){this.C!=null&&(this.C=null,bi(this),ro(this),ze(19))};function Si(o){o.C!=null&&(l.clearTimeout(o.C),o.C=null)}function Xl(o,c){var d=null;if(o.g==c){Si(o),io(o),o.g=null;var p=2}else if(Zs(o.h,c))d=c.D,Cl(o.h,c),p=1;else return;if(o.G!=0){if(c.o)if(p==1){d=c.m?c.m.length:0,c=Date.now()-c.F;var b=o.B;p=pi(),Te(p,new _l(p,d)),Ai(o)}else Kl(o);else if(b=c.s,b==3||b==0&&0<c.X||!(p==1&&Mf(o,c)||p==2&&ro(o)))switch(d&&0<d.length&&(c=o.h,c.i=c.i.concat(d)),b){case 1:fn(o,5);break;case 4:fn(o,10);break;case 3:fn(o,6);break;default:fn(o,2)}}}function Jl(o,c){let d=o.Ta+Math.floor(Math.random()*o.cb);return o.isActive()||(d*=2),d*c}function fn(o,c){if(o.j.info("Error code "+c),c==2){var d=_(o.fb,o),p=o.Xa;const b=!p;p=new hn(p||"//www.google.com/images/cleardot.gif"),l.location&&l.location.protocol=="http"||vi(p,"https"),Ei(p),b?Sf(p.toString(),d):Rf(p.toString(),d)}else ze(2);o.G=0,o.l&&o.l.sa(c),Zl(o),Wl(o)}n.fb=function(o){o?(this.j.info("Successfully pinged google.com"),ze(2)):(this.j.info("Failed to ping google.com"),ze(1))};function Zl(o){if(o.G=0,o.ka=[],o.l){const c=xl(o.h);(c.length!=0||o.i.length!=0)&&(P(o.ka,c),P(o.ka,o.i),o.h.i.length=0,D(o.i),o.i.length=0),o.l.ra()}}function ec(o,c,d){var p=d instanceof hn?vt(d):new hn(d);if(p.g!="")c&&(p.g=c+"."+p.g),_i(p,p.s);else{var b=l.location;p=b.protocol,c=c?c+"."+b.hostname:b.hostname,b=+b.port;var S=new hn(null);p&&vi(S,p),c&&(S.g=c),b&&_i(S,b),d&&(S.l=d),p=S}return d=o.D,c=o.ya,d&&c&&ie(p,d,c),ie(p,"VER",o.la),Tr(o,p),p}function tc(o,c,d){if(c&&!o.J)throw Error("Can't create secondary domain capable XhrIo object.");return c=o.Ca&&!o.pa?new ae(new wi({eb:d})):new ae(o.pa),c.Ha(o.J),c}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function nc(){}n=nc.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function Ri(){}Ri.prototype.g=function(o,c){return new Qe(o,c)};function Qe(o,c){he.call(this),this.g=new Hl(c),this.l=o,this.h=c&&c.messageUrlParams||null,o=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(o?o["X-Client-Protocol"]="webchannel":o={"X-Client-Protocol":"webchannel"}),this.g.o=o,o=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(o?o["X-WebChannel-Content-Type"]=c.messageContentType:o={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.va&&(o?o["X-WebChannel-Client-Profile"]=c.va:o={"X-WebChannel-Client-Profile":c.va}),this.g.S=o,(o=c&&c.Sb)&&!x(o)&&(this.g.m=o),this.v=c&&c.supportsCrossDomainXhr||!1,this.u=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!x(c)&&(this.g.D=c,o=this.h,o!==null&&c in o&&(o=this.h,c in o&&delete o[c])),this.j=new Nn(this)}R(Qe,he),Qe.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Qe.prototype.close=function(){no(this.g)},Qe.prototype.o=function(o){var c=this.g;if(typeof o=="string"){var d={};d.__data__=o,o=d}else this.u&&(d={},d.__data__=js(o),o=d);c.i.push(new gf(c.Ya++,o)),c.G==3&&Ai(c)},Qe.prototype.N=function(){this.g.l=null,delete this.j,no(this.g),delete this.g,Qe.aa.N.call(this)};function rc(o){Ws.call(this),o.__headers__&&(this.headers=o.__headers__,this.statusCode=o.__status__,delete o.__headers__,delete o.__status__);var c=o.__sm__;if(c){e:{for(const d in c){o=d;break e}o=void 0}(this.i=o)&&(o=this.i,c=c!==null&&o in c?c[o]:void 0),this.data=c}else this.data=o}R(rc,Ws);function ic(){Gs.call(this),this.status=1}R(ic,Gs);function Nn(o){this.g=o}R(Nn,nc),Nn.prototype.ua=function(){Te(this.g,"a")},Nn.prototype.ta=function(o){Te(this.g,new rc(o))},Nn.prototype.sa=function(o){Te(this.g,new ic)},Nn.prototype.ra=function(){Te(this.g,"b")},Ri.prototype.createWebChannel=Ri.prototype.g,Qe.prototype.send=Qe.prototype.o,Qe.prototype.open=Qe.prototype.m,Qe.prototype.close=Qe.prototype.close,Td=function(){return new Ri},Id=function(){return pi()},wd=un,No={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},mi.NO_ERROR=0,mi.TIMEOUT=8,mi.HTTP_ERROR=6,Ui=mi,El.COMPLETE="complete",Ed=El,ml.EventType=hr,hr.OPEN="a",hr.CLOSE="b",hr.ERROR="c",hr.MESSAGE="d",he.prototype.listen=he.prototype.K,Pr=ml,ae.prototype.listenOnce=ae.prototype.L,ae.prototype.getLastError=ae.prototype.Ka,ae.prototype.getLastErrorCode=ae.prototype.Ba,ae.prototype.getStatus=ae.prototype.Z,ae.prototype.getResponseJson=ae.prototype.Oa,ae.prototype.getResponseText=ae.prototype.oa,ae.prototype.send=ae.prototype.ea,ae.prototype.setWithCredentials=ae.prototype.Ha,_d=ae}).apply(typeof ki<"u"?ki:typeof self<"u"?self:typeof window<"u"?window:{});const Vc="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j(n="Unexpected state"){const e=`FIRESTORE (${sr}) INTERNAL ASSERTION FAILED: `+n;throw Pt(e),new Error(e)}function ee(n,e){n||j()}function W(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bd{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class qy{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(Ne.UNAUTHENTICATED))}shutdown(){}}class jy{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class Hy{constructor(e){this.t=e,this.currentUser=Ne.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){ee(this.o===void 0);let r=this.i;const i=u=>this.i!==r?(r=this.i,t(u)):Promise.resolve();let s=new At;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new At,e.enqueueRetryable(()=>i(this.currentUser))};const a=()=>{const u=s;e.enqueueRetryable(async()=>{await u.promise,await i(this.currentUser)})},l=u=>{L("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(u=>l(u)),setTimeout(()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?l(u):(L("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new At)}},0),a()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(L("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(ee(typeof r.accessToken=="string"),new bd(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return ee(e===null||typeof e=="string"),new Ne(e)}}class Wy{constructor(e,t,r){this.l=e,this.h=t,this.P=r,this.type="FirstParty",this.user=Ne.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class Gy{constructor(e,t,r){this.l=e,this.h=t,this.P=r}getToken(){return Promise.resolve(new Wy(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t(Ne.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Yy{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Ky{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){ee(this.o===void 0);const r=s=>{s.error!=null&&L("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${s.error.message}`);const a=s.token!==this.R;return this.R=s.token,L("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?t(s.token):Promise.resolve()};this.o=s=>{e.enqueueRetryable(()=>r(s))};const i=s=>{L("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=s,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(s=>i(s)),setTimeout(()=>{if(!this.appCheck){const s=this.A.getImmediate({optional:!0});s?i(s):L("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(ee(typeof t.token=="string"),this.R=t.token,new Yy(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zr{constructor(e,t,r){t===void 0?t=0:t>e.length&&j(),r===void 0?r=e.length-t:r>e.length-t&&j(),this.segments=e,this.offset=t,this.len=r}get length(){return this.len}isEqual(e){return zr.comparator(this,e)===0}child(e){const t=this.segments.slice(this.offset,this.limit());return e instanceof zr?e.forEach(r=>{t.push(r)}):t.push(e),this.construct(t)}limit(){return this.offset+this.length}popFirst(e){return e=e===void 0?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return this.length===0}isPrefixOf(e){if(e.length<this.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}forEach(e){for(let t=this.offset,r=this.limit();t<r;t++)e(this.segments[t])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,t){const r=Math.min(e.length,t.length);for(let i=0;i<r;i++){const s=e.get(i),a=t.get(i);if(s<a)return-1;if(s>a)return 1}return e.length<t.length?-1:e.length>t.length?1:0}}class se extends zr{construct(e,t,r){return new se(e,t,r)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...e){const t=[];for(const r of e){if(r.indexOf("//")>=0)throw new O(k.INVALID_ARGUMENT,`Invalid segment (${r}). Paths must not contain // in them.`);t.push(...r.split("/").filter(i=>i.length>0))}return new se(t)}static emptyPath(){return new se([])}}const Xy=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class Se extends zr{construct(e,t,r){return new Se(e,t,r)}static isValidIdentifier(e){return Xy.test(e)}canonicalString(){return this.toArray().map(e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),Se.isValidIdentifier(e)||(e="`"+e+"`"),e)).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)==="__name__"}static keyField(){return new Se(["__name__"])}static fromServerFormat(e){const t=[];let r="",i=0;const s=()=>{if(r.length===0)throw new O(k.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);t.push(r),r=""};let a=!1;for(;i<e.length;){const l=e[i];if(l==="\\"){if(i+1===e.length)throw new O(k.INVALID_ARGUMENT,"Path has trailing escape character: "+e);const u=e[i+1];if(u!=="\\"&&u!=="."&&u!=="`")throw new O(k.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);r+=u,i+=2}else l==="`"?(a=!a,i++):l!=="."||a?(r+=l,i++):(s(),i++)}if(s(),a)throw new O(k.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new Se(t)}static emptyPath(){return new Se([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class je{constructor(e){this.value=e}static empty(){return new je({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!zi(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Mr(t)}setAll(e){let t=Se.emptyPath(),r={},i=[];e.forEach((a,l)=>{if(!t.isImmediateParentOf(l)){const u=this.getFieldsMap(t);this.applyChanges(u,r,i),r={},i=[],t=l.popLast()}a?r[l.lastSegment()]=Mr(a):i.push(l.lastSegment())});const s=this.getFieldsMap(t);this.applyChanges(s,r,i)}delete(e){const t=this.field(e.popLast());zi(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return ft(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let i=t.mapValue.fields[e.get(r)];zi(i)&&i.mapValue.fields||(i={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=i),t=i}return t.mapValue.fields}applyChanges(e,t,r){Sn(t,(i,s)=>e[i]=s);for(const i of r)delete e[i]}clone(){return new je(Mr(this.value))}}function Pd(n){const e=[];return Sn(n.fields,(t,r)=>{const i=new Se([t]);if(zi(r)){const s=Pd(r.mapValue).fields;if(s.length===0)e.push(i);else for(const a of s)e.push(i.child(a))}else e.push(i)}),new Je(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ve{constructor(e,t,r,i,s,a,l){this.key=e,this.documentType=t,this.version=r,this.readTime=i,this.createTime=s,this.data=a,this.documentState=l}static newInvalidDocument(e){return new Ve(e,0,H.min(),H.min(),H.min(),je.empty(),0)}static newFoundDocument(e,t,r,i){return new Ve(e,1,t,H.min(),r,i,0)}static newNoDocument(e,t){return new Ve(e,2,t,H.min(),H.min(),je.empty(),0)}static newUnknownDocument(e,t){return new Ve(e,3,t,H.min(),H.min(),je.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(H.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=je.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=je.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=H.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof Ve&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new Ve(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rs{constructor(e,t){this.position=e,this.inclusive=t}}function qc(n,e,t){let r=0;for(let i=0;i<n.position.length;i++){const s=e[i],a=n.position[i];if(s.field.isKeyField()?r=U.comparator(U.fromName(a.referenceValue),t.key):r=Jn(a,t.data.field(s.field)),s.dir==="desc"&&(r*=-1),r!==0)break}return r}function jc(n,e){if(n===null)return e===null;if(e===null||n.inclusive!==e.inclusive||n.position.length!==e.position.length)return!1;for(let t=0;t<n.position.length;t++)if(!ft(n.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qi{constructor(e,t,r,i){this.Re=e,this.removedTargetIds=t,this.key=r,this.Ve=i}}class Kd{constructor(e,t){this.targetId=e,this.me=t}}class Qd{constructor(e,t,r=Pe.EMPTY_BYTE_STRING,i=null){this.state=e,this.targetIds=t,this.resumeToken=r,this.cause=i}}class Zc{constructor(){this.fe=0,this.ge=tu(),this.pe=Pe.EMPTY_BYTE_STRING,this.ye=!1,this.we=!0}get current(){return this.ye}get resumeToken(){return this.pe}get Se(){return this.fe!==0}get be(){return this.we}De(e){e.approximateByteSize()>0&&(this.we=!0,this.pe=e)}ve(){let e=Y(),t=Y(),r=Y();return this.ge.forEach((i,s)=>{switch(s){case 0:e=e.add(i);break;case 2:t=t.add(i);break;case 1:r=r.add(i);break;default:j()}}),new ii(this.pe,this.ye,e,t,r)}Ce(){this.we=!1,this.ge=tu()}Fe(e,t){this.we=!0,this.ge=this.ge.insert(e,t)}Me(e){this.we=!0,this.ge=this.ge.remove(e)}xe(){this.fe+=1}Oe(){this.fe-=1,ee(this.fe>=0)}Ne(){this.we=!0,this.ye=!0}}class $0{constructor(e){this.Le=e,this.Be=new Map,this.ke=Ct(),this.qe=eu(),this.Qe=new oe(J)}Ke(e){for(const t of e.Re)e.Ve&&e.Ve.isFoundDocument()?this.$e(t,e.Ve):this.Ue(t,e.key,e.Ve);for(const t of e.removedTargetIds)this.Ue(t,e.key,e.Ve)}We(e){this.forEachTarget(e,t=>{const r=this.Ge(t);switch(e.state){case 0:this.ze(t)&&r.De(e.resumeToken);break;case 1:r.Oe(),r.Se||r.Ce(),r.De(e.resumeToken);break;case 2:r.Oe(),r.Se||this.removeTarget(t);break;case 3:this.ze(t)&&(r.Ne(),r.De(e.resumeToken));break;case 4:this.ze(t)&&(this.je(t),r.De(e.resumeToken));break;default:j()}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Be.forEach((r,i)=>{this.ze(i)&&t(i)})}He(e){const t=e.targetId,r=e.me.count,i=this.Je(t);if(i){const s=i.target;if(Bo(s))if(r===0){const a=new U(s.path);this.Ue(t,a,Ve.newNoDocument(a,H.min()))}else ee(r===1);else{const a=this.Ye(t);if(a!==r){const l=this.Ze(e),u=l?this.Xe(l,e,a):1;if(u!==0){this.je(t);const h=u===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Qe=this.Qe.insert(t,h)}}}}}Ze(e){const t=e.me.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:r="",padding:i=0},hashCount:s=0}=t;let a,l;try{a=bn(r).toUint8Array()}catch(u){if(u instanceof Rd)return Qn("Decoding the base64 bloom filter in existence filter failed ("+u.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw u}try{l=new ba(a,i,s)}catch(u){return Qn(u instanceof xr?"BloomFilter error: ":"Applying bloom filter failed: ",u),null}return l.Ie===0?null:l}Xe(e,t,r){return t.me.count===r-this.nt(e,t.targetId)?0:2}nt(e,t){const r=this.Le.getRemoteKeysForTarget(t);let i=0;return r.forEach(s=>{const a=this.Le.tt(),l=`projects/${a.projectId}/databases/${a.database}/documents/${s.path.canonicalString()}`;e.mightContain(l)||(this.Ue(t,s,null),i++)}),i}rt(e){const t=new Map;this.Be.forEach((s,a)=>{const l=this.Je(a);if(l){if(s.current&&Bo(l.target)){const u=new U(l.target.path);this.ke.get(u)!==null||this.it(a,u)||this.Ue(a,u,Ve.newNoDocument(u,e))}s.be&&(t.set(a,s.ve()),s.Ce())}});let r=Y();this.qe.forEach((s,a)=>{let l=!0;a.forEachWhile(u=>{const h=this.Je(u);return!h||h.purpose==="TargetPurposeLimboResolution"||(l=!1,!1)}),l&&(r=r.add(s))}),this.ke.forEach((s,a)=>a.setReadTime(e));const i=new Is(e,t,this.Qe,this.ke,r);return this.ke=Ct(),this.qe=eu(),this.Qe=new oe(J),i}$e(e,t){if(!this.ze(e))return;const r=this.it(e,t.key)?2:0;this.Ge(e).Fe(t.key,r),this.ke=this.ke.insert(t.key,t),this.qe=this.qe.insert(t.key,this.st(t.key).add(e))}Ue(e,t,r){if(!this.ze(e))return;const i=this.Ge(e);this.it(e,t)?i.Fe(t,1):i.Me(t),this.qe=this.qe.insert(t,this.st(t).delete(e)),r&&(this.ke=this.ke.insert(t,r))}removeTarget(e){this.Be.delete(e)}Ye(e){const t=this.Ge(e).ve();return this.Le.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}xe(e){this.Ge(e).xe()}Ge(e){let t=this.Be.get(e);return t||(t=new Zc,this.Be.set(e,t)),t}st(e){let t=this.qe.get(e);return t||(t=new Re(J),this.qe=this.qe.insert(e,t)),t}ze(e){const t=this.Je(e)!==null;return t||L("WatchChangeAggregator","Detected inactive target",e),t}Je(e){const t=this.Be.get(e);return t&&t.Se?null:this.Le.ot(e)}je(e){this.Be.set(e,new Zc),this.Le.getRemoteKeysForTarget(e).forEach(t=>{this.Ue(e,t,null)})}it(e,t){return this.Le.getRemoteKeysForTarget(e).has(t)}}function eu(){return new oe(U.comparator)}function tu(){return new oe(U.comparator)}const q0={asc:"ASCENDING",desc:"DESCENDING"},j0={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},H0={and:"AND",or:"OR"};class W0{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function Uo(n,e){return n.useProto3Json||ys(e)?e:{value:e}}function as(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function Xd(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function G0(n,e){return as(n,e.toTimestamp())}function dt(n){return ee(!!n),H.fromTimestamp(function(t){const r=Zt(t);return new ye(r.seconds,r.nanos)}(n))}function Aa(n,e){return zo(n,e).canonicalString()}function zo(n,e){const t=function(i){return new se(["projects",i.projectId,"databases",i.database])}(n).child("documents");return e===void 0?t:t.child(e)}function Jd(n){const e=se.fromString(n);return ee(rh(e)),e}function $o(n,e){return Aa(n.databaseId,e.path)}function mo(n,e){const t=Jd(e);if(t.get(1)!==n.databaseId.projectId)throw new O(k.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new O(k.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new U(eh(t))}function Zd(n,e){return Aa(n.databaseId,e)}function Y0(n){const e=Jd(n);return e.length===4?se.emptyPath():eh(e)}function qo(n){return new se(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function eh(n){return ee(n.length>4&&n.get(4)==="documents"),n.popFirst(5)}function nu(n,e,t){return{name:$o(n,e),fields:t.value.mapValue.fields}}function K0(n,e){let t;if("targetChange"in e){e.targetChange;const r=function(h){return h==="NO_CHANGE"?0:h==="ADD"?1:h==="REMOVE"?2:h==="CURRENT"?3:h==="RESET"?4:j()}(e.targetChange.targetChangeType||"NO_CHANGE"),i=e.targetChange.targetIds||[],s=function(h,f){return h.useProto3Json?(ee(f===void 0||typeof f=="string"),Pe.fromBase64String(f||"")):(ee(f===void 0||f instanceof Buffer||f instanceof Uint8Array),Pe.fromUint8Array(f||new Uint8Array))}(n,e.targetChange.resumeToken),a=e.targetChange.cause,l=a&&function(h){const f=h.code===void 0?k.UNKNOWN:Yd(h.code);return new O(f,h.message||"")}(a);t=new Qd(r,i,s,l||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const i=mo(n,r.document.name),s=dt(r.document.updateTime),a=r.document.createTime?dt(r.document.createTime):H.min(),l=new je({mapValue:{fields:r.document.fields}}),u=Ve.newFoundDocument(i,s,a,l),h=r.targetIds||[],f=r.removedTargetIds||[];t=new qi(h,f,u.key,u)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const i=mo(n,r.document),s=r.readTime?dt(r.readTime):H.min(),a=Ve.newNoDocument(i,s),l=r.removedTargetIds||[];t=new qi([],l,a.key,a)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const i=mo(n,r.document),s=r.removedTargetIds||[];t=new qi([],s,i,null)}else{if(!("filter"in e))return j();{e.filter;const r=e.filter;r.targetId;const{count:i=0,unchangedNames:s}=r,a=new B0(i,s),l=r.targetId;t=new Kd(l,a)}}return t}function Q0(n,e){let t;if(e instanceof ri)t={update:nu(n,e.key,e.value)};else if(e instanceof Ia)t={delete:$o(n,e.key)};else if(e instanceof nn)t={update:nu(n,e.key,e.data),updateMask:sv(e.fieldMask)};else{if(!(e instanceof V0))return j();t={verify:$o(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(r=>function(s,a){const l=a.transform;if(l instanceof ss)return{fieldPath:a.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(l instanceof Wr)return{fieldPath:a.field.canonicalString(),appendMissingElements:{values:l.elements}};if(l instanceof Gr)return{fieldPath:a.field.canonicalString(),removeAllFromArray:{values:l.elements}};if(l instanceof os)return{fieldPath:a.field.canonicalString(),increment:l.Pe};throw j()}(0,r))),e.precondition.isNone||(t.currentDocument=function(i,s){return s.updateTime!==void 0?{updateTime:G0(i,s.updateTime)}:s.exists!==void 0?{exists:s.exists}:j()}(n,e.precondition)),t}function X0(n,e){return n&&n.length>0?(ee(e!==void 0),n.map(t=>function(i,s){let a=i.updateTime?dt(i.updateTime):dt(s);return a.isEqual(H.min())&&(a=dt(s)),new D0(a,i.transformResults||[])}(t,e))):[]}function J0(n,e){return{documents:[Zd(n,e.path)]}}function Z0(n,e){const t={structuredQuery:{}},r=e.path;let i;e.collectionGroup!==null?(i=r,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(i=r.popLast(),t.structuredQuery.from=[{collectionId:r.lastSegment()}]),t.parent=Zd(n,i);const s=function(h){if(h.length!==0)return nh(ot.create(h,"and"))}(e.filters);s&&(t.structuredQuery.where=s);const a=function(h){if(h.length!==0)return h.map(f=>function(_){return{field:Ln(_.field),direction:nv(_.dir)}}(f))}(e.orderBy);a&&(t.structuredQuery.orderBy=a);const l=Uo(n,e.limit);return l!==null&&(t.structuredQuery.limit=l),e.startAt&&(t.structuredQuery.startAt=function(h){return{before:h.inclusive,values:h.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(h){return{before:!h.inclusive,values:h.position}}(e.endAt)),{_t:t,parent:i}}function ev(n){let e=Y0(n.parent);const t=n.structuredQuery,r=t.from?t.from.length:0;let i=null;if(r>0){ee(r===1);const f=t.from[0];f.allDescendants?i=f.collectionId:e=e.child(f.collectionId)}let s=[];t.where&&(s=function(g){const _=th(g);return _ instanceof ot&&kd(_)?_.getFilters():[_]}(t.where));let a=[];t.orderBy&&(a=function(g){return g.map(_=>function(R){return new Hr(Bn(R.field),function(P){switch(P){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(R.direction))}(_))}(t.orderBy));let l=null;t.limit&&(l=function(g){let _;return _=typeof g=="object"?g.value:g,ys(_)?null:_}(t.limit));let u=null;t.startAt&&(u=function(g){const _=!!g.before,T=g.values||[];return new rs(T,_)}(t.startAt));let h=null;return t.endAt&&(h=function(g){const _=!g.before,T=g.values||[];return new rs(T,_)}(t.endAt)),_0(e,i,a,s,l,"F",u,h)}function tv(n,e){const t=function(i){switch(i){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return j()}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function th(n){return n.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const r=Bn(t.unaryFilter.field);return pe.create(r,"==",{doubleValue:NaN});case"IS_NULL":const i=Bn(t.unaryFilter.field);return pe.create(i,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const s=Bn(t.unaryFilter.field);return pe.create(s,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const a=Bn(t.unaryFilter.field);return pe.create(a,"!=",{nullValue:"NULL_VALUE"});default:return j()}}(n):n.fieldFilter!==void 0?function(t){return pe.create(Bn(t.fieldFilter.field),function(i){switch(i){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return j()}}(t.fieldFilter.op),t.fieldFilter.value)}(n):n.compositeFilter!==void 0?function(t){return ot.create(t.compositeFilter.filters.map(r=>th(r)),function(i){switch(i){case"AND":return"and";case"OR":return"or";default:return j()}}(t.compositeFilter.op))}(n):j()}function nv(n){return q0[n]}function rv(n){return j0[n]}function iv(n){return H0[n]}function Ln(n){return{fieldPath:n.canonicalString()}}function Bn(n){return Se.fromServerFormat(n.fieldPath)}function nh(n){return n instanceof pe?function(t){if(t.op==="=="){if($c(t.value))return{unaryFilter:{field:Ln(t.field),op:"IS_NAN"}};if(zc(t.value))return{unaryFilter:{field:Ln(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if($c(t.value))return{unaryFilter:{field:Ln(t.field),op:"IS_NOT_NAN"}};if(zc(t.value))return{unaryFilter:{field:Ln(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:Ln(t.field),op:rv(t.op),value:t.value}}}(n):n instanceof ot?function(t){const r=t.getFilters().map(i=>nh(i));return r.length===1?r[0]:{compositeFilter:{op:iv(t.op),filters:r}}}(n):j()}function sv(n){const e=[];return n.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function rh(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uv{constructor(){this.changes=new ar(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Ve.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?N.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mv{constructor(){this.sessionToken=Pe.EMPTY_BYTE_STRING}getSessionToken(e){return N.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,N.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sa{constructor(){this.Tr=new Re(we.Er),this.dr=new Re(we.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const r=new we(e,t);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Vr(new we(e,t))}mr(e,t){e.forEach(r=>this.removeReference(r,t))}gr(e){const t=new U(new se([])),r=new we(t,e),i=new we(t,e+1),s=[];return this.dr.forEachInRange([r,i],a=>{this.Vr(a),s.push(a.key)}),s}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new U(new se([])),r=new we(t,e),i=new we(t,e+1);let s=Y();return this.dr.forEachInRange([r,i],a=>{s=s.add(a.key)}),s}containsKey(e){const t=new we(e,0),r=this.Tr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class we{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return U.comparator(e.key,t.key)||J(e.wr,t.wr)}static Ar(e,t){return J(e.wr,t.wr)||U.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gv{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.Sr=1,this.br=new Re(we.Er)}checkEmpty(e){return N.resolve(this.mutationQueue.length===0)}addMutationBatch(e,t,r,i){const s=this.Sr;this.Sr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const a=new O0(s,t,r,i);this.mutationQueue.push(a);for(const l of i)this.br=this.br.add(new we(l.key,s)),this.indexManager.addToCollectionParentIndex(e,l.key.path.popLast());return N.resolve(a)}lookupMutationBatch(e,t){return N.resolve(this.Dr(t))}getNextMutationBatchAfterBatchId(e,t){const r=t+1,i=this.vr(r),s=i<0?0:i;return N.resolve(this.mutationQueue.length>s?this.mutationQueue[s]:null)}getHighestUnacknowledgedBatchId(){return N.resolve(this.mutationQueue.length===0?-1:this.Sr-1)}getAllMutationBatches(e){return N.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const r=new we(t,0),i=new we(t,Number.POSITIVE_INFINITY),s=[];return this.br.forEachInRange([r,i],a=>{const l=this.Dr(a.wr);s.push(l)}),N.resolve(s)}getAllMutationBatchesAffectingDocumentKeys(e,t){let r=new Re(J);return t.forEach(i=>{const s=new we(i,0),a=new we(i,Number.POSITIVE_INFINITY);this.br.forEachInRange([s,a],l=>{r=r.add(l.wr)})}),N.resolve(this.Cr(r))}getAllMutationBatchesAffectingQuery(e,t){const r=t.path,i=r.length+1;let s=r;U.isDocumentKey(s)||(s=s.child(""));const a=new we(new U(s),0);let l=new Re(J);return this.br.forEachWhile(u=>{const h=u.key.path;return!!r.isPrefixOf(h)&&(h.length===i&&(l=l.add(u.wr)),!0)},a),N.resolve(this.Cr(l))}Cr(e){const t=[];return e.forEach(r=>{const i=this.Dr(r);i!==null&&t.push(i)}),t}removeMutationBatch(e,t){ee(this.Fr(t.batchId,"removed")===0),this.mutationQueue.shift();let r=this.br;return N.forEach(t.mutations,i=>{const s=new we(i.key,t.batchId);return r=r.delete(s),this.referenceDelegate.markPotentiallyOrphaned(e,i.key)}).next(()=>{this.br=r})}On(e){}containsKey(e,t){const r=new we(t,0),i=this.br.firstAfterOrEqual(r);return N.resolve(t.isEqual(i&&i.key))}performConsistencyCheck(e){return this.mutationQueue.length,N.resolve()}Fr(e,t){return this.vr(e)}vr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Dr(e){const t=this.vr(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ev{constructor(e,t){this.qr={},this.overlays={},this.Qr=new pa(0),this.Kr=!1,this.Kr=!0,this.$r=new mv,this.referenceDelegate=e(this),this.Ur=new _v(this),this.indexManager=new lv,this.remoteDocumentCache=function(i){return new yv(i)}(r=>this.referenceDelegate.Wr(r)),this.serializer=new ov(t),this.Gr=new fv(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new pv,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let r=this.qr[e.toKey()];return r||(r=new gv(t,this.referenceDelegate),this.qr[e.toKey()]=r),r}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(e,t,r){L("MemoryPersistence","Starting transaction:",e);const i=new wv(this.Qr.next());return this.referenceDelegate.zr(),r(i).next(s=>this.referenceDelegate.jr(i).next(()=>s)).toPromise().then(s=>(i.raiseOnCommittedEvent(),s))}Hr(e,t){return N.or(Object.values(this.qr).map(r=>()=>r.containsKey(e,t)))}}class wv extends n0{constructor(e){super(),this.currentSequenceNumber=e}}class Ra{constructor(e){this.persistence=e,this.Jr=new Sa,this.Yr=null}static Zr(e){return new Ra(e)}get Xr(){if(this.Yr)return this.Yr;throw j()}addReference(e,t,r){return this.Jr.addReference(r,t),this.Xr.delete(r.toString()),N.resolve()}removeReference(e,t,r){return this.Jr.removeReference(r,t),this.Xr.add(r.toString()),N.resolve()}markPotentiallyOrphaned(e,t){return this.Xr.add(t.toString()),N.resolve()}removeTarget(e,t){this.Jr.gr(t.targetId).forEach(i=>this.Xr.add(i.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next(i=>{i.forEach(s=>this.Xr.add(s.toString()))}).next(()=>r.removeTargetData(e,t))}zr(){this.Yr=new Set}jr(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return N.forEach(this.Xr,r=>{const i=U.fromPath(r);return this.ei(e,i).next(s=>{s||t.removeEntry(i,H.min())})}).next(()=>(this.Yr=null,t.apply(e)))}updateLimboDocument(e,t){return this.ei(e,t).next(r=>{r?this.Xr.delete(t.toString()):this.Xr.add(t.toString())})}Wr(e){return 0}ei(e,t){return N.or([()=>N.resolve(this.Jr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Hr(e,t)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tv{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return sp()?8:r0(Oe())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,i){const s={result:null};return this.Yi(e,t).next(a=>{s.result=a}).next(()=>{if(!s.result)return this.Zi(e,t,i,r).next(a=>{s.result=a})}).next(()=>{if(s.result)return;const a=new Iv;return this.Xi(e,t,a).next(l=>{if(s.result=l,this.zi)return this.es(e,t,a,l.size)})}).next(()=>s.result)}es(e,t,r,i){return r.documentReadCount<this.ji?(Ar()<=K.DEBUG&&L("QueryEngine","SDK will not create cache indexes for query:",On(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),N.resolve()):(Ar()<=K.DEBUG&&L("QueryEngine","Query:",On(t),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Hi*i?(Ar()<=K.DEBUG&&L("QueryEngine","The SDK decides to create cache indexes for query:",On(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,ut(t))):N.resolve())}Yi(e,t){if(Wc(t))return N.resolve(null);let r=ut(t);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(t.limit!==null&&i===1&&(t=is(t,null,"F"),r=ut(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const a=Y(...s);return this.Ji.getDocuments(e,a).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const h=this.ts(t,l);return this.ns(t,h,a,u.readTime)?this.Yi(e,is(t,null,"F")):this.rs(e,h,t,u)}))})))}Zi(e,t,r,i){return Wc(t)||i.isEqual(H.min())?N.resolve(null):this.Ji.getDocuments(e,r).next(s=>{const a=this.ts(t,s);return this.ns(t,a,r,i)?N.resolve(null):(Ar()<=K.DEBUG&&L("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),On(t)),this.rs(e,a,t,Jy(i,-1)).next(l=>l))})}ts(e,t){let r=new Re(Ld(e));return t.forEach((i,s)=>{_s(e,s)&&(r=r.add(s))}),r}ns(e,t,r,i){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const s=e.limitType==="F"?t.last():t.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Xi(e,t,r){return Ar()<=K.DEBUG&&L("QueryEngine","Using full collection scan to execute query:",On(t)),this.Ji.getDocumentsMatchingQuery(e,t,Jt.min(),r)}rs(e,t,r,i){return this.Ji.getDocumentsMatchingQuery(e,r,i).next(s=>(t.forEach(a=>{s=s.insert(a.key,a)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bv{constructor(e,t,r,i){this.persistence=e,this.ss=t,this.serializer=i,this.os=new oe(J),this._s=new ar(s=>va(s),_a),this.us=new Map,this.cs=e.getRemoteDocumentCache(),this.Ur=e.getTargetCache(),this.Gr=e.getBundleCache(),this.ls(r)}ls(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new hv(this.cs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.cs.setIndexManager(this.indexManager),this.ss.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",t=>e.collect(t,this.os))}}function Av(n,e,t,r){return new bv(n,e,t,r)}async function ih(n,e){const t=W(n);return await t.persistence.runTransaction("Handle user change","readonly",r=>{let i;return t.mutationQueue.getAllMutationBatches(r).next(s=>(i=s,t.ls(e),t.mutationQueue.getAllMutationBatches(r))).next(s=>{const a=[],l=[];let u=Y();for(const h of i){a.push(h.batchId);for(const f of h.mutations)u=u.add(f.key)}for(const h of s){l.push(h.batchId);for(const f of h.mutations)u=u.add(f.key)}return t.localDocuments.getDocuments(r,u).next(h=>({hs:h,removedBatchIds:a,addedBatchIds:l}))})})}function Sv(n,e){const t=W(n);return t.persistence.runTransaction("Acknowledge batch","readwrite-primary",r=>{const i=e.batch.keys(),s=t.cs.newChangeBuffer({trackRemovals:!0});return function(l,u,h,f){const g=h.batch,_=g.keys();let T=N.resolve();return _.forEach(R=>{T=T.next(()=>f.getEntry(u,R)).next(D=>{const P=h.docVersions.get(R);ee(P!==null),D.version.compareTo(P)<0&&(g.applyToRemoteDocument(D,h),D.isValidDocument()&&(D.setReadTime(h.commitVersion),f.addEntry(D)))})}),T.next(()=>l.mutationQueue.removeMutationBatch(u,g))}(t,r,e,s).next(()=>s.apply(r)).next(()=>t.mutationQueue.performConsistencyCheck(r)).next(()=>t.documentOverlayCache.removeOverlaysForBatchId(r,i,e.batch.batchId)).next(()=>t.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(r,function(l){let u=Y();for(let h=0;h<l.mutationResults.length;++h)l.mutationResults[h].transformResults.length>0&&(u=u.add(l.batch.mutations[h].key));return u}(e))).next(()=>t.localDocuments.getDocuments(r,i))})}function sh(n){const e=W(n);return e.persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.Ur.getLastRemoteSnapshotVersion(t))}function Rv(n,e){const t=W(n),r=e.snapshotVersion;let i=t.os;return t.persistence.runTransaction("Apply remote event","readwrite-primary",s=>{const a=t.cs.newChangeBuffer({trackRemovals:!0});i=t.os;const l=[];e.targetChanges.forEach((f,g)=>{const _=i.get(g);if(!_)return;l.push(t.Ur.removeMatchingKeys(s,f.removedDocuments,g).next(()=>t.Ur.addMatchingKeys(s,f.addedDocuments,g)));let T=_.withSequenceNumber(s.currentSequenceNumber);e.targetMismatches.get(g)!==null?T=T.withResumeToken(Pe.EMPTY_BYTE_STRING,H.min()).withLastLimboFreeSnapshotVersion(H.min()):f.resumeToken.approximateByteSize()>0&&(T=T.withResumeToken(f.resumeToken,r)),i=i.insert(g,T),function(D,P,C){return D.resumeToken.approximateByteSize()===0||P.snapshotVersion.toMicroseconds()-D.snapshotVersion.toMicroseconds()>=3e8?!0:C.addedDocuments.size+C.modifiedDocuments.size+C.removedDocuments.size>0}(_,T,f)&&l.push(t.Ur.updateTargetData(s,T))});let u=Ct(),h=Y();if(e.documentUpdates.forEach(f=>{e.resolvedLimboDocuments.has(f)&&l.push(t.persistence.referenceDelegate.updateLimboDocument(s,f))}),l.push(Pv(s,a,e.documentUpdates).next(f=>{u=f.Ps,h=f.Is})),!r.isEqual(H.min())){const f=t.Ur.getLastRemoteSnapshotVersion(s).next(g=>t.Ur.setTargetsMetadata(s,s.currentSequenceNumber,r));l.push(f)}return N.waitFor(l).next(()=>a.apply(s)).next(()=>t.localDocuments.getLocalViewOfDocuments(s,u,h)).next(()=>u)}).then(s=>(t.os=i,s))}function Pv(n,e,t){let r=Y(),i=Y();return t.forEach(s=>r=r.add(s)),e.getEntries(n,r).next(s=>{let a=Ct();return t.forEach((l,u)=>{const h=s.get(l);u.isFoundDocument()!==h.isFoundDocument()&&(i=i.add(l)),u.isNoDocument()&&u.version.isEqual(H.min())?(e.removeEntry(l,u.readTime),a=a.insert(l,u)):!h.isValidDocument()||u.version.compareTo(h.version)>0||u.version.compareTo(h.version)===0&&h.hasPendingWrites?(e.addEntry(u),a=a.insert(l,u)):L("LocalStore","Ignoring outdated watch update for ",l,". Current version:",h.version," Watch version:",u.version)}),{Ps:a,Is:i}})}function Cv(n,e){const t=W(n);return t.persistence.runTransaction("Get next mutation batch","readonly",r=>(e===void 0&&(e=-1),t.mutationQueue.getNextMutationBatchAfterBatchId(r,e)))}function xv(n,e){const t=W(n);return t.persistence.runTransaction("Allocate target","readwrite",r=>{let i;return t.Ur.getTargetData(r,e).next(s=>s?(i=s,N.resolve(i)):t.Ur.allocateTargetId(r).next(a=>(i=new Ht(e,a,"TargetPurposeListen",r.currentSequenceNumber),t.Ur.addTargetData(r,i).next(()=>i))))}).then(r=>{const i=t.os.get(r.targetId);return(i===null||r.snapshotVersion.compareTo(i.snapshotVersion)>0)&&(t.os=t.os.insert(r.targetId,r),t._s.set(e,r.targetId)),r})}async function jo(n,e,t){const r=W(n),i=r.os.get(e),s=t?"readwrite":"readwrite-primary";try{t||await r.persistence.runTransaction("Release target",s,a=>r.persistence.referenceDelegate.removeTarget(a,i))}catch(a){if(!ni(a))throw a;L("LocalStore",`Failed to update sequence numbers for target ${e}: ${a}`)}r.os=r.os.remove(e),r._s.delete(i.target)}function ru(n,e,t){const r=W(n);let i=H.min(),s=Y();return r.persistence.runTransaction("Execute query","readwrite",a=>function(u,h,f){const g=W(u),_=g._s.get(f);return _!==void 0?N.resolve(g.os.get(_)):g.Ur.getTargetData(h,f)}(r,a,ut(e)).next(l=>{if(l)return i=l.lastLimboFreeSnapshotVersion,r.Ur.getMatchingKeysForTargetId(a,l.targetId).next(u=>{s=u})}).next(()=>r.ss.getDocumentsMatchingQuery(a,e,t?i:H.min(),t?s:Y())).next(l=>(kv(r,w0(e),l),{documents:l,Ts:s})))}function kv(n,e,t){let r=n.us.get(e)||H.min();t.forEach((i,s)=>{s.readTime.compareTo(r)>0&&(r=s.readTime)}),n.us.set(e,r)}class iu{constructor(){this.activeTargetIds=R0()}fs(e){this.activeTargetIds=this.activeTargetIds.add(e)}gs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Vs(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class Dv{constructor(){this.so=new iu,this.oo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,r){}addLocalQueryTarget(e,t=!0){return t&&this.so.fs(e),this.oo[e]||"not-current"}updateQueryState(e,t,r){this.oo[e]=t}removeLocalQueryTarget(e){this.so.gs(e)}isLocalQueryTarget(e){return this.so.activeTargetIds.has(e)}clearQueryState(e){delete this.oo[e]}getAllActiveQueryTargets(){return this.so.activeTargetIds}isActiveQueryTarget(e){return this.so.activeTargetIds.has(e)}start(){return this.so=new iu,Promise.resolve()}handleUserChange(e,t,r){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Me="WebChannelConnection";class Ov extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",i=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${i}/databases/${s}`,this.Co=this.databaseId.database==="(default)"?`project_id=${i}`:`project_id=${i}&database_id=${s}`}get Fo(){return!1}Mo(t,r,i,s,a){const l=go(),u=this.xo(t,r.toUriEncodedString());L("RestConnection",`Sending RPC '${t}' ${l}:`,u,i);const h={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(h,s,a),this.No(t,u,h,i).then(f=>(L("RestConnection",`Received RPC '${t}' ${l}: `,f),f),f=>{throw Qn("RestConnection",`RPC '${t}' ${l} failed with error: `,f,"url: ",u,"request:",i),f})}Lo(t,r,i,s,a,l){return this.Mo(t,r,i,s,a)}Oo(t,r,i){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+sr}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((s,a)=>t[a]=s),i&&i.headers.forEach((s,a)=>t[a]=s)}xo(t,r){const i=Nv[t];return`${this.Do}/v1/${r}:${i}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,i){const s=go();return new Promise((a,l)=>{const u=new _d;u.setWithCredentials(!0),u.listenOnce(Ed.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case Ui.NO_ERROR:const f=u.getResponseJson();L(Me,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(f)),a(f);break;case Ui.TIMEOUT:L(Me,`RPC '${e}' ${s} timed out`),l(new O(k.DEADLINE_EXCEEDED,"Request time out"));break;case Ui.HTTP_ERROR:const g=u.getStatus();if(L(Me,`RPC '${e}' ${s} failed with status:`,g,"response text:",u.getResponseText()),g>0){let _=u.getResponseJson();Array.isArray(_)&&(_=_[0]);const T=_==null?void 0:_.error;if(T&&T.status&&T.message){const R=function(P){const C=P.toLowerCase().replace(/_/g,"-");return Object.values(k).indexOf(C)>=0?C:k.UNKNOWN}(T.status);l(new O(R,T.message))}else l(new O(k.UNKNOWN,"Server responded with status "+u.getStatus()))}else l(new O(k.UNAVAILABLE,"Connection failed."));break;default:j()}}finally{L(Me,`RPC '${e}' ${s} completed.`)}});const h=JSON.stringify(i);L(Me,`RPC '${e}' ${s} sending request:`,i),u.send(t,"POST",h,r,15)})}Bo(e,t,r){const i=go(),s=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=Td(),l=Id(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Oo(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const f=s.join("");L(Me,`Creating RPC '${e}' stream ${i}: ${f}`,u);const g=a.createWebChannel(f,u);let _=!1,T=!1;const R=new Vv({Io:P=>{T?L(Me,`Not sending because RPC '${e}' stream ${i} is closed:`,P):(_||(L(Me,`Opening RPC '${e}' stream ${i} transport.`),g.open(),_=!0),L(Me,`RPC '${e}' stream ${i} sending:`,P),g.send(P))},To:()=>g.close()}),D=(P,C,x)=>{P.listen(C,M=>{try{x(M)}catch(B){setTimeout(()=>{throw B},0)}})};return D(g,Pr.EventType.OPEN,()=>{T||(L(Me,`RPC '${e}' stream ${i} transport opened.`),R.yo())}),D(g,Pr.EventType.CLOSE,()=>{T||(T=!0,L(Me,`RPC '${e}' stream ${i} transport closed`),R.So())}),D(g,Pr.EventType.ERROR,P=>{T||(T=!0,Qn(Me,`RPC '${e}' stream ${i} transport errored:`,P),R.So(new O(k.UNAVAILABLE,"The operation could not be completed")))}),D(g,Pr.EventType.MESSAGE,P=>{var C;if(!T){const x=P.data[0];ee(!!x);const M=x,B=M.error||((C=M[0])===null||C===void 0?void 0:C.error);if(B){L(Me,`RPC '${e}' stream ${i} received error:`,B);const G=B.status;let z=function(y){const w=fe[y];if(w!==void 0)return Yd(w)}(G),E=B.message;z===void 0&&(z=k.INTERNAL,E="Unknown error status: "+G+" with message "+B.message),T=!0,R.So(new O(z,E)),g.close()}else L(Me,`RPC '${e}' stream ${i} received:`,x),R.bo(x)}}),D(l,wd.STAT_EVENT,P=>{P.stat===No.PROXY?L(Me,`RPC '${e}' stream ${i} detected buffering proxy`):P.stat===No.NOPROXY&&L(Me,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{R.wo()},0),R}}function yo(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rn{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new rn(this.firestore,e,this._query)}}class We{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Qt(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new We(this.firestore,e,this._key)}}class Qt extends rn{constructor(e,t,r){super(e,t,Ea(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new We(this.firestore,null,new U(e))}withConverter(e){return new Qt(this.firestore,e,this._path)}}function P_(n,e,...t){if(n=me(n),Ch("collection","path",e),n instanceof Rs){const r=se.fromString(e,...t);return mu(r),new Qt(n,null,r)}{if(!(n instanceof We||n instanceof Qt))throw new O(k.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(se.fromString(e,...t));return mu(r),new Qt(n.firestore,null,r)}}function Hn(n,e,...t){if(n=me(n),arguments.length===1&&(e=Ad.newId()),Ch("doc","path",e),n instanceof Rs){const r=se.fromString(e,...t);return pu(r),new We(n,null,new U(r))}{if(!(n instanceof We||n instanceof Qt))throw new O(k.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(se.fromString(e,...t));return pu(r),new We(n.firestore,n instanceof Qt?n.converter:null,new U(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nr{constructor(e){this._byteString=e}static fromBase64String(e){try{return new nr(Pe.fromBase64String(e))}catch(t){throw new O(k.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new nr(Pe.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cs{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new O(k.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Se(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k_=/^__.*__$/;class D_{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return this.fieldMask!==null?new nn(e,this.data,this.fieldMask,t,this.fieldTransforms):new ri(e,this.data,t,this.fieldTransforms)}}class xh{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new nn(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function kh(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw j()}}class Ua{constructor(e,t,r,i,s,a){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=i,s===void 0&&this.vu(),this.fieldTransforms=s||[],this.fieldMask=a||[]}get path(){return this.settings.path}get Cu(){return this.settings.Cu}Fu(e){return new Ua(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Mu(e){var t;const r=(t=this.path)===null||t===void 0?void 0:t.child(e),i=this.Fu({path:r,xu:!1});return i.Ou(e),i}Nu(e){var t;const r=(t=this.path)===null||t===void 0?void 0:t.child(e),i=this.Fu({path:r,xu:!1});return i.vu(),i}Lu(e){return this.Fu({path:void 0,xu:!0})}Bu(e){return us(e,this.settings.methodName,this.settings.ku||!1,this.path,this.settings.qu)}contains(e){return this.fieldMask.find(t=>e.isPrefixOf(t))!==void 0||this.fieldTransforms.find(t=>e.isPrefixOf(t.field))!==void 0}vu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Ou(this.path.get(e))}Ou(e){if(e.length===0)throw this.Bu("Document fields must not be empty");if(kh(this.Cu)&&k_.test(e))throw this.Bu('Document fields cannot begin and end with "__"')}}class M_{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||Ts(e)}Qu(e,t,r,i=!1){return new Ua({Cu:e,methodName:t,qu:r,path:Se.emptyPath(),xu:!1,ku:i},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function xs(n){const e=n._freezeSettings(),t=Ts(n._databaseId);return new M_(n._databaseId,!!e.ignoreUndefinedProperties,t)}function za(n,e,t,r,i,s={}){const a=n.Qu(s.merge||s.mergeFields?2:0,e,t,i);$a("Data must be an object, but it was:",a,r);const l=Dh(r,a);let u,h;if(s.merge)u=new Je(a.fieldMask),h=a.fieldTransforms;else if(s.mergeFields){const f=[];for(const g of s.mergeFields){const _=Yo(e,g,t);if(!a.contains(_))throw new O(k.INVALID_ARGUMENT,`Field '${_}' is specified in your field mask but missing from your input data.`);Nh(f,_)||f.push(_)}u=new Je(f),h=a.fieldTransforms.filter(g=>u.covers(g.field))}else u=null,h=a.fieldTransforms;return new D_(new je(l),u,h)}class ks extends La{_toFieldTransform(e){if(e.Cu!==2)throw e.Cu===1?e.Bu(`${this._methodName}() can only appear at the top level of your update data`):e.Bu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof ks}}function N_(n,e,t,r){const i=n.Qu(1,e,t);$a("Data must be an object, but it was:",i,r);const s=[],a=je.empty();Sn(r,(u,h)=>{const f=qa(e,u,t);h=me(h);const g=i.Nu(f);if(h instanceof ks)s.push(f);else{const _=ai(h,g);_!=null&&(s.push(f),a.set(f,_))}});const l=new Je(s);return new xh(a,l,i.fieldTransforms)}function V_(n,e,t,r,i,s){const a=n.Qu(1,e,t),l=[Yo(e,r,t)],u=[i];if(s.length%2!=0)throw new O(k.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let _=0;_<s.length;_+=2)l.push(Yo(e,s[_])),u.push(s[_+1]);const h=[],f=je.empty();for(let _=l.length-1;_>=0;--_)if(!Nh(h,l[_])){const T=l[_];let R=u[_];R=me(R);const D=a.Nu(T);if(R instanceof ks)h.push(T);else{const P=ai(R,D);P!=null&&(h.push(T),f.set(T,P))}}const g=new Je(h);return new xh(f,g,a.fieldTransforms)}function O_(n,e,t,r=!1){return ai(t,n.Qu(r?4:3,e))}function ai(n,e){if(Mh(n=me(n)))return $a("Unsupported field value:",e,n),Dh(n,e);if(n instanceof La)return function(r,i){if(!kh(i.Cu))throw i.Bu(`${r._methodName}() can only be used with update() and set()`);if(!i.path)throw i.Bu(`${r._methodName}() is not currently supported inside arrays`);const s=r._toFieldTransform(i);s&&i.fieldTransforms.push(s)}(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.xu&&e.Cu!==4)throw e.Bu("Nested arrays are not supported");return function(r,i){const s=[];let a=0;for(const l of r){let u=ai(l,i.Lu(a));u==null&&(u={nullValue:"NULL_VALUE"}),s.push(u),a++}return{arrayValue:{values:s}}}(n,e)}return function(r,i){if((r=me(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return P0(i.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const s=ye.fromDate(r);return{timestampValue:as(i.serializer,s)}}if(r instanceof ye){const s=new ye(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:as(i.serializer,s)}}if(r instanceof Ba)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof nr)return{bytesValue:Xd(i.serializer,r._byteString)};if(r instanceof We){const s=i.databaseId,a=r.firestore._databaseId;if(!a.isEqual(s))throw i.Bu(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${s.projectId}/${s.database}`);return{referenceValue:Aa(r.firestore._databaseId||i.databaseId,r._key.path)}}if(r instanceof Fa)return function(a,l){return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:a.toArray().map(u=>{if(typeof u!="number")throw l.Bu("VectorValues must only contain numeric values.");return wa(l.serializer,u)})}}}}}}(r,i);throw i.Bu(`Unsupported field value: ${Ss(r)}`)}(n,e)}function Dh(n,e){const t={};return Sd(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Sn(n,(r,i)=>{const s=ai(i,e.Mu(r));s!=null&&(t[r]=s)}),{mapValue:{fields:t}}}function Mh(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof ye||n instanceof Ba||n instanceof nr||n instanceof We||n instanceof La||n instanceof Fa)}function $a(n,e,t){if(!Mh(t)||!function(i){return typeof i=="object"&&i!==null&&(Object.getPrototypeOf(i)===Object.prototype||Object.getPrototypeOf(i)===null)}(t)){const r=Ss(t);throw r==="an object"?e.Bu(n+" a custom object"):e.Bu(n+" "+r)}}function Yo(n,e,t){if((e=me(e))instanceof Cs)return e._internalPath;if(typeof e=="string")return qa(n,e);throw us("Field path arguments must be of type string or ",n,!1,void 0,t)}const L_=new RegExp("[~\\*/\\[\\]]");function qa(n,e,t){if(e.search(L_)>=0)throw us(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new Cs(...e.split("."))._internalPath}catch{throw us(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function us(n,e,t,r,i){const s=r&&!r.isEmpty(),a=i!==void 0;let l=`Function ${e}() called with invalid data`;t&&(l+=" (via `toFirestore()`)"),l+=". ";let u="";return(s||a)&&(u+=" (found",s&&(u+=` in field ${r}`),a&&(u+=` in document ${i}`),u+=")"),new O(k.INVALID_ARGUMENT,l+n+u)}function Nh(n,e){return n.some(t=>t.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bh(n){n=xt(n,We);const e=xt(n.firestore,cr);return T_(Ps(e),n._key).then(t=>H_(e,n,t))}class Fh extends z_{constructor(e){super(),this.firestore=e}convertBytes(e){return new nr(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new We(this.firestore,null,t)}}function Ns(n){n=xt(n,rn);const e=xt(n.firestore,cr),t=Ps(e),r=new Fh(e);return F_(n._query),b_(t,n._query).then(i=>new $_(e,r,n,i))}function Xa(n,e,t){n=xt(n,We);const r=xt(n.firestore,cr),i=Qa(n.converter,e,t);return Ja(r,[za(xs(r),"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,Ze.none())])}function j_(n,e){const t=xt(n.firestore,cr),r=Hn(n),i=Qa(n.converter,e);return Ja(t,[za(xs(n.firestore),"addDoc",r._key,i,n.converter!==null,{}).toMutation(r._key,Ze.exists(!1))]).then(()=>r)}function Ja(n,e){return function(r,i){const s=new At;return r.asyncQueue.enqueueAndForget(async()=>h_(await I_(r),i,s)),s.promise}(Ps(n),e)}function H_(n,e,t){const r=t.docs.get(e._key),i=new Fh(n);return new Lh(n,i,e._key,r,new kr(t.hasPendingWrites,t.fromCache),e.converter)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function ds(n){return Ps(n=xt(n,cr)),new W_(n,e=>Ja(n,e))}(function(e,t=!0){(function(i){sr=i})(rr),Yn(new En("firestore",(r,{instanceIdentifier:i,options:s})=>{const a=r.getProvider("app").getImmediate(),l=new cr(new Hy(r.getProvider("auth-internal")),new Ky(r.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new O(k.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new qr(h.options.projectId,f)}(a,i),a);return s=Object.assign({useFetchStreams:t},s),l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),Kt(Vc,"4.7.3",e),Kt(Vc,"4.7.3","esm2017")})();const Uh={apiKey:"AIzaSyBdbve0H70D-Ch69WlaxEly7PVBFVRB5p0",authDomain:"pensiontools-4b237.firebaseapp.com",projectId:"pensiontools-4b237",storageBucket:"pensiontools-4b237.firebasestorage.app",messagingSenderId:"760877353696",appId:"1:760877353696:web:2d6f7173c8d7fab6fd9e85",measurementId:"G-80XX542QZE"};function ge(){return Uh.apiKey!=="YOUR_API_KEY"}let Eo=null,et=null,He=null;try{ge()?(Eo=Vu(Uh),et=zy(Eo),He=C_(Eo)):console.warn("Firebase not configured. Login required to save data.")}catch(n){console.error("Firebase initialization error:",n)}const G_=new Et;let qt=null,Br=[];function Y_(){if(!ge()||!et){console.warn("Firebase not configured - auth disabled");return}Cg(et,n=>{console.log("onAuthStateChanged fired:",n?n.email:"null"),qt=n,console.log("Notifying",Br.length,"listeners"),Br.forEach(e=>e(n))})}function K_(n){return console.log("onAuthStateChange: adding listener, currentUser is:",qt&&qt.email),Br.push(n),qt&&(console.log("onAuthStateChange: immediately calling listener with user"),n(qt)),()=>{Br=Br.filter(e=>e!==n)}}function li(){return qt}function sn(){return qt!==null}async function Q_(n,e,t=null){if(!ge()||!et)throw new Error("Firebase not configured");const r=await Tg(et,n,e);return t&&r.user&&await Sg(r.user,{displayName:t}),r}async function X_(n,e){if(!ge()||!et)throw new Error("Firebase not configured");return bg(et,n,e)}async function J_(){if(!ge()||!et)throw new Error("Firebase not configured");console.log("Initiating Google sign-in popup...");try{const n=await Qg(et,G_);return console.log("Google sign-in successful:",n.user.email),n}catch(n){throw console.error("signInWithPopup error:",n.code,n.message),n}}async function Z_(){if(!ge()||!et)throw new Error("Firebase not configured");return xg(et)}async function eE(n){if(!ge()||!et)throw new Error("Firebase not configured");return Ig(et,n)}Y_();function Vs(n,e="settings"){const t=li();return!t||!He?null:Hn(He,"users",t.uid,n,e)}function Os(n){const e=li();return!e||!He?null:P_(He,"users",e.uid,n)}async function zh(){if(!ge())return null;const n=Vs("decision");if(!n)return null;try{const e=await Bh(n);return e.exists()?e.data():null}catch(e){return console.error("Error loading decision data:",e),null}}async function tE(n){if(!ge())return;const e=Vs("decision");if(e)try{await Xa(e,{...n,lastModified:new Date().toISOString()},{merge:!0})}catch(t){throw console.error("Error saving decision data:",t),t}}async function Za(n={}){if(!ge())return[];const e=Os("history");if(!e)return[];try{let t=Lr(e,vu("date",n.sortDesc?"desc":"asc"));n.taxYear&&(t=Lr(e,Wa("taxYear","==",n.taxYear),vu("date",n.sortDesc?"desc":"asc"))),n.limit&&(t=Lr(t,U_(n.limit)));const r=await Ns(t),i=[];return r.forEach(s=>{i.push({id:s.id,...s.data()})}),i}catch(t){return console.error("Error loading decision history:",t),[]}}async function nE(n){if(!ge())return null;const e=Os("history");if(!e)return null;try{const t=Lr(e,Wa("date","==",n.date)),r=await Ns(t);if(!r.empty){const s=r.docs[0].id;return await Xa(Hn(He,"users",li().uid,"history",s),{...n,updatedAt:new Date().toISOString()}),s}return(await j_(e,{...n,createdAt:new Date().toISOString()})).id}catch(t){throw console.error("Error adding history record:",t),t}}async function rE(n){if(!ge())return;const e=Os("history");if(e)try{const t=Lr(e,Wa("date","==",n)),r=await Ns(t),i=ds(He);r.forEach(s=>{i.delete(s.ref)}),await i.commit()}catch(t){throw console.error("Error deleting history record:",t),t}}async function iE(){if(!ge())return;const n=Os("history");if(n)try{const e=await Ns(n),t=500,r=[];let i=ds(He),s=0;e.forEach(a=>{i.delete(a.ref),s++,s>=t&&(r.push(i),i=ds(He),s=0)}),s>0&&r.push(i),await Promise.all(r.map(a=>a.commit()))}catch(e){throw console.error("Error clearing history:",e),e}}async function sE(){if(!ge())return null;const n=Vs("stress");if(!n)return null;try{const e=await Bh(n);return e.exists()?e.data():null}catch(e){return console.error("Error loading stress data:",e),null}}async function $h(n){if(!ge())return;const e=Vs("stress");if(e)try{await Xa(e,{...n,lastModified:new Date().toISOString()},{merge:!0})}catch(t){throw console.error("Error saving stress data:",t),t}}async function oE(){if(!ge())return;const n=li();if(!(!n||!He))try{await iE();const e=ds(He);e.delete(Hn(He,"users",n.uid,"decision","settings")),e.delete(Hn(He,"users",n.uid,"stress","settings")),e.delete(Hn(He,"users",n.uid,"profile","settings")),await e.commit(),console.log("All user data wiped successfully")}catch(e){throw console.error("Error wiping user data:",e),e}}async function aE(){if(!ge())return!1;const n=await zh(),e=await Za({limit:1});return n!==null||e.length>0}let $e=null,vn=null;const qh=5e3;function Hi(){return{settings:{equityMin:qe.EQUITY_MIN,bondMin:qe.BOND_MIN,cashTarget:qe.CASH_TARGET,duration:qe.DURATION_YEARS,baseSalary:qe.BASE_SALARY,protectionFactor:qe.PROTECTION_FACTOR,recoveryBuffer:qe.RECOVERY_BUFFER,consecutiveLimit:qe.CONSECUTIVE_LIMIT,startDate:null,statePension:12e3,statePensionYear:12},taxYears:{"25/26":{pa:12570,brl:50270,hrl:125140,cpi:.04,other:0}},history:[],lastModified:null,checksum:null}}function ci(){return ge()&&sn()}function lE(){$e=null,vn=null}function jh(){return $e&&vn&&Date.now()-vn<qh?$e:Hi()}async function ur(){if($e&&vn&&Date.now()-vn<qh)return $e;if(!ci())return console.warn("Firebase not available - returning defaults"),Hi();try{const n=await zh(),e=await Za();if(n){const t={settings:n.settings||Hi().settings,taxYears:n.taxYears||{},history:e||[],lastModified:n.lastModified,checksum:n.checksum};return $e=t,vn=Date.now(),t}}catch(n){console.error("Error loading from Firebase:",n)}return Hi()}async function el(n){if(!ci())throw new Error("Must be logged in to save data");try{n.lastModified=new Date().toISOString(),n.checksum=cE(n),await tE({settings:n.settings,taxYears:n.taxYears,lastModified:n.lastModified,checksum:n.checksum}),$e=n,vn=Date.now()}catch(e){throw console.error("Error saving to Firebase:",e),new Error("Failed to save decision data")}}function cE(n){const e={settings:n.settings,taxYears:n.taxYears,historyCount:n.history.length,lastHistoryDate:n.history.length>0?n.history[n.history.length-1].date:null};return Su(e)}async function Ls(){return(await ur()).settings}async function tl(n){const e=await ur();e.settings={...e.settings,...n},await el(e)}function Hh(){return{pa:Xe.PERSONAL_ALLOWANCE,brl:Xe.BASIC_RATE_LIMIT,hrl:Xe.HIGHER_RATE_LIMIT,cpi:.04,other:0}}function uE(n){const t=jh().taxYears[n];return t||Hh()}async function dE(n){const t=(await ur()).taxYears[n];return t||Hh()}async function nl(n,e){const t=await ur();t.taxYears[n]={...uE(n),...e},await el(t)}async function Wh(){return(await ur()).taxYears}function hE(n={}){let t=[...jh().history];return n.taxYear&&(t=t.filter(r=>r.taxYear===n.taxYear)),n.startDate&&(t=t.filter(r=>r.date>=n.startDate)),n.endDate&&(t=t.filter(r=>r.date<=n.endDate)),n.sortDesc?t.sort((r,i)=>i.date.localeCompare(r.date)):t.sort((r,i)=>r.date.localeCompare(i.date)),n.limit&&(t=t.slice(0,n.limit)),t}async function Gh(n={}){if(ci())try{return await Za(n)}catch(e){console.error("Error loading history from Firebase:",e)}return hE(n)}async function fE(n){if(!ci())throw new Error("Must be logged in to save history");if(await nE(n),$e){const e=$e.history.findIndex(t=>t.date===n.date);e>=0?$e.history[e]=n:$e.history.push(n),$e.history.sort((t,r)=>t.date.localeCompare(r.date))}}async function pE(n){if(!ci())throw new Error("Must be logged in to delete history");await rE(n),$e&&($e.history=$e.history.filter(e=>e.date!==n))}async function mE(n){const e=Nf(n);e.stdSipp=n.sippDraw-(n.boostAmount||0),await fE(e)}function rl(n,e,t=0){const r=Au(t);let i=n.equityStart,s=n.bondStart,a=n.cashStart,l=n.hodlEnabled?n.hodlStart!==void 0?n.hodlStart:n.hodlValue:0,u=0,h=null,f=0,g=0,_=0,T=0,R=!1,D=!1,P=null,C=0,x=-1;const M=[],B=[];let G=1;M.push({year:0,month:0,equity:i,bond:s,cash:a,hodl:l,total:i+s+a,draw:0,source:"None",inProtection:!1,equityMin:n.equityMin,bondMin:n.bondMin,cashMax:n.cashTarget});for(let z=0;z<n.years*12;z++){const E=Math.floor(z/12),m=z%12,y=m>=3?E:E-1;if(y!==x&&(C=0,x=y),z>0&&z%12===0){const re=e.inflation[E]||.025;B.push(re),G*=1+re}const w=e.equity[E]||0,I=e.inflation[E]||.025,A=E>0?e.inflation[E-1]||.025:I,v=Un(n.equityMin,E,n.duration,G,!0),Le=Un(n.bondMin,E,n.duration,G,!0),Ge=Un(n.cashTarget,E,n.duration,G,!1),an=yE(n,E,G,B),nt=an;let de=R?an*n.protectionMult:an;R&&(C+=nt-de);const at=gE(I,w,A,r),Ye=Math.max(.005,I+.012);if(i*=1+Math.pow(1+w,1/12)-1,s*=1+Math.pow(1+at,1/12)-1,a*=1+Math.pow(1+Ye,1/12)-1,l>0){const Fe=(r()-.5)*2*.06;let ve=0;w<-.1?ve=Math.min(.15,Math.abs(w)*.4):w<-.05&&(ve=Math.abs(w)*.2);let Ie=.069+Fe+ve;Ie=Math.max(-.08,Math.min(.18,Ie)),l*=1+Math.pow(1+Ie,1/12)-1}const Ce=i+s,te=v+Le;R&&Ce>te+5e3&&(R=!1,T=0,g=Math.max(g,_),_=0),R&&(f++,_++);let Ke=0;if(!R&&C>0&&Ce>te+15e3){let re=m>=3?15-m:3-m;re<1&&(re=1);const Be=Ce-te-15e3,Fe=Math.min(C/re,Be/re),ve=nt*.5;Ke=Math.min(Fe,ve),Ke>50&&(de+=Ke,C-=Ke)}let xe="Growth";if(!R&&Ce>=te+de){const re=Math.max(0,i-v),Be=Math.max(0,s-Le),Fe=re+Be;if(Fe>0){if(i-=de*re/Fe,s-=de*Be/Fe,T=0,xe="Growth",a<Ge){const ve=Ce-te-de;if(ve>5e3){const Ie=Math.min((Ge-a)*.3,ve*.5);i-=Ie*re/Fe,s-=Ie*Be/Fe,a+=Ie}}}else a-=de,xe="Cash"}else if(a>=de)a-=de,T++,xe="Cash",!n.disableProtection&&T>=n.consecutiveLimit&&(R=!0);else{const re=de-a;a=0,s>re?(s-=re,xe="Bond"):i>re?(i-=re,xe="Equity"):l>re?(l-=re,u+=re,h===null&&(h=z),xe="HODL"):(D=!0,P=z)}if(i=Math.max(0,i),s=Math.max(0,s),a=Math.max(0,a),(m===0||z===n.years*12-1||D)&&M.push({year:E+m/12,month:z,equity:i,bond:s,cash:a,hodl:l,total:i+s+a,draw:de,boostAmount:Ke,source:xe,inProtection:R,equityMin:v,bondMin:Le,cashMax:Ge}),D)break}return g=Math.max(g,_),{failed:D,years:D?P/12:n.years,failMonth:P,final:i+s+a,finalEquity:i,finalBond:s,finalCash:a,finalHodl:l,protMonths:f,maxConsec:g,hodlUsed:u,hodlUsedMonth:h,hist:M,seed:t}}function gE(n,e,t,r){let i=.15,s=.3,a=.2,l=.1,u=.1,h=.15;const f=t!==void 0?t:n,g=f>.045,_=f>.07;if(g){const M=r()>.3?1:.5;_?(i=.15+.35*M,s=.3-.2*M,h=.15-.1*M,l=.1+.05*M):(i=.15+.2*M,s=.3-.1*M,h=.15-.05*M)}g&&r()<.15&&(i=.2,s=.25,h=.12);const T=n+.005+br(0,.03,r),R=.04-(n>.04?(n-.04)*.5:0)+br(0,.05,r),D=.03+n*.3+br(0,.08,r),P=n*.8+br(0,.15,r),C=Math.max(.005,n+.005),x=e*.5+br(0,.02,r);return i*T+s*R+a*D+l*P+u*C+h*x}function yE(n,e,t,r){n.taxMode==="frozen"?n.pa:n.pa*t;const i=n.taxMode==="frozen"?n.brl:n.brl*t,s=n.baseSalary*t;let a=n.other;for(const f of r)a*=1+Math.min(f,.04);const l=e>=n.statePensionYear?n.statePension*t:0,u=a+l;return Math.max(0,Math.min(i,s)-u)/12}function vE(n,e=1e3){const t=Object.keys(Wi).map(Number).sort((i,s)=>i-s),r=[];for(let i=0;i<e;i++){const s=Au(i*12345),a={equity:{},inflation:{}};for(let l=0;l<n.years;l++){const u=t[Math.floor(s()*t.length)];a.equity[l]=Wi[u],a.inflation[l]=bu[u]||.025}r.push(rl(n,a,i))}return r}function _E(n){const e=Object.keys(Wi).map(Number).sort((i,s)=>i-s),t=Math.max(...e),r=[];for(const i of e){if(i+n.years-1>t)continue;const s={equity:{},inflation:{}};for(let l=0;l<n.years;l++)s.equity[l]=Wi[i+l]||0,s.inflation[l]=bu[i+l]||.025;const a=rl(n,s,i);a.startYear=i,r.push(a)}return r}function EE(n,e){const t={equity:{},inflation:{}};for(let r=0;r<n.years;r++)t.equity[r]=e.equity[r%e.equity.length],t.inflation[r]=e.inflation[r%e.inflation.length];return rl(n,t,999)}function wE(n){const e=n.filter(t=>t.failed).length;return(n.length-e)/n.length*100}function Yh(n){const e=n.filter(l=>!l.failed),t=n.filter(l=>l.failed),r=n.map(l=>l.years).sort((l,u)=>l-u),i=e.map(l=>l.final).sort((l,u)=>l-u),s=n.map(l=>l.protMonths).sort((l,u)=>l-u),a=(l,u)=>l[Math.floor(l.length*u)]||0;return{total:n.length,successCount:e.length,failCount:t.length,successRate:wE(n),survival:{p5:a(r,.05),p10:a(r,.1),p25:a(r,.25),p50:a(r,.5),p75:a(r,.75),p90:a(r,.9),p95:a(r,.95),min:r[0],max:r[r.length-1]},finalValue:{p5:a(i,.05),p10:a(i,.1),p25:a(i,.25),p50:a(i,.5),p75:a(i,.75),p90:a(i,.9),p95:a(i,.95),min:i[0]||0,max:i[i.length-1]||0,avg:e.reduce((l,u)=>l+u.final,0)/(e.length||1)},minYears:r[0],p10Years:a(r,.1),medianYears:a(r,.5),medianFinal:a(i,.5),p10Final:a(i,.1),p90Final:a(i,.9),avgFinal:e.reduce((l,u)=>l+u.final,0)/(e.length||1),protection:{runsWithProtection:n.filter(l=>l.protMonths>0).length,pctWithProtection:n.filter(l=>l.protMonths>0).length/n.length*100,avgMonths:s.reduce((l,u)=>l+u,0)/n.length,maxMonths:Math.max(...s),maxConsecutive:Math.max(...n.map(l=>l.maxConsec)),avgConsecutive:n.reduce((l,u)=>l+u.maxConsec,0)/n.length,p50Months:a(s,.5),p90Months:a(s,.9),p95Months:a(s,.95)},runsWithProtection:n.filter(l=>l.protMonths>0).length,avgProtMonths:s.reduce((l,u)=>l+u,0)/n.length,maxProtMonths:Math.max(...s),maxConsecutive:Math.max(...n.map(l=>l.maxConsec)),avgConsecutive:n.reduce((l,u)=>l+u.maxConsec,0)/n.length,hodl:{runsUsingHodl:n.filter(l=>l.hodlUsed>0).length,pctUsingHodl:n.filter(l=>l.hodlUsed>0).length/n.length*100,avgUsed:n.filter(l=>l.hodlUsed>0).length>0?n.filter(l=>l.hodlUsed>0).reduce((l,u)=>l+u.hodlUsed,0)/n.filter(l=>l.hodlUsed>0).length:0,maxUsed:Math.max(...n.map(l=>l.hodlUsed||0))},runsUsingHodl:n.filter(l=>l.hodlUsed>0).length,avgHodlUsed:n.filter(l=>l.hodlUsed>0).length>0?n.filter(l=>l.hodlUsed>0).reduce((l,u)=>l+u.hodlUsed,0)/n.filter(l=>l.hodlUsed>0).length:0,maxHodlUsed:Math.max(...n.map(l=>l.hodlUsed||0)),failures:t.map(l=>({seed:l.seed,startYear:l.startYear,years:l.years,failMonth:l.failMonth,protMonths:l.protMonths}))}}let Wt=null,_n=null;const Kh=5e3;function Wn(){return{settings:{equityMin:qe.EQUITY_MIN,bondMin:qe.BOND_MIN,cashTarget:qe.CASH_TARGET,duration:qe.DURATION_YEARS,baseSalary:qe.BASE_SALARY,other:0,statePension:12e3,statePensionYear:12,pa:Xe.PERSONAL_ALLOWANCE,brl:Xe.BASIC_RATE_LIMIT,hrl:Xe.HIGHER_RATE_LIMIT,taxMode:"inflates",protectionMult:oo.PROTECTION_MULTIPLIER,consecutiveLimit:qe.CONSECUTIVE_LIMIT,disableProtection:!1,hodlEnabled:oo.HODL_ENABLED,hodlValue:oo.HODL_VALUE},lastModified:null,checksum:null}}function il(){return ge()&&sn()}function IE(){Wt=null,_n=null}function TE(){return Wt&&_n&&Date.now()-_n<Kh?Wt:Wn()}async function Qh(){if(Wt&&_n&&Date.now()-_n<Kh)return Wt;if(!il())return console.warn("Firebase not available - returning defaults"),Wn();try{const n=await sE();if(n){const e={settings:n.settings||Wn().settings,lastModified:n.lastModified,checksum:n.checksum};return Wt=SE(e),_n=Date.now(),Wt}}catch(n){console.error("Error loading stress data from Firebase:",n)}return Wn()}async function bE(n){if(!il())throw new Error("Must be logged in to save data");try{n.lastModified=new Date().toISOString(),n.checksum=AE(n),await $h({settings:n.settings,lastModified:n.lastModified,checksum:n.checksum}),Wt=n,_n=Date.now()}catch(e){throw console.error("Error saving stress data to Firebase:",e),new Error("Failed to save stress data")}}function AE(n){return Su(n.settings)}function SE(n){const e={...Wn()};return n.settings&&(e.settings={...e.settings,...n.settings},n.settings.pacwMin!==void 0&&n.settings.equityMin===void 0&&(e.settings.equityMin=n.settings.pacwMin),n.settings.cgtMin!==void 0&&n.settings.bondMin===void 0&&(e.settings.bondMin=n.settings.cgtMin),n.settings.csh2Target!==void 0&&n.settings.cashTarget===void 0&&(e.settings.cashTarget=n.settings.csh2Target),e.settings.hodlEnabled===void 0&&(e.settings.hodlEnabled=!1),e.settings.hodlValue===void 0&&(e.settings.hodlValue=25e3)),e.lastModified=n.lastModified,e.checksum=n.checksum,e}function RE(){return TE().settings}async function on(){return(await Qh()).settings}async function sl(n){const e=await Qh();e.settings={...e.settings,...n},await bE(e)}async function PE(){if(!il())throw new Error("Must be logged in to reset settings");const n=Wn();await $h({settings:n.settings,lastModified:new Date().toISOString()}),IE()}function ol(n={},e=null){const t=e||RE();return{equityStart:n.equityStart??t.equityMin,bondStart:n.bondStart??t.bondMin,cashStart:n.cashStart??t.cashTarget,equityMin:t.equityMin,bondMin:t.bondMin,cashTarget:t.cashTarget,years:n.years??t.duration,duration:t.duration,baseSalary:t.baseSalary,other:t.other,statePension:t.statePension,statePensionYear:t.statePensionYear,pa:t.pa,brl:t.brl,hrl:t.hrl,taxMode:t.taxMode,protectionMult:t.protectionMult,consecutiveLimit:t.consecutiveLimit,disableProtection:t.disableProtection,hodlEnabled:t.hodlEnabled,hodlValue:t.hodlValue}}function F(n,e=null){const t=Math.abs(n),r=e!==null?e:t<100,i=Math.abs(n).toLocaleString("en-GB",{minimumFractionDigits:r?2:0,maximumFractionDigits:r?2:0});return n<0?`-£${i}`:`£${i}`}function CE(n,e){const t=xE(n);e.innerHTML=t}function xE(n){const e=n,t=e.calculationDetails||{};let r="";const i=e.taxEfficient?"success":"warning",s=e.taxEfficient?"Tax-Efficient Mode":"Standard Mode",a=e.taxEfficient?"✓":"!";if(r+=`<div class="decision-mode ${i}">
  ...
  `}let tn=null,Qo=null,$={introDone:!1,baseSalary:3e4,otherIncome:0,statePension:12e3,statePensionYear:12,equityMin:25e4,bondMin:2e5,cashTarget:5e4,duration:35,taxMode:"inflates",decisionSalary:3e4,decisionEquity:25e4,decisionBond:2e5,decisionCash:5e4,decisionDuration:35},lt="intro",Ee=1;function $E(){lt="intro",Ee=1,$={introDone:!1,baseSalary:3e4,otherIncome:0,statePension:12e3,statePensionYear:12,equityMin:25e4,bondMin:2e5,cashTarget:5e4,duration:35,taxMode:"inflates",decisionSalary:3e4,decisionEquity:25e4,decisionBond:2e5,decisionCash:5e4,decisionDuration:35}}function Xo(n,e){tn=n,Qo=e,$E(),Ft()}function Ft(){tn&&(lt==="intro"?qE():lt==="stress"?WE():lt==="decision"&&YE())}function qE(){tn.innerHTML=`
  ...
  `,ll()}function KE(n){switch(n){case 1:return`
      ...
      `;default:return""}}function al(n,e){let t="";for(let r=1;r<=n;r++){const i=r<e?"done":r===e?"active":"";t+=`<div class="wizard-dot ${i}"></div>`}return t}function ll(){tn.querySelectorAll("[data-action]").forEach(e=>{e.addEventListener("click",()=>QE(e.dataset.action))})}function QE(n){switch(ef(),n){case"skip-all":To();break;case"next":lt==="intro"?Ee<2&&(Ee++,Ft()):lt==="stress"?Ee<6&&(Ee++,Ft()):lt==="decision"&&Ee<4&&(Ee++,Ft());break;case"back":Ee>1&&(Ee--,Ft());break;case"start-stress":lt="stress",Ee=1,Ft();break;case"skip-stress":lt="decision",Ee=1,$.decisionSalary=$.baseSalary,$.decisionEquity=$.equityMin,$.decisionBond=$.bondMin,$.decisionCash=$.cashTarget,$.decisionDuration=$.duration,Ft();break;case"finish-stress":lt="decision",Ee=1,$.decisionSalary=$.baseSalary,$.decisionEquity=$.equityMin,$.decisionBond=$.bondMin,$.decisionCash=$.cashTarget,$.decisionDuration=$.duration,Ft();break;case"skip-decision":To();break;case"finish":To();break}}function ef(){const n=document.getElementById("wizBaseSalary");n&&($.baseSalary=parseFloat(n.value)||3e4);const e=document.getElementById("wizOther");e&&($.otherIncome=parseFloat(e.value)||0);const t=document.getElementById("wizStatePension");t&&($.statePension=parseFloat(t.value)||12e3);const r=document.getElementById("wizStatePensionYear");r&&($.statePensionYear=parseInt(r.value)||12);const i=document.getElementById("wizEquityMin");i&&($.equityMin=parseFloat(i.value)||25e4);const s=document.getElementById("wizBondMin");s&&($.bondMin=parseFloat(s.value)||2e5);const a=document.getElementById("wizCashTarget");a&&($.cashTarget=parseFloat(a.value)||5e4);const l=document.getElementById("wizDuration");l&&($.duration=parseInt(l.value)||35);const u=document.getElementById("wizTaxMode");u&&($.taxMode=u.value);const h=document.getElementById("wizDBaseSalary");h&&($.decisionSalary=parseFloat(h.value)||3e4);const f=document.getElementById("wizDEquityMin");f&&($.decisionEquity=parseFloat(f.value)||25e4);const g=document.getElementById("wizDBondMin");g&&($.decisionBond=parseFloat(g.value)||2e5);const _=document.getElementById("wizDCashTarget");_&&($.decisionCash=parseFloat(_.value)||5e4);const T=document.getElementById("wizDDuration");T&&($.decisionDuration=parseInt(T.value)||35)}function To(){ef(),Qo&&Qo($)}function XE(){tn&&(tn.style.display="none")}function JE(){return`
    .wizard-overlay {
      position: fixed;
      top: 0;
      left: 0;
...
Type OK to confirm deletion of all your data.`)))try{console.log("Wiping all user data..."),await oE(),console.log("Data wiped successfully"),lE(),localStorage.clear(),document.getElementById("mainApp").classList.add("hidden"),document.getElementById("setupWizard").style.display="block",Xo(document.getElementById("setupWizard"),Jo),alert("All data has been deleted. Please complete the setup wizard to start fresh.")}catch(t){console.error("Reset error:",t),alert("Error resetting data: "+t.message)}});document.querySelectorAll(".tab").forEach(n=>{n.addEventListener("click",async()=>{document.querySelectorAll(".tab").forEach(e=>e.classList.remove("active")),n.classList.add("active"),document.querySelectorAll(".tab-content").forEach(e=>e.classList.remove("active")),document.getElementById(`${n.dataset.tab}-content`).classList.add("active"),n.dataset.tab==="history"&&await $s(),n.dataset.tab==="taxyears"&&await qs(),n.dataset.tab==="stress"&&ul()})});document.querySelectorAll(".sub-tab[data-stresstab]").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll(".sub-tab[data-stresstab]").forEach(e=>e.classList.remove("active")),n.classList.add("active"),document.querySelectorAll(".stress-subtab").forEach(e=>e.classList.add("hidden")),document.getElementById(`stress-${n.dataset.stresstab}`).classList.remove("hidden"),n.dataset.stresstab==="stresssettings"&&ul()})});document.querySelectorAll(".sub-tab[data-decisiontab]").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll(".sub-tab[data-decisiontab]").forEach(e=>e.classList.remove("active")),n.classList.add("active"),document.querySelectorAll(".decision-subtab").forEach(e=>e.classList.add("hidden")),document.getElementById(`decision-${n.dataset.decisiontab}`).classList.remove("hidden"),n.dataset.decisiontab==="decisionsettings"&&af()})});function hw(n){const[e,t]=n.split("-").map(Number);return t>=4?e%100+"/"+(e+1)%100:(e-1)%100+"/"+e%100}function fw(n){const[e,t]=n.split("-").map(Number);return Math.max(0,(t>=4?e:e-1)-2026)}function bo(n,e,t,r,i){if(i){const s=Math.max(0,1-e/t);return n*r*s}return n*r}function wu(n,e,t){return n<=e?n:n<=t?e+(n-e)*.8:e+(t-e)*.8+(n-t)*.6}async function pw(n,e,t,r){const i=await Ls(),s=await Gh(),a=await Wh(),l=hw(n),u=fw(n),[h,f]=n.split("-").map(Number);if(!a[l])throw new Error(`Tax year ${l} is not configured. Please add it in the Settings tab before calculating.`);const g=a[l],_=g.pa||12570,T=g.brl||50270,R=g.other||0,D=i.statePension||0,P=i.statePensionYear||12;let C=0;if(u>=P&&D>0){let Z=1;for(let _e=0;_e<=u;_e++){const Ue=String((26+_e)%100).padStart(2,"0")+"/"+String((27+_e)%100).padStart(2,"0");Z*=1+((a[Ue]||{}).cpi||.04)}C=D*Z}let x=1;for(let Z=0;Z<u;Z++){const _e=String((26+Z)%100).padStart(2,"0")+"/"+String((27+Z)%100).padStart(2,"0"),Ue=(a[_e]||{}).cpi||.04;x*=1+Ue}const M=Math.round(bo(i.equityMin,u,i.duration,x,!0)),B=Math.round(bo(i.bondMin,u,i.duration,x,!0)),G=Math.round(bo(i.cashTarget,u,i.duration,x,!1)),z=e+t,E=M+B;let m=!1,y=0;const w=s.filter(Z=>Z.date<n);for(let Z=w.length-1;Z>=0&&w[Z].source==="Cash";Z--)y++;w.length&&w[w.length-1].inProtection&&(m=z<=E+(i.recoveryBuffer||1e4)),!m&&z<E&&y+1>=(i.consecutiveLimit||3)&&(m=!0);const I=i.baseSalary*x,A=R+C,v=wu(I,_,T),Le=Math.min(I,T),Ge=Math.max(0,Le-A),an=wu(Math.min(A+Ge,T),_,T),nt=Math.max(0,v-an);let ue,de,at,Ye=0;if(m)ue=Ge/12*(1-(i.protectionFactor||20)/100),de=nt/12,at="Protection";else{ue=Ge/12,de=nt/12,at="Standard";const Z=f>=4?h:h-1,_e=w.filter(le=>{const[Nt,cn]=le.date.split("-").map(Number);return(cn>=4?Nt:Nt-1)===Z});let Ue=0,hi=0;if(_e.forEach(le=>{hi+=le.sipp||0,le.inProtection&&le.stdSipp&&(Ue+=le.stdSipp-le.sipp),le.boostAmount>0&&(Ue-=le.boostAmount)}),Ue>0){let le=f>=4?16-f:4-f;le<1&&(le=1);const Nt=hi+ue*le+A*le/12,cn=T-Nt,he=z-E-(i.recoveryBuffer||1e4);if(cn>0&&he>0){const Te=cn/le,kn=Ue/le,fi=he/le;Ye=Math.min(kn,Te,fi),Ye>50&&(ue+=Ye,at="Tax Boost")}}}const Ce=(T-A)/12;let te,Ke,xe=0,re=0,Be=0,Fe="";if(!m&&z>=E+ue){te="Growth";const Z=Math.max(0,e-M),_e=Math.max(0,t-B),Ue=Z+_e;Ue>0?(xe=ue*Z/Ue,re=ue*_e/Ue,Ke="Healthy"):(te="Cash",Be=ue,Ke="At min")}else te="Cash",Be=ue,Ke=m?"Protection":"Below min",r<ue&&(Fe="Cash low!");let ve="";const Ie=e-M,mt=t-B;if(Ie>5e3&&mt<-5e3){const Z=Math.floor(Math.min(Ie,-mt)/1e3)*1e3;Z>=5e3&&(ve=`Move £${Z.toLocaleString()} Equity→Bond`)}else if(mt>5e3&&Ie<-5e3){const Z=Math.floor(Math.min(mt,-Ie)/1e3)*1e3;Z>=5e3&&(ve=`Move £${Z.toLocaleString()} Bond→Equity`)}let ln="";const Pn=G-r;if(Pn>5e3&&te==="Growth"&&!m){const Z=z-E-ue;if(Z>1e4){const _e=Math.floor(Math.min(Pn*.3,Z*.5)/1e3)*1e3;_e>=5e3&&(ln=`Replenish Cash: Move £${_e.toLocaleString()} from growth funds`)}}const gt=[];Fe&&gt.push({message:Fe,severity:"danger",type:"low-cash"}),Ye>50&&gt.push({message:`Tax Boost: +£${Math.round(Ye).toLocaleString()}/mo catch-up from protection shortfall`,severity:"success",type:"tax-boost"}),ve&&gt.push({message:ve,severity:"warning",type:"rebalance"}),ln&&gt.push({message:ln,severity:"info",type:"cash-replenish"});const Cn=ue+R/12+C/12,yt=Cn*12;let xn=0;yt>_&&(yt<=T?xn=(yt-_)*.2:xn=(T-_)*.2+(yt-T)*.4);const di=Cn-xn/12+de;return{date:n,taxYear:l,yearNumber:u,equity:e,bond:t,cash:r,isa:0,adjEquityMin:M,adjBondMin:B,adjCashTarget:G,pa:_,brl:T,other:R/12,statePension:C/12,sippDraw:ue,isaDraw:de,totalMonthlyNet:di,taxEfficient:!m&&Ye<=50,inProtection:m,protectionReason:m?Ke:null,consecutiveCashDraws:y,boostAmount:Ye>50?Ye:0,boostEligible:Ye>50,source:te,drawFromEquity:xe,drawFromBond:re,drawFromCash:Be,rebalanceNeeded:ve!=="",rebalanceActions:ve?[ve]:[],alerts:gt,calculationDetails:{mode:at,reason:`${Ke} | ${at}`,totalGrowth:z,minGrowth:E,consec:y,stdSipp:Ce,inputs:{baseSalary:i.baseSalary,targetGross:i.baseSalary*x,cumInf:x,yearNum:u,taxYear:l,OTHER:R,STATE:C,PA:_,BRL:T},taxInfo:{annualTaxable:yt,headroomToBRL:T-yt,annualTax:xn,monthlyNet:di}}}}window.handleDecisionSubmit=async function(n){n.preventDefault();const e=document.getElementById("entryMonth").value,t=parseFloat(document.getElementById("entryEquity").value)||0,r=parseFloat(document.getElementById("entryBond").value)||0,i=parseFloat(document.getElementById("entryCash").value)||0,s=[];if(e||s.push("Month"),!t&&t!==0&&s.push("Equity Fund"),!r&&r!==0&&s.push("Bond Balance"),!i&&i!==0&&s.push("Cash Balance"),s.length>0){alert(`Please fill in the following fields:
