 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wm(n){Wn(new yn("platform-logger",e=>new Np(e),"PRIVATE")),Wn(new yn("heartbeat",e=>new _m(e),"PRIVATE")),Kt(bo,lc,n),Kt(bo,lc,"esm2017"),Kt("fire-js","")}wm("");var Im="firebase",Tm="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Om(n,e){return ft(n,"POST","/v1/accounts:delete",e)}async function qu(n,e){return ft(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gm(n,e={}){return ft(n,"GET","/v2/passwordPolicy",kt(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ia{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return Et("not implemented")}_getIdTokenResponse(e){return Et("not implemented")}_linkToIdToken(e,t){return Et("not implemented")}_getReauthenticationResolver(e){return Et("not implemented")}}async function cg(n,e){return ft(n,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ug(n,e){return Xr(n,"POST","/v1/accounts:signInWithPassword",kt(n,e))}async function hg(n,e){return ft(n,"POST","/v1/accounts:sendOobCode",kt(n,e))}async function dg(n,e){return hg(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rh(n,e,t=!1){if(it(n.app))return Promise.reject(Tt(n));const r="signIn",i=await nh(n,r,e),s=await vn._fromIdTokenResponse(n,r,i);return t||await n._updateCurrentUser(s.user),s}async function wg(n,e){return rh(Dt(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ih(n){const e=Dt(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Ig(n,e,t){const r=Dt(n);await Qi(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",dg)}async function Tg(n,e,t){if(it(n.app))return Promise.reject(Tt(n));const r=Dt(n),a=await Qi(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",_g).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&ih(n),u}),l=await vn._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(l.user),l}function bg(n,e,t){return it(n.app)?Promise.reject(Tt(n)):wg(pe(n),nr.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&ih(n),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ag(n,e){return ft(n,"POST","/v1/accounts:update",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lt(){return window}function Og(n){lt().location.href=n}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ch(){return typeof lt().WorkerGlobalScope<"u"&&typeof lt().importScripts=="function"}async function Lg(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Bg(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function Fg(){return ch()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ay(n,e={}){return ft(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dy=new Qr(3e4,6e4);function Sc(){const n=lt().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function fy(n){return new Promise((e,t)=>{var r,i,s;function a(){Sc(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Sc(),t(st(n,"network-request-failed"))},timeout:dy.get()})}if(!((i=(r=lt().gapi)===null||r===void 0?void 0:r.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((s=lt().gapi)===null||s===void 0)&&s.load)a();else{const l=eg("iframefcb");return lt()[l]=()=>{gapi.load?a():t(st(n,"network-request-failed"))},eh(`${Zm()}?onload=${l}`).catch(u=>t(u))}}).catch(e=>{throw Li=null,e})}let Li=null;function py(n){return Li=Li||fy(n),Li}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oy(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Ly(n){Wn(new yn("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:a,authDomain:l}=r.options;q(a&&!a.includes(":"),"invalid-api-key",{appName:r.name});const u={apiKey:a,authDomain:l,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Zu(n)},d=new Qm(r,i,s,u);return sg(d,t),d},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),Wn(new yn("auth-internal",e=>{const t=Dt(e.getProvider("auth").getImmediate());return(r=>new Vy(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Kt(Cc,xc,Oy(n)),Kt(Cc,xc,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function cs(n){return Ss(n=Ct(n,ar)),new Wv(n,e=>Ka(n,e))}(function(e,t=!0){(function(i){rr=i})(tr),Wn(new yn("firestore",(r,{instanceIdentifier:i,options:s})=>{const a=r.getProvider("app").getImmediate(),l=new ar(new Hy(r.getProvider("auth-internal")),new Yy(r.getProvider("app-check-internal")),function(d,f){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new O(x.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new qr(d.options.projectId,f)}(a,i),a);return s=Object.assign({useFetchStreams:t},s),l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),Kt(Mc,"4.7.3",e),Kt(Mc,"4.7.3","esm2017")})();const Bd={apiKey:"AIzaSyBdbve0H70D-Ch69WlaxEly7PVBFVRB5p0",authDomain:"pensiontools-4b237.firebaseapp.com",projectId:"pensiontools-4b237",storageBucket:"pensiontools-4b237.firebasestorage.app",messagingSenderId:"760877353696",appId:"1:760877353696:web:2d6f7173c8d7fab6fd9e85",measurementId:"G-80XX542QZE"};function me(){return Bd.apiKey!=="YOUR_API_KEY"}let go=null,Xe=null,ze=null;try{me()?(go=Mu(Bd),Xe=zy(go),ze=Cv(go)):console.warn("Firebase not configured. Login required to save data.")}catch(n){console.error("Firebase initialization error:",n)}const Gv=new vt;let qt=null,Lr=[];function Kv(){if(!me()||!Xe){console.warn("Firebase not configured - auth disabled");return}Cg(Xe,n=>{console.log("onAuthStateChanged fired:",n?n.email:"null"),qt=n,console.log("Notifying",Lr.length,"listeners"),Lr.forEach(e=>e(n))})}function Yv(n){return console.log("onAuthStateChange: adding listener, currentUser is:",qt&&qt.email),Lr.push(n),qt&&(console.log("onAuthStateChange: immediately calling listener with user"),n(qt)),()=>{Lr=Lr.filter(e=>e!==n)}}function ai(){return qt}function rn(){return qt!==null}async function Qv(n,e,t=null){if(!me()||!Xe)throw new Error("Firebase not configured");const r=await Tg(Xe,n,e);return t&&r.user&&await Sg(r.user,{displayName:t}),r}async function Xv(n,e){if(!me()||!Xe)throw new Error("Firebase not configured");return bg(Xe,n,e)}async function Jv(){if(!me()||!Xe)throw new Error("Firebase not configured");console.log("Initiating Google sign-in popup...");try{const n=await Qg(Xe,Gv);return console.log("Google sign-in successful:",n.user.email),n}catch(n){throw console.error("signInWithPopup error:",n.code,n.message),n}}async function Zv(){if(!me()||!Xe)throw new Error("Firebase not configured");return xg(Xe)}async function eE(n){if(!me()||!Xe)throw new Error("Firebase not configured");return Ig(Xe,n)}Kv();function Ms(n,e="settings"){const t=ai();return!t||!ze?null:qn(ze,"users",t.uid,n,e)}function Ns(n){const e=ai();return!e||!ze?null:Pv(ze,"users",e.uid,n)}async function Fd(){if(!me())return null;const n=Ms("decision");if(!n)return null;try{const e=await Od(n);return e.exists()?e.data():null}catch(e){return console.error("Error loading decision data:",e),null}}async function tE(n){if(!me())return;const e=Ms("decision");if(e)try{await Ga(e,{...n,lastModified:new Date().toISOString()},{merge:!0})}catch(t){throw console.error("Error saving decision data:",t),t}}async function Ya(n={}){if(!me())return[];const e=Ns("history");if(!e)return[];try{let t=Or(e,gu("date",n.sortDesc?"desc":"asc"));n.taxYear&&(t=Or(e,qa("taxYear","==",n.taxYear),gu("date",n.sortDesc?"desc":"asc"))),n.limit&&(t=Or(t,Uv(n.limit)));const r=await Ds(t),i=[];return r.forEach(s=>{i.push({id:s.id,...s.data()})}),i}catch(t){return console.error("Error loading decision history:",t),[]}}async function nE(n){if(!me())return null;const e=Ns("history");if(!e)return null;try{const t=Or(e,qa("date","==",n.date)),r=await Ds(t);if(!r.empty){const s=r.docs[0].id;return await Ga(qn(ze,"users",ai().uid,"history",s),{...n,updatedAt:new Date().toISOString()}),s}return(await jv(e,{...n,createdAt:new Date().toISOString()})).id}catch(t){throw console.error("Error adding history record:",t),t}}async function rE(n){if(!me())return;const e=Ns("history");if(e)try{const t=Or(e,qa("date","==",n)),r=await Ds(t),i=cs(ze);r.forEach(s=>{i.delete(s.ref)}),await i.commit()}catch(t){throw console.error("Error deleting history record:",t),t}}async function iE(){if(!me())return;const n=Ns("history");if(n)try{const e=await Ds(n),t=500,r=[];let i=cs(ze),s=0;e.forEach(a=>{i.delete(a.ref),s++,s>=t&&(r.push(i),i=cs(ze),s=0)}),s>0&&r.push(i),await Promise.all(r.map(a=>a.commit()))}catch(e){throw console.error("Error clearing history:",e),e}}async function sE(){if(!me())return null;const n=Ms("stress");if(!n)return null;try{const e=await Od(n);return e.exists()?e.data():null}catch(e){return console.error("Error loading stress data:",e),null}}async function Ud(n){if(!me())return;const e=Ms("stress");if(e)try{await Ga(e,{...n,lastModified:new Date().toISOString()},{merge:!0})}catch(t){throw console.error("Error saving stress data:",t),t}}async function oE(){if(!me())return;const n=ai();if(!(!n||!ze))try{await iE();const e=cs(ze);e.delete(qn(ze,"users",n.uid,"decision","settings")),e.delete(qn(ze,"users",n.uid,"stress","settings")),e.delete(qn(ze,"users",n.uid,"profile","settings")),await e.commit(),console.log("All user data wiped successfully")}catch(e){throw console.error("Error wiping user data:",e),e}}async function aE(){if(!me())return!1;const n=await Fd(),e=await Ya({limit:1});return n!==null||e.length>0}let qe=null,$n=null;const zd=5e3;function $i(){return{settings:{equityMin:Fe.EQUITY_MIN,bondMin:Fe.BOND_MIN,cashTarget:Fe.CASH_TARGET,duration:Fe.DURATION_YEARS,baseSalary:Fe.BASE_SALARY,protectionFactor:Fe.PROTECTION_FACTOR,recoveryBuffer:Fe.RECOVERY_BUFFER,consecutiveLimit:Fe.CONSECUTIVE_LIMIT,startDate:null},taxYears:{"25/26":{pa:12570,brl:50270,hrl:125140,cpi:.025,other:0,statePension:0}},history:[],lastModified:null,checksum:null}}function li(){return me()&&rn()}function Qa(){return qe&&$n&&Date.now()-$n<zd?qe:$i()}async function Xa(){if(qe&&$n&&Date.now()-$n<zd)return qe;if(!li())return console.warn("Firebase not available - returning defaults"),$i();try{const n=await Fd(),e=await Ya();if(n){const t={settings:n.settings||$i().settings,taxYears:n.taxYears||{},history:e||[],lastModified:n.lastModified,checksum:n.checksum};return qe=t,$n=Date.now(),t}}catch(n){console.error("Error loading from Firebase:",n)}return $i()}async function qd(n){if(!li())throw new Error("Must be logged in to save data");try{n.lastModified=new Date().toISOString(),n.checksum=lE(n),await tE({settings:n.settings,taxYears:n.taxYears,lastModified:n.lastModified,checksum:n.checksum}),qe=n,$n=Date.now()}catch(e){throw console.error("Error saving to Firebase:",e),new Error("Failed to save decision data")}}function lE(n){const e={settings:n.settings,taxYears:n.taxYears,historyCount:n.history.length,lastHistoryDate:n.history.length>0?n.history[n.history.length-1].date:null};return bu(e)}async function Ja(){return(await Xa()).settings}async function Za(n){const e=await Xa();e.settings={...e.settings,...n},await qd(e)}function $d(n){const t=Qa().taxYears[n];return t||{pa:Ke.PERSONAL_ALLOWANCE,brl:Ke.BASIC_RATE_LIMIT,hrl:Ke.HIGHER_RATE_LIMIT,cpi:.025,other:0,statePension:0,isaBalance:0,isaMonthlyDraw:0}}async function jd(n,e){const t=await Xa();t.taxYears[n]={...$d(n),...e},await qd(t)}function Hd(){return Qa().taxYears}function Wd(n={}){let t=[...Qa().history];return n.taxYear&&(t=t.filter(r=>r.taxYear===n.taxYear)),n.startDate&&(t=t.filter(r=>r.date>=n.startDate)),n.endDate&&(t=t.filter(r=>r.date<=n.endDate)),n.sortDesc?t.sort((r,i)=>i.date.localeCompare(r.date)):t.sort((r,i)=>r.date.localeCompare(i.date)),n.limit&&(t=t.slice(0,n.limit)),t}async function cE(n={}){if(li())try{return await Ya(n)}catch(e){console.error("Error loading history from Firebase:",e)}return Wd(n)}async function uE(n){if(!li())throw new Error("Must be logged in to save history");if(await nE(n),qe){const e=qe.history.findIndex(t=>t.date===n.date);e>=0?qe.history[e]=n:qe.history.push(n),qe.history.sort((t,r)=>t.date.localeCompare(r.date))}}async function hE(n){if(!li())throw new Error("Must be logged in to delete history");await rE(n),qe&&(qe.history=qe.history.filter(e=>e.date!==n))}function dE(n){const e=Nf(n);e.stdSipp=n.sippDraw-(n.boostAmount||0),uE(e)}function el(n,e,t=0){const r=Tu(t);let i=n.equityStart,s=n.bondStart,a=n.cashStart,l=n.hodlEnabled?n.hodlStart!==void 0?n.hodlStart:n.hodlValue:0,u=0,d=null,f=0,g=0,v=0,T=0,P=!1,D=!1,S=null,C=0,k=-1;const M=[],B=[];let G=1,j=.025;M.push({year:0,month:0,equity:i,bond:s,cash:a,hodl:l,total:i+s+a,draw:0,source:"None",inProtection:!1,equityMin:n.equityMin,bondMin:n.bondMin,cashMax:n.cashTarget});for(let E=0;E<n.years*12;E++){const m=Math.floor(E/12),y=E%12,w=y>=3?m:m-1;if(w!==k&&(C=0,k=w),E>0&&E%12===0){const X=e.inflation[m]||.025;B.push(X),G*=1+X}const I=e.equity[m]||0,A=e.inflation[m]||.025,_=Ln(n.equityMin,m,n.duration,G,!0),Ne=Ln(n.bondMin,m,n.duration,G,!0),Je=Ln(n.cashTarget,m,n.duration,G,!1),he=pE(n,m,G,B),je=he;let re=P?he*n.protectionMult:he;P&&(C+=je-re);const An=Math.pow(1+I,1/12)-1,pt=fE(A,I,j,r)/12,Se=Math.pow(1+Math.max(.005,A+.012),1/12)-1;if(i*=1+An,s*=1+pt,a*=1+Se,l>0){const Re=(r()-.5)*2*.06;let ve=0;I<-.1?ve=Math.min(.15,Math.abs(I)*.4):I<-.05&&(ve=Math.abs(I)*.2);let Oe=.069+Re+ve;Oe=Math.max(-.08,Math.min(.18,Oe)),l*=1+Math.pow(1+Oe,1/12)-1}j=A;const ie=i+s,at=_+Ne;P&&ie>at+5e3&&(P=!1,T=0,g=Math.max(g,v),v=0),P&&(f++,v++);let Ve=0;if(!P&&C>0&&ie>at+15e3){let X=y>=3?15-y:3-y;X<1&&(X=1);const We=ie-at-15e3,Re=Math.min(C/X,We/X),ve=je*.5;Ve=Math.min(Re,ve),Ve>50&&(re+=Ve,C-=Ve)}let He="Growth";if(!P&&ie>=at+re){const X=Math.max(0,i-_),We=Math.max(0,s-Ne),Re=X+We;if(Re>0){if(i-=re*X/Re,s-=re*We/Re,T=0,He="Growth",a<Je){const ve=ie-at-re;if(ve>5e3){const Oe=Math.min((Je-a)*.3,ve*.5);i-=Oe*X/Re,s-=Oe*We/Re,a+=Oe}}}else a-=re,He="Cash"}else if(a>=re)a-=re,T++,He="Cash",!n.disableProtection&&T>=n.consecutiveLimit&&(P=!0);else{const X=re-a;a=0,s>X?(s-=X,He="Bond"):i>X?(i-=X,He="Equity"):l>X?(l-=X,u+=X,d===null&&(d=E),He="HODL"):(D=!0,S=E)}if(i=Math.max(0,i),s=Math.max(0,s),a=Math.max(0,a),(y===0||E===n.years*12-1||D)&&M.push({year:m+y/12,month:E,equity:i,bond:s,cash:a,hodl:l,total:i+s+a,draw:re,boostAmount:Ve,source:He,inProtection:P,equityMin:_,bondMin:Ne,cashMax:Je}),D)break}return g=Math.max(g,v),{failed:D,years:D?S/12:n.years,failMonth:S,final:i+s+a,finalEquity:i,finalBond:s,finalCash:a,finalHodl:l,protMonths:f,maxConsec:g,hodlUsed:u,hodlUsedMonth:d,hist:M,seed:t}}function fE(n,e,t,r){let i=.15,s=.3,a=.2,l=.1,u=.1,d=.15;const f=t!==void 0?t:n,g=f>.045,v=f>.07;if(g){const M=r()>.3?1:.5;v?(i=.15+.35*M,s=.3-.2*M,d=.15-.1*M,l=.1+.05*M):(i=.15+.2*M,s=.3-.1*M,d=.15-.05*M)}g&&r()<.15&&(i=.2,s=.25,d=.12);const T=n+.005+Tr(0,.03,r),P=.04-(n>.04?(n-.04)*.5:0)+Tr(0,.05,r),D=.03+n*.3+Tr(0,.08,r),S=n*.8+Tr(0,.15,r),C=Math.max(.005,n+.005),k=e*.5+Tr(0,.02,r);return i*T+s*P+a*D+l*S+u*C+d*k}function pE(n,e,t,r){n.taxMode==="frozen"?n.pa:n.pa*t;const i=n.taxMode==="frozen"?n.brl:n.brl*t,s=n.baseSalary*t;let a=n.other;for(const f of r)a*=1+Math.min(f,.04);const l=e>=n.statePensionYear?n.statePension*t:0,u=a+l;return Math.max(0,Math.min(i,s)-u)/12}function mE(n,e=1e3){const t=Object.keys(ji).map(Number).sort((i,s)=>i-s),r=[];for(let i=0;i<e;i++){const s=Tu(i*12345),a={equity:{},inflation:{}};for(let l=0;l<n.years;l++){const u=t[Math.floor(s()*t.length)];a.equity[l]=ji[u],a.inflation[l]=Iu[u]||.025}r.push(el(n,a,i))}return r}function gE(n){const e=Object.keys(ji).map(Number).sort((i,s)=>i-s),t=Math.max(...e),r=[];for(const i of e){if(i+n.years-1>t)continue;const s={equity:{},inflation:{}};for(let l=0;l<n.years;l++)s.equity[l]=ji[i+l]||0,s.inflation[l]=Iu[i+l]||.025;const a=el(n,s,i);a.startYear=i,r.push(a)}return r}function yE(n,e){const t={equity:{},inflation:{}};for(let r=0;r<n.years;r++)t.equity[r]=e.equity[r%e.equity.length],t.inflation[r]=e.inflation[r%e.inflation.length];return el(n,t,999)}function _E(n){const e=n.filter(t=>t.failed).length;return(n.length-e)/n.length*100}function Gd(n){const e=n.filter(l=>!l.failed),t=n.filter(l=>l.failed),r=n.map(l=>l.years).sort((l,u)=>l-u),i=e.map(l=>l.final).sort((l,u)=>l-u),s=n.map(l=>l.protMonths).sort((l,u)=>l-u),a=(l,u)=>l[Math.floor(l.length*u)]||0;return{total:n.length,successCount:e.length,failCount:t.length,successRate:_E(n),survival:{p5:a(r,.05),p10:a(r,.1),p25:a(r,.25),p50:a(r,.5),p75:a(r,.75),p90:a(r,.9),p95:a(r,.95),min:r[0],max:r[r.length-1]},finalValue:{p5:a(i,.05),p10:a(i,.1),p25:a(i,.25),p50:a(i,.5),p75:a(i,.75),p90:a(i,.9),p95:a(i,.95),min:i[0]||0,max:i[i.length-1]||0,avg:e.reduce((l,u)=>l+u.final,0)/(e.length||1)},minYears:r[0],p10Years:a(r,.1),medianYears:a(r,.5),medianFinal:a(i,.5),p10Final:a(i,.1),p90Final:a(i,.9),avgFinal:e.reduce((l,u)=>l+u.final,0)/(e.length||1),protection:{runsWithProtection:n.filter(l=>l.protMonths>0).length,pctWithProtection:n.filter(l=>l.protMonths>0).length/n.length*100,avgMonths:s.reduce((l,u)=>l+u,0)/n.length,maxMonths:Math.max(...s),maxConsecutive:Math.max(...n.map(l=>l.maxConsec)),avgConsecutive:n.reduce((l,u)=>l+u.maxConsec,0)/n.length,p50Months:a(s,.5),p90Months:a(s,.9),p95Months:a(s,.95)},runsWithProtection:n.filter(l=>l.protMonths>0).length,avgProtMonths:s.reduce((l,u)=>l+u,0)/n.length,maxProtMonths:Math.max(...s),maxConsecutive:Math.max(...n.map(l=>l.maxConsec)),avgConsecutive:n.reduce((l,u)=>l+u.maxConsec,0)/n.length,hodl:{runsUsingHodl:n.filter(l=>l.hodlUsed>0).length,pctUsingHodl:n.filter(l=>l.hodlUsed>0).length/n.length*100,avgUsed:n.filter(l=>l.hodlUsed>0).length>0?n.filter(l=>l.hodlUsed>0).reduce((l,u)=>l+u.hodlUsed,0)/n.filter(l=>l.hodlUsed>0).length:0,maxUsed:Math.max(...n.map(l=>l.hodlUsed||0))},runsUsingHodl:n.filter(l=>l.hodlUsed>0).length,avgHodlUsed:n.filter(l=>l.hodlUsed>0).length>0?n.filter(l=>l.hodlUsed>0).reduce((l,u)=>l+u.hodlUsed,0)/n.filter(l=>l.hodlUsed>0).length:0,maxHodlUsed:Math.max(...n.map(l=>l.hodlUsed||0)),failures:t.map(l=>({seed:l.seed,startYear:l.startYear,years:l.years,failMonth:l.failMonth,protMonths:l.protMonths}))}}let Ht=null,gn=null;const Kd=5e3;function jn(){return{settings:{equityMin:Fe.EQUITY_MIN,bondMin:Fe.BOND_MIN,cashTarget:Fe.CASH_TARGET,duration:Fe.DURATION_YEARS,baseSalary:Fe.BASE_SALARY,other:0,statePension:12e3,statePensionYear:12,pa:Ke.PERSONAL_ALLOWANCE,brl:Ke.BASIC_RATE_LIMIT,hrl:Ke.HIGHER_RATE_LIMIT,taxMode:"inflates",protectionMult:no.PROTECTION_MULTIPLIER,consecutiveLimit:Fe.CONSECUTIVE_LIMIT,disableProtection:!1,hodlEnabled:no.HODL_ENABLED,hodlValue:no.HODL_VALUE},lastModified:null,checksum:null}}function tl(){return me()&&rn()}function vE(){Ht=null,gn=null}function EE(){return Ht&&gn&&Date.now()-gn<Kd?Ht:jn()}async function Yd(){if(Ht&&gn&&Date.now()-gn<Kd)return Ht;if(!tl())return console.warn("Firebase not available - returning defaults"),jn();try{const n=await sE();if(n){const e={settings:n.settings||jn().settings,lastModified:n.lastModified,checksum:n.checksum};return Ht=TE(e),gn=Date.now(),Ht}}catch(n){console.error("Error loading stress data from Firebase:",n)}return jn()}async function wE(n){if(!tl())throw new Error("Must be logged in to save data");try{n.lastModified=new Date().toISOString(),n.checksum=IE(n),await Ud({settings:n.settings,lastModified:n.lastModified,checksum:n.checksum}),Ht=n,gn=Date.now()}catch(e){throw console.error("Error saving stress data to Firebase:",e),new Error("Failed to save stress data")}}function IE(n){return bu(n.settings)}function TE(n){const e={...jn()};return n.settings&&(e.settings={...e.settings,...n.settings},n.settings.pacwMin!==void 0&&n.settings.equityMin===void 0&&(e.settings.equityMin=n.settings.pacwMin),n.settings.cgtMin!==void 0&&n.settings.bondMin===void 0&&(e.settings.bondMin=n.settings.cgtMin),n.settings.csh2Target!==void 0&&n.settings.cashTarget===void 0&&(e.settings.cashTarget=n.settings.csh2Target),e.settings.hodlEnabled===void 0&&(e.settings.hodlEnabled=!1),e.settings.hodlValue===void 0&&(e.settings.hodlValue=25e3)),e.lastModified=n.lastModified,e.checksum=n.checksum,e}function bE(){return EE().settings}async function sn(){return(await Yd()).settings}async function nl(n){const e=await Yd();e.settings={...e.settings,...n},await wE(e)}async function AE(){if(!tl())throw new Error("Must be logged in to reset settings");const n=jn();await Ud({settings:n.settings,lastModified:new Date().toISOString()}),vE()}function rl(n={},e=null){const t=e||bE();return{equityStart:n.equityStart??t.equityMin,bondStart:n.bondStart??t.bondMin,cashStart:n.cashStart??t.cashTarget,equityMin:t.equityMin,bondMin:t.bondMin,cashTarget:t.cashTarget,years:n.years??t.duration,duration:t.duration,baseSalary:t.baseSalary,other:t.other,statePension:t.statePension,statePensionYear:t.statePensionYear,pa:t.pa,brl:t.brl,hrl:t.hrl,taxMode:t.taxMode,protectionMult:t.protectionMult,consecutiveLimit:t.consecutiveLimit,disableProtection:t.disableProtection,hodlEnabled:t.hodlEnabled,hodlValue:t.hodlValue}}function U(n,e=null){const t=Math.abs(n),r=e!==null?e:t<100,i=Math.abs(n).toLocaleString("en-GB",{minimumFractionDigits:r?2:0,maximumFractionDigits:r?2:0});return n<0?`-£${i}`:`£${i}`}function SE(n,e){const t=RE(n);e.innerHTML=t}function RE(n){const e=n,t=e.calculationDetails||{};let r="";const i=e.taxEfficient?"success":"warning",s=e.taxEfficient?"Tax-Efficient Mode":"Standard Mode",a=e.taxEfficient?"✓":"!";if(r+=`<div class="decision-mode ${i}">
  ...
  `}function Qd(n={},e=null){const t=rl(n,e),r=mE(t),i=Gd(r);return{results:r,stats:i,config:t}}function Xd(n={},e=null){const t=rl(n,e),r=gE(t),i=Gd(r);return{results:r,stats:i,config:t}}function xE(n={}){const e=rl(n),t={};for(const[r,i]of Object.entries(Vf))t[r]={...i,result:yE(e,i)};return t}let ht=null,_o=null,On=!1;function kE(n,e){console.log("initAuthScreen: initializing"),ht=n,_o=e,On=!1,Yv(t=>{console.log("AuthScreen: auth state change received:",t?t.email:"null","processed:",On),t&&_o&&!On?(console.log("AuthScreen: calling onAuthSuccessCallback"),On=!0,_o(t)):t?console.log("AuthScreen: skipping callback, already processed or no callback"):(On=!1,console.log("AuthScreen: user signed out, reset authProcessed"))}),Jd(),console.log("initAuthScreen: complete")}function Jd(){if(ht){if(!me()){ht.innerHTML=`
