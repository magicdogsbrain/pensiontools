 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ki=new Map,um=new Map,Co=new Map;function uc(n,e){try{n.container.addComponent(e)}catch(t){St.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Yn(n){const e=n.name;if(Co.has(e))return St.debug(`There were multiple attempts to register component ${e}.`),!1;Co.set(e,n);for(const t of Ki.values())uc(t,n);for(const t of um.values())uc(t,n);return!0}function ta(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function st(n){return n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rr=lm;function Nu(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:xo,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw Yt.create("bad-app-name",{appName:String(i)});if(t||(t=Cu()),!t)throw Yt.create("no-options");const s=Ki.get(i);if(s){if(Yi(t,s.options)&&Yi(r,s.config))return s;throw Yt.create("duplicate-app",{appName:i})}const a=new vp(i);for(const u of Co.values())a.addComponent(u);const l=new hm(t,r,a);return Ki.set(i,l),l}function Vu(n=xo){const e=Ki.get(n);if(!e&&n===xo&&Cu())return Nu();if(!e)throw Yt.create("no-app",{appName:n});return e}function Kt(n,e,t){var r;let i=(r=cm[n])!==null&&r!==void 0?r:n;t&&(i+=`-${t}`);const s=i.match(/\s|\//),a=e.match(/\s|\//);if(s||a){const l=[`Unable to register library "${i}" with version "${e}":`];s&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&a&&l.push("and"),a&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),St.warn(l.join(" "));return}Yn(new En(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gm=1024,ym=30*24*60*60*1e3;class vm{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Em(t),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=hc();return((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(a=>a.date===s)?void 0:(this._heartbeatsCache.heartbeats.push({date:s,agent:i}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(a=>{const l=new Date(a.date).valueOf();return Date.now()-l<=ym}),this._storage.overwrite(this._heartbeatsCache))}catch(r){St.warn(r)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=hc(),{heartbeatsToSend:r,unsentEntries:i}=_m(this._heartbeatsCache.heartbeats),s=Gi(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(t){return St.warn(t),""}}}function hc(){return new Date().toISOString().substring(0,10)}function _m(n,e=gm){const t=[];let r=n.slice();for(const i of n){const s=t.find(a=>a.agent===i.agent);if(s){if(s.dates.push(i.date),fc(t)>e){s.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),fc(t)>e){t.pop();break}r=r.slice(1)}return{heartbeatsToSend:t,unsentEntries:r}}class Em{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return op()?ap().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await mm(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return dc(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return dc(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function fc(n){return Gi(JSON.stringify({version:2,heartbeats:n})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wm(n){Yn(new En("platform-logger",e=>new Np(e),"PRIVATE")),Yn(new En("heartbeat",e=>new vm(e),"PRIVATE")),Kt(Po,cc,n),Kt(Po,cc,"esm2017"),Kt("fire-js","")}wm("");var Im="firebase",Tm="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pm(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Rm()||np()||"connection"in navigator)?navigator.onLine:!0}function xm(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xi(n){var e;const t=n.auth,r=await n.getIdToken(),i=await Kn(n,qu(t,{idToken:r}));$(i==null?void 0:i.users.length,t,"internal-error");const s=i.users[0];n._notifyReloadListener(s);const a=!((e=s.providerUserInfo)===null||e===void 0)&&e.length?ju(s.providerUserInfo):[],l=zm(n.providerData,a),u=n.isAnonymous,h=!(n.email&&s.passwordHash)&&!(l!=null&&l.length),f=u?h:!1,g={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:l,metadata:new Do(s.createdAt,s.lastLoginAt),isAnonymous:f};Object.assign(n,g)}async function Um(n){const e=me(n);await Xi(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function zm(n,e){return[...n.filter(r=>!e.some(i=>i.providerId===r.providerId)),...e]}function ju(n){return n.map(e=>{var{providerId:t}=e,r=na(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Li(n,e,t){return`firebase:${n}:${e}:${t}`}class $n{constructor(e,t,r){this.persistence=e,this.auth=t,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=Li(this.userKey,i.apiKey,s),this.fullPersistenceKey=Li("persistence",i.apiKey,s),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?It._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,r="authUser"){if(!t.length)return new $n(Tt(vc),e,r);const i=(await Promise.all(t.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let s=i[0]||Tt(vc);const a=Li(r,e.config.apiKey,e.name);let l=null;for(const h of t)try{const f=await h._get(a);if(f){const g=It._fromJSON(e,f);h!==s&&(l=g),s=h;break}}catch{}const u=i.filter(h=>h._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new $n(s,e,r):(s=u[0],l&&await s._set(a,l.toJSON()),await Promise.all(t.map(async h=>{if(h!==s)try{await h._remove(a)}catch{}})),new $n(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ed(n,e=[]){let t;switch(n){case"Browser":t=_c(Ve());break;case"Worker":t=`${_c(Ve())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${rr}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function id(n,e,t=!1){if(st(n.app))return Promise.reject(bt(n));const r="signIn",i=await rd(n,r,e),s=await In._fromIdTokenResponse(n,r,i);return t||await n._updateCurrentUser(s.user),s}async function wg(n,e){return id(Mt(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sd(n){const e=Mt(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Ig(n,e,t){const r=Mt(n);await Ji(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",hg)}async function Tg(n,e,t){if(st(n.app))return Promise.reject(bt(n));const r=Mt(n),a=await Ji(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",vg).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&sd(n),u}),l=await In._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(l.user),l}function bg(n,e,t){return st(n.app)?Promise.reject(bt(n)):wg(me(n),ir.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&sd(n),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class od{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(es,"1"),this.storage.removeItem(es),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ud(){return typeof ut().WorkerGlobalScope<"u"&&typeof ut().importScripts=="function"}async function Lg(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Bg(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function Fg(){return ud()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pd(n,e){return e?Tt(e):($(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class md{constructor(e,t,r,i,s=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:i,tenantId:s,error:a,type:l}=e;if(a){this.reject(a);return}const u={auth:this.auth,requestUri:t,sessionId:r,tenantId:s||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(u))}catch(h){this.reject(h)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Wg;case"linkViaPopup":case"linkViaRedirect":return Yg;case"reauthViaPopup":case"reauthViaRedirect":return Gg;default:nt(this.auth,"internal-error")}}resolve(e){Rt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Rt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xg="pendingRedirect",Bi=new Map;class Jg extends md{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=Bi.get(this.auth._key());if(!e){try{const r=await Zg(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}Bi.set(this.auth._key(),e)}return this.bypassAuthState||Bi.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Zg(n,e){const t=ny(e),r=ty(n);if(!await r._isAvailable())return!1;const i=await r._get(t)==="true";return await r._remove(t),i}function ey(n,e){Bi.set(n._key(),e)}function ty(n){return Tt(n._redirectPersistence)}function ny(n){return Li(Xg,n.config.apiKey,n.name)}async function ry(n,e,t=!1){if(st(n.app))return Promise.reject(bt(n));const r=Mt(n),i=pd(r,e),a=await new Jg(r,i,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hy=new Xr(3e4,6e4);function Rc(){const n=ut().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function fy(n){return new Promise((e,t)=>{var r,i,s;function a(){Rc(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Rc(),t(ot(n,"network-request-failed"))},timeout:hy.get()})}if(!((i=(r=ut().gapi)===null||r===void 0?void 0:r.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((s=ut().gapi)===null||s===void 0)&&s.load)a();else{const l=eg("iframefcb");return ut()[l]=()=>{gapi.load?a():t(ot(n,"network-request-failed"))},td(`${Zm()}?onload=${l}`).catch(u=>t(u))}}).catch(e=>{throw Fi=null,e})}let Fi=null;function py(n){return Fi=Fi||fy(n),Fi}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oy(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Ly(n){Yn(new En("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:a,authDomain:l}=r.options;$(a&&!a.includes(":"),"invalid-api-key",{appName:r.name});const u={apiKey:a,authDomain:l,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:ed(n)},h=new Qm(r,i,s,u);return sg(h,t),h},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),Yn(new En("auth-internal",e=>{const t=Mt(e.getProvider("auth").getImmediate());return(r=>new Vy(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Kt(Cc,kc,Oy(n)),Kt(Cc,kc,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vc(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function Sn(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function Ad(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pd{}class pe extends Pd{constructor(e,t,r){super(),this.field=e,this.op=t,this.value=r}static create(e,t,r){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,r):new d0(e,t,r):t==="array-contains"?new p0(e,r):t==="in"?new m0(e,r):t==="not-in"?new g0(e,r):t==="array-contains-any"?new y0(e,r):new pe(e,t,r)}static createKeyFieldInFilter(e,t,r){return t==="in"?new h0(e,r):new f0(e,r)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&this.matchesComparison(Jn(t,this.value)):t!==null&&An(this.value)===An(t)&&this.matchesComparison(Jn(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return q()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class at extends Pd{constructor(e,t){super(),this.filters=e,this.op=t,this.ae=null}static create(e,t){return new at(e,t)}matches(e){return xd(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function xd(n){return n.op==="and"}function Cd(n){return u0(n)&&xd(n)}function u0(n){for(const e of n.filters)if(e instanceof at)return!1;return!0}function Lo(n){if(n instanceof pe)return n.field.canonicalString()+n.op.toString()+Zn(n.value);if(Cd(n))return n.filters.map(e=>Lo(e)).join(",");{const e=n.filters.map(t=>Lo(t)).join(",");return`${n.op}(${e})`}}function kd(n,e){return n instanceof pe?function(r,i){return i instanceof pe&&r.op===i.op&&r.field.isEqual(i.field)&&pt(r.value,i.value)}(n,e):n instanceof at?function(r,i){return i instanceof at&&r.op===i.op&&r.filters.length===i.filters.length?r.filters.reduce((s,a,l)=>s&&kd(a,i.filters[l]),!0):!1}(n,e):void q()}function Dd(n){return n instanceof pe?function(t){return`${t.field.canonicalString()} ${t.op} ${Zn(t.value)}`}(n):n instanceof at?function(t){return t.op.toString()+" {"+t.getFilters().map(Dd).join(" ,")+"}"}(n):"Filter"}class d0 extends pe{constructor(e,t,r){super(e,t,r),this.key=U.fromName(r.referenceValue)}matches(e){const t=U.comparator(e.key,this.key);return this.matchesComparison(t)}}class h0 extends pe{constructor(e,t){super(e,"in",t),this.keys=Md("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class f0 extends pe{constructor(e,t){super(e,"not-in",t),this.keys=Md("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function Md(n,e){var t;return(((t=e.arrayValue)===null||t===void 0?void 0:t.values)||[]).map(r=>U.fromName(r.referenceValue))}class p0 extends pe{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return ya(t)&&jr(t.arrayValue,this.value)}}class m0 extends pe{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&jr(this.value.arrayValue,t)}}class g0 extends pe{constructor(e,t){super(e,"not-in",t)}matches(e){if(jr(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&!jr(this.value.arrayValue,t)}}class y0 extends pe{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!ya(t)||!t.arrayValue.values)&&t.arrayValue.values.some(r=>jr(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T0=new oe(U.comparator);function xt(){return T0}const Ld=new oe(U.comparator);function xr(...n){let e=Ld;for(const t of n)e=e.insert(t.key,t);return e}function Bd(n){let e=Ld;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function gn(){return Vr()}function Fd(){return Vr()}function Vr(){return new ar(n=>n.toString(),(n,e)=>n.isEqual(e))}const b0=new oe(U.comparator),A0=new Pe(U.comparator);function Y(...n){let e=A0;for(const t of n)e=e.add(t);return e}const S0=new Pe(J);function R0(){return S0}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wa(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:ns(e)?"-0":e}}function Ud(n){return{integerValue:""+n}}function P0(n,e){return i0(e)?Ud(e):wa(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Es{constructor(){this._=void 0}}function x0(n,e,t){return n instanceof ss?function(i,s){const a={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:i.seconds,nanos:i.nanoseconds}}}};return s&&ma(s)&&(s=ga(s)),s&&(a.fields.__previous_value__=s),{mapValue:a}}(t,e):n instanceof Wr?$d(n,e):n instanceof Gr?qd(n,e):function(i,s){const a=zd(i,s),l=Wc(a)+Wc(i.Pe);return Oo(a)&&Oo(i.Pe)?Ud(l):wa(i.serializer,l)}(n,e)}function C0(n,e,t){return n instanceof Wr?$d(n,e):n instanceof Gr?qd(n,e):t}function zd(n,e){return n instanceof os?function(r){return Oo(r)||function(s){return!!s&&"doubleValue"in s}(r)}(e)?e:{integerValue:0}:null}class ss extends Es{}class Wr extends Es{constructor(e){super(),this.elements=e}}function $d(n,e){const t=jd(e);for(const r of n.elements)t.some(i=>pt(i,r))||t.push(r);return{arrayValue:{values:t}}}class Gr extends Es{constructor(e){super(),this.elements=e}}function qd(n,e){let t=jd(e);for(const r of n.elements)t=t.filter(i=>!pt(i,r));return{arrayValue:{values:t}}}class os extends Es{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function Wc(n){return ce(n.integerValue||n.doubleValue)}function jd(n){return ya(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}function k0(n,e){return n.field.isEqual(e.field)&&function(r,i){return r instanceof Wr&&i instanceof Wr||r instanceof Gr&&i instanceof Gr?Xn(r.elements,i.elements,pt):r instanceof os&&i instanceof os?pt(r.Pe,i.Pe):r instanceof ss&&i instanceof ss}(n.transform,e.transform)}class D0{constructor(e,t){this.version=e,this.transformResults=t}}class Xe{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Xe}static exists(e){return new Xe(void 0,e)}static updateTime(e){return new Xe(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function $i(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class ws{}function Hd(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new Ia(n.key,Xe.none()):new ri(n.key,n.data,Xe.none());{const t=n.data,r=$e.empty();let i=new Pe(Re.comparator);for(let s of e.fields)if(!i.has(s)){let a=t.field(s);a===null&&s.length>1&&(s=s.popLast(),a=t.field(s)),a===null?r.delete(s):r.set(s,a),i=i.add(s)}return new nn(n.key,r,new Qe(i.toArray()),Xe.none())}}function M0(n,e,t){n instanceof ri?function(i,s,a){const l=i.value.clone(),u=Yc(i.fieldTransforms,s,a.transformResults);l.setAll(u),s.convertToFoundDocument(a.version,l).setHasCommittedMutations()}(n,e,t):n instanceof nn?function(i,s,a){if(!$i(i.precondition,s))return void s.convertToUnknownDocument(a.version);const l=Yc(i.fieldTransforms,s,a.transformResults),u=s.data;u.setAll(Wd(i)),u.setAll(l),s.convertToFoundDocument(a.version,u).setHasCommittedMutations()}(n,e,t):function(i,s,a){s.convertToNoDocument(a.version).setHasCommittedMutations()}(0,e,t)}function Or(n,e,t,r){return n instanceof ri?function(s,a,l,u){if(!$i(s.precondition,a))return l;const h=s.value.clone(),f=Kc(s.fieldTransforms,u,a);return h.setAll(f),a.convertToFoundDocument(a.version,h).setHasLocalMutations(),null}(n,e,t,r):n instanceof nn?function(s,a,l,u){if(!$i(s.precondition,a))return l;const h=Kc(s.fieldTransforms,u,a),f=a.data;return f.setAll(Wd(s)),f.setAll(h),a.convertToFoundDocument(a.version,f).setHasLocalMutations(),l===null?null:l.unionWith(s.fieldMask.fields).unionWith(s.fieldTransforms.map(g=>g.field))}(n,e,t,r):function(s,a,l){return $i(s.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):l}(n,e,t)}function N0(n,e){let t=null;for(const r of n.fieldTransforms){const i=e.data.field(r.field),s=zd(r.transform,i||null);s!=null&&(t===null&&(t=$e.empty()),t.set(r.field,s))}return t||null}function Gc(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(r,i){return r===void 0&&i===void 0||!(!r||!i)&&Xn(r,i,(s,a)=>k0(s,a))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class ri extends ws{constructor(e,t,r,i=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=i,this.type=0}getFieldMask(){return null}}class nn extends ws{constructor(e,t,r,i,s=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=i,this.fieldTransforms=s,this.type=1}getFieldMask(){return this.fieldMask}}function Wd(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}}),e}function Yc(n,e,t){const r=new Map;te(n.length===t.length);for(let i=0;i<t.length;i++){const s=n[i],a=s.transform,l=e.data.field(s.field);r.set(s.field,C0(a,l,t[i]))}return r}function Kc(n,e,t){const r=new Map;for(const i of n){const s=i.transform,a=t.data.field(i.field);r.set(i.field,x0(s,a,e))}return r}class Ia extends ws{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class V0 extends ws{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mv{constructor(){this.sessionToken=xe.EMPTY_BYTE_STRING}getSessionToken(e){return N.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,N.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const De="WebChannelConnection";class Ov extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",i=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${i}/databases/${s}`,this.Co=this.databaseId.database==="(default)"?`project_id=${i}`:`project_id=${i}&database_id=${s}`}get Fo(){return!1}Mo(t,r,i,s,a){const l=go(),u=this.xo(t,r.toUriEncodedString());L("RestConnection",`Sending RPC '${t}' ${l}:`,u,i);const h={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(h,s,a),this.No(t,u,h,i).then(f=>(L("RestConnection",`Received RPC '${t}' ${l}: `,f),f),f=>{throw Qn("RestConnection",`RPC '${t}' ${l} failed with error: `,f,"url: ",u,"request:",i),f})}Lo(t,r,i,s,a,l){return this.Mo(t,r,i,s,a)}Oo(t,r,i){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+sr}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((s,a)=>t[a]=s),i&&i.headers.forEach((s,a)=>t[a]=s)}xo(t,r){const i=Nv[t];return`${this.Do}/v1/${r}:${i}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,i){const s=go();return new Promise((a,l)=>{const u=new vd;u.setWithCredentials(!0),u.listenOnce(_d.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case Ui.NO_ERROR:const f=u.getResponseJson();L(De,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(f)),a(f);break;case Ui.TIMEOUT:L(De,`RPC '${e}' ${s} timed out`),l(new O(k.DEADLINE_EXCEEDED,"Request time out"));break;case Ui.HTTP_ERROR:const g=u.getStatus();if(L(De,`RPC '${e}' ${s} failed with status:`,g,"response text:",u.getResponseText()),g>0){let _=u.getResponseJson();Array.isArray(_)&&(_=_[0]);const T=_==null?void 0:_.error;if(T&&T.status&&T.message){const P=function(S){const x=S.toLowerCase().replace(/_/g,"-");return Object.values(k).indexOf(x)>=0?x:k.UNKNOWN}(T.status);l(new O(P,T.message))}else l(new O(k.UNKNOWN,"Server responded with status "+u.getStatus()))}else l(new O(k.UNAVAILABLE,"Connection failed."));break;default:q()}}finally{L(De,`RPC '${e}' ${s} completed.`)}});const h=JSON.stringify(i);L(De,`RPC '${e}' ${s} sending request:`,i),u.send(t,"POST",h,r,15)})}Bo(e,t,r){const i=go(),s=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=Id(),l=wd(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Oo(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const f=s.join("");L(De,`Creating RPC '${e}' stream ${i}: ${f}`,u);const g=a.createWebChannel(f,u);let _=!1,T=!1;const P=new Vv({Io:S=>{T?L(De,`Not sending because RPC '${e}' stream ${i} is closed:`,S):(_||(L(De,`Opening RPC '${e}' stream ${i} transport.`),g.open(),_=!0),L(De,`RPC '${e}' stream ${i} sending:`,S),g.send(S))},To:()=>g.close()}),D=(S,x,C)=>{S.listen(x,M=>{try{C(M)}catch(B){setTimeout(()=>{throw B},0)}})};return D(g,Pr.EventType.OPEN,()=>{T||(L(De,`RPC '${e}' stream ${i} transport opened.`),P.yo())}),D(g,Pr.EventType.CLOSE,()=>{T||(T=!0,L(De,`RPC '${e}' stream ${i} transport closed`),P.So())}),D(g,Pr.EventType.ERROR,S=>{T||(T=!0,Qn(De,`RPC '${e}' stream ${i} transport errored:`,S),P.So(new O(k.UNAVAILABLE,"The operation could not be completed")))}),D(g,Pr.EventType.MESSAGE,S=>{var x;if(!T){const C=S.data[0];te(!!C);const M=C,B=M.error||((x=M[0])===null||x===void 0?void 0:x.error);if(B){L(De,`RPC '${e}' stream ${i} received error:`,B);const G=B.status;let W=function(y){const w=fe[y];if(w!==void 0)return Gd(w)}(G),E=B.message;W===void 0&&(W=k.INTERNAL,E="Unknown error status: "+G+" with message "+B.message),T=!0,P.So(new O(W,E)),g.close()}else L(De,`RPC '${e}' stream ${i} received:`,C),P.bo(C)}}),D(l,Ed.STAT_EVENT,S=>{S.stat===No.PROXY?L(De,`RPC '${e}' stream ${i} detected buffering proxy`):S.stat===No.NOPROXY&&L(De,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{P.wo()},0),P}}function yo(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zv{constructor(e,t,r,i,s){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.O_=[],this.N_=new Map,this.L_=new Set,this.B_=[],this.k_=s,this.k_._o(a=>{r.enqueueAndForget(async()=>{Rn(this)&&(L("RemoteStore","Restarting streams for network reachability change."),await async function(u){const h=H(u);h.L_.add(4),await si(h),h.q_.set("Unknown"),h.L_.delete(4),await bs(h)}(this))})}),this.q_=new Uv(r,i)}}async function bs(n){if(Rn(n))for(const e of n.B_)await e(!0)}async function si(n){for(const e of n.B_)await e(!1)}function ah(n,e){const t=H(n);t.N_.has(e.targetId)||(t.N_.set(e.targetId,e),Da(t)?ka(t):lr(t).r_()&&Ca(t,e))}function xa(n,e){const t=H(n),r=lr(t);t.N_.delete(e),r.r_()&&lh(t,e),t.N_.size===0&&(r.r_()?r.o_():Rn(t)&&t.q_.set("Unknown"))}function Ca(n,e){if(n.Q_.xe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(j.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}lr(n).A_(e)}function lh(n,e){n.Q_.xe(e),lr(n).R_(e)}function ka(n){n.Q_=new $0({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),ot:e=>n.N_.get(e)||null,tt:()=>n.datastore.serializer.databaseId}),lr(n).start(),n.q_.v_()}function Da(n){return Rn(n)&&!lr(n).n_()&&n.N_.size>0}function Rn(n){return H(n).L_.size===0}function ch(n){n.Q_=void 0}async function $v(n){n.q_.set("Online")}async function qv(n){n.N_.forEach((e,t)=>{Ca(n,e)})}async function jv(n,e){ch(n),Da(n)?(n.q_.M_(e),ka(n)):n.q_.set("Unknown")}async function Hv(n,e,t){if(n.q_.set("Online"),e instanceof Kd&&e.state===2&&e.cause)try{await async function(i,s){const a=s.cause;for(const l of s.targetIds)i.N_.has(l)&&(await i.remoteSyncer.rejectListen(l,a),i.N_.delete(l),i.Q_.removeTarget(l))}(n,e)}catch(r){L("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await ls(n,r)}else if(e instanceof qi?n.Q_.Ke(e):e instanceof Yd?n.Q_.He(e):n.Q_.We(e),!t.isEqual(j.min()))try{const r=await ih(n.localStore);t.compareTo(r)>=0&&await function(s,a){const l=s.Q_.rt(a);return l.targetChanges.forEach((u,h)=>{if(u.resumeToken.approximateByteSize()>0){const f=s.N_.get(h);f&&s.N_.set(h,f.withResumeToken(u.resumeToken,a))}}),l.targetMismatches.forEach((u,h)=>{const f=s.N_.get(u);if(!f)return;s.N_.set(u,f.withResumeToken(xe.EMPTY_BYTE_STRING,f.snapshotVersion)),lh(s,u);const g=new Ht(f.target,u,h,f.sequenceNumber);Ca(s,g)}),s.remoteSyncer.applyRemoteEvent(l)}(n,t)}catch(r){L("RemoteStore","Failed to raise snapshot:",r),await ls(n,r)}}async function ls(n,e,t){if(!ni(e))throw e;n.L_.add(1),await si(n),n.q_.set("Offline"),t||(t=()=>ih(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{L("RemoteStore","Retrying IndexedDB access"),await t(),n.L_.delete(1),await bs(n)})}function uh(n,e){return e().catch(t=>ls(n,t,e))}async function As(n){const e=H(n),t=en(e);let r=e.O_.length>0?e.O_[e.O_.length-1].batchId:-1;for(;Wv(e);)try{const i=await xv(e.localStore,r);if(i===null){e.O_.length===0&&t.o_();break}r=i.batchId,Gv(e,i)}catch(i){await ls(e,i)}dh(e)&&hh(e)}function Wv(n){return Rn(n)&&n.O_.length<10}function Gv(n,e){n.O_.push(e);const t=en(n);t.r_()&&t.V_&&t.m_(e.mutations)}function dh(n){return Rn(n)&&!en(n).n_()&&n.O_.length>0}function hh(n){en(n).start()}async function Yv(n){en(n).p_()}async function Kv(n){const e=en(n);for(const t of n.O_)e.m_(t.mutations)}async function Qv(n,e,t){const r=n.O_.shift(),i=Ta.from(r,e,t);await uh(n,()=>n.remoteSyncer.applySuccessfulWrite(i)),await As(n)}async function Xv(n,e){e&&en(n).V_&&await async function(r,i){if(function(a){return F0(a)&&a!==k.ABORTED}(i.code)){const s=r.O_.shift();en(r).s_(),await uh(r,()=>r.remoteSyncer.rejectFailedWrite(s.batchId,i)),await As(r)}}(n,e),dh(n)&&hh(n)}async function su(n,e){const t=H(n);t.asyncQueue.verifyOperationInProgress(),L("RemoteStore","RemoteStore received new credentials");const r=Rn(t);t.L_.add(3),await si(t),r&&t.q_.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.L_.delete(3),await bs(t)}async function Jv(n,e){const t=H(n);e?(t.L_.delete(2),await bs(t)):e||(t.L_.add(2),await si(t),t.q_.set("Unknown"))}function lr(n){return n.K_||(n.K_=function(t,r,i){const s=H(t);return s.w_(),new Lv(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(n.datastore,n.asyncQueue,{Eo:$v.bind(null,n),Ro:qv.bind(null,n),mo:jv.bind(null,n),d_:Hv.bind(null,n)}),n.B_.push(async e=>{e?(n.K_.s_(),Da(n)?ka(n):n.q_.set("Unknown")):(await n.K_.stop(),ch(n))})),n.K_}function en(n){return n.U_||(n.U_=function(t,r,i){const s=H(t);return s.w_(),new Bv(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(n.datastore,n.asyncQueue,{Eo:()=>Promise.resolve(),Ro:Yv.bind(null,n),mo:Xv.bind(null,n),f_:Kv.bind(null,n),g_:Qv.bind(null,n)}),n.B_.push(async e=>{e?(n.U_.s_(),await As(n)):(await n.U_.stop(),n.O_.length>0&&(L("RemoteStore",`Stopping write stream with ${n.O_.length} pending writes`),n.O_=[]))})),n.U_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gh{constructor(e){this.key=e}}class yh{constructor(e){this.key=e}}class r_{constructor(e,t){this.query=e,this.Ta=t,this.Ea=null,this.hasCachedResults=!1,this.current=!1,this.da=Y(),this.mutatedKeys=Y(),this.Aa=Od(e),this.Ra=new jn(this.Aa)}get Va(){return this.Ta}ma(e,t){const r=t?t.fa:new ou,i=t?t.Ra:this.Ra;let s=t?t.mutatedKeys:this.mutatedKeys,a=i,l=!1;const u=this.query.limitType==="F"&&i.size===this.query.limit?i.last():null,h=this.query.limitType==="L"&&i.size===this.query.limit?i.first():null;if(e.inorderTraversal((f,g)=>{const _=i.get(f),T=_s(this.query,g)?g:null,P=!!_&&this.mutatedKeys.has(_.key),D=!!T&&(T.hasLocalMutations||this.mutatedKeys.has(T.key)&&T.hasCommittedMutations);let S=!1;_&&T?_.data.isEqual(T.data)?P!==D&&(r.track({type:3,doc:T}),S=!0):this.ga(_,T)||(r.track({type:2,doc:T}),S=!0,(u&&this.Aa(T,u)>0||h&&this.Aa(T,h)<0)&&(l=!0)):!_&&T?(r.track({type:0,doc:T}),S=!0):_&&!T&&(r.track({type:1,doc:_}),S=!0,(u||h)&&(l=!0)),S&&(T?(a=a.add(T),s=D?s.add(f):s.delete(f)):(a=a.delete(f),s=s.delete(f)))}),this.query.limit!==null)for(;a.size>this.query.limit;){const f=this.query.limitType==="F"?a.last():a.first();a=a.delete(f.key),s=s.delete(f.key),r.track({type:1,doc:f})}return{Ra:a,fa:r,ns:l,mutatedKeys:s}}ga(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,r,i){const s=this.Ra;this.Ra=e.Ra,this.mutatedKeys=e.mutatedKeys;const a=e.fa.G_();a.sort((f,g)=>function(T,P){const D=S=>{switch(S){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return q()}};return D(T)-D(P)}(f.type,g.type)||this.Aa(f.doc,g.doc)),this.pa(r),i=i!=null&&i;const l=t&&!i?this.ya():[],u=this.da.size===0&&this.current&&!i?1:0,h=u!==this.Ea;return this.Ea=u,a.length!==0||h?{snapshot:new tr(this.query,e.Ra,s,a,e.mutatedKeys,u===0,h,!1,!!r&&r.resumeToken.approximateByteSize()>0),wa:l}:{wa:l}}Z_(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({Ra:this.Ra,fa:new ou,mutatedKeys:this.mutatedKeys,ns:!1},!1)):{wa:[]}}Sa(e){return!this.Ta.has(e)&&!!this.Ra.has(e)&&!this.Ra.get(e).hasLocalMutations}pa(e){e&&(e.addedDocuments.forEach(t=>this.Ta=this.Ta.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.Ta=this.Ta.delete(t)),this.current=e.current)}ya(){if(!this.current)return[];const e=this.da;this.da=Y(),this.Ra.forEach(r=>{this.Sa(r.key)&&(this.da=this.da.add(r.key))});const t=[];return e.forEach(r=>{this.da.has(r)||t.push(new yh(r))}),this.da.forEach(r=>{e.has(r)||t.push(new gh(r))}),t}ba(e){this.Ta=e.Ts,this.da=Y();const t=this.ma(e.documents);return this.applyChanges(t,!0)}Da(){return tr.fromInitialDocuments(this.query,this.Ra,this.mutatedKeys,this.Ea===0,this.hasCachedResults)}}class i_{constructor(e,t,r){this.query=e,this.targetId=t,this.view=r}}class s_{constructor(e){this.key=e,this.va=!1}}class o_{constructor(e,t,r,i,s,a){this.localStore=e,this.remoteStore=t,this.eventManager=r,this.sharedClientState=i,this.currentUser=s,this.maxConcurrentLimboResolutions=a,this.Ca={},this.Fa=new ar(l=>Vd(l),vs),this.Ma=new Map,this.xa=new Set,this.Oa=new oe(U.comparator),this.Na=new Map,this.La=new Sa,this.Ba={},this.ka=new Map,this.qa=er.kn(),this.onlineState="Unknown",this.Qa=void 0}get isPrimaryClient(){return this.Qa===!0}}async function a_(n,e,t=!0){const r=Th(n);let i;const s=r.Fa.get(e);return s?(r.sharedClientState.addLocalQueryTarget(s.targetId),i=s.view.Da()):i=await vh(r,e,t,!0),i}async function l_(n,e){const t=Th(n);await vh(t,e,!0,!1)}async function vh(n,e,t,r){const i=await Cv(n.localStore,dt(e)),s=i.targetId,a=n.sharedClientState.addLocalQueryTarget(s,t);let l;return r&&(l=await c_(n,e,s,a==="current",i.resumeToken)),n.isPrimaryClient&&t&&ah(n.remoteStore,i),l}async function c_(n,e,t,r,i){n.Ka=(g,_,T)=>async function(D,S,x,C){let M=S.view.ma(x);M.ns&&(M=await nu(D.localStore,S.query,!1).then(({documents:E})=>S.view.ma(E,M)));const B=C&&C.targetChanges.get(S.targetId),G=C&&C.targetMismatches.get(S.targetId)!=null,W=S.view.applyChanges(M,D.isPrimaryClient,B,G);return uu(D,S.targetId,W.wa),W.snapshot}(n,g,_,T);const s=await nu(n.localStore,e,!0),a=new r_(e,s.Ts),l=a.ma(s.documents),u=ii.createSynthesizedTargetChangeForCurrentChange(t,r&&n.onlineState!=="Offline",i),h=a.applyChanges(l,n.isPrimaryClient,u);uu(n,t,h.wa);const f=new i_(e,t,a);return n.Fa.set(e,f),n.Ma.has(t)?n.Ma.get(t).push(e):n.Ma.set(t,[e]),h.snapshot}async function u_(n,e,t){const r=H(n),i=r.Fa.get(e),s=r.Ma.get(i.targetId);if(s.length>1)return r.Ma.set(i.targetId,s.filter(a=>!vs(a,e))),void r.Fa.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(i.targetId),r.sharedClientState.isActiveQueryTarget(i.targetId)||await jo(r.localStore,i.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(i.targetId),t&&xa(r.remoteStore,i.targetId),Wo(r,i.targetId)}).catch(ti)):(Wo(r,i.targetId),await jo(r.localStore,i.targetId,!0))}async function d_(n,e){const t=H(n),r=t.Fa.get(e),i=t.Ma.get(r.targetId);t.isPrimaryClient&&i.length===1&&(t.sharedClientState.removeLocalQueryTarget(r.targetId),xa(t.remoteStore,r.targetId))}async function h_(n,e,t){const r=__(n);try{const i=await function(a,l){const u=H(a),h=ve.now(),f=l.reduce((T,P)=>T.add(P.key),Y());let g,_;return u.persistence.runTransaction("Locally write mutations","readwrite",T=>{let P=xt(),D=Y();return u.cs.getEntries(T,f).next(S=>{P=S,P.forEach((x,C)=>{C.isValidDocument()||(D=D.add(x))})}).next(()=>u.localDocuments.getOverlayedDocuments(T,P)).next(S=>{g=S;const x=[];for(const C of l){const M=N0(C,g.get(C.key).overlayedDocument);M!=null&&x.push(new nn(C.key,M,Rd(M.value.mapValue),Xe.exists(!0)))}return u.mutationQueue.addMutationBatch(T,h,x,l)}).next(S=>{_=S;const x=S.applyToLocalDocumentSet(g,D);return u.documentOverlayCache.saveOverlays(T,S.batchId,x)})}).then(()=>({batchId:_.batchId,changes:Bd(g)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(i.batchId),function(a,l,u){let h=a.Ba[a.currentUser.toKey()];h||(h=new oe(J)),h=h.insert(l,u),a.Ba[a.currentUser.toKey()]=h}(r,i.batchId,t),await oi(r,i.changes),await As(r.remoteStore)}catch(i){const s=Na(i,"Failed to persist write");t.reject(s)}}async function _h(n,e){const t=H(n);try{const r=await Rv(t.localStore,e);e.targetChanges.forEach((i,s)=>{const a=t.Na.get(s);a&&(te(i.addedDocuments.size+i.modifiedDocuments.size+i.removedDocuments.size<=1),i.addedDocuments.size>0?a.va=!0:i.modifiedDocuments.size>0?te(a.va):i.removedDocuments.size>0&&(te(a.va),a.va=!1))}),await oi(t,r,e)}catch(r){await ti(r)}}function cu(n,e,t){const r=H(n);if(r.isPrimaryClient&&t===0||!r.isPrimaryClient&&t===1){const i=[];r.Fa.forEach((s,a)=>{const l=a.view.Z_(e);l.snapshot&&i.push(l.snapshot)}),function(a,l){const u=H(a);u.onlineState=l;let h=!1;u.queries.forEach((f,g)=>{for(const _ of g.j_)_.Z_(l)&&(h=!0)}),h&&Va(u)}(r.eventManager,e),i.length&&r.Ca.d_(i),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function f_(n,e,t){const r=H(n);r.sharedClientState.updateQueryState(e,"rejected",t);const i=r.Na.get(e),s=i&&i.key;if(s){let a=new oe(U.comparator);a=a.insert(s,Ne.newNoDocument(s,j.min()));const l=Y().add(s),u=new Is(j.min(),new Map,new oe(J),a,l);await _h(r,u),r.Oa=r.Oa.remove(s),r.Na.delete(e),Oa(r)}else await jo(r.localStore,e,!1).then(()=>Wo(r,e,t)).catch(ti)}async function p_(n,e){const t=H(n),r=e.batch.batchId;try{const i=await Sv(t.localStore,e);wh(t,r,null),Eh(t,r),t.sharedClientState.updateMutationState(r,"acknowledged"),await oi(t,i)}catch(i){await ti(i)}}async function m_(n,e,t){const r=H(n);try{const i=await function(a,l){const u=H(a);return u.persistence.runTransaction("Reject batch","readwrite-primary",h=>{let f;return u.mutationQueue.lookupMutationBatch(h,l).next(g=>(te(g!==null),f=g.keys(),u.mutationQueue.removeMutationBatch(h,g))).next(()=>u.mutationQueue.performConsistencyCheck(h)).next(()=>u.documentOverlayCache.removeOverlaysForBatchId(h,f,l)).next(()=>u.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(h,f)).next(()=>u.localDocuments.getDocuments(h,f))})}(r.localStore,e);wh(r,e,t),Eh(r,e),r.sharedClientState.updateMutationState(e,"rejected",t),await oi(r,i)}catch(i){await ti(i)}}function Eh(n,e){(n.ka.get(e)||[]).forEach(t=>{t.resolve()}),n.ka.delete(e)}function wh(n,e,t){const r=H(n);let i=r.Ba[r.currentUser.toKey()];if(i){const s=i.get(e);s&&(t?s.reject(t):s.resolve(),i=i.remove(e)),r.Ba[r.currentUser.toKey()]=i}}function Wo(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const r of n.Ma.get(e))n.Fa.delete(r),t&&n.Ca.$a(r,t);n.Ma.delete(e),n.isPrimaryClient&&n.La.gr(e).forEach(r=>{n.La.containsKey(r)||Ih(n,r)})}function Ih(n,e){n.xa.delete(e.path.canonicalString());const t=n.Oa.get(e);t!==null&&(xa(n.remoteStore,t),n.Oa=n.Oa.remove(e),n.Na.delete(t),Oa(n))}function uu(n,e,t){for(const r of t)r instanceof gh?(n.La.addReference(r.key,e),g_(n,r)):r instanceof yh?(L("SyncEngine","Document no longer in limbo: "+r.key),n.La.removeReference(r.key,e),n.La.containsKey(r.key)||Ih(n,r.key)):q()}function g_(n,e){const t=e.key,r=t.path.canonicalString();n.Oa.get(t)||n.xa.has(r)||(L("SyncEngine","New document in limbo: "+t),n.xa.add(r),Oa(n))}function Oa(n){for(;n.xa.size>0&&n.Oa.size<n.maxConcurrentLimboResolutions;){const e=n.xa.values().next().value;n.xa.delete(e);const t=new U(se.fromString(e)),r=n.qa.next();n.Na.set(r,new s_(t)),n.Oa=n.Oa.insert(t,r),ah(n.remoteStore,new Ht(dt(Ea(t.path)),r,"TargetPurposeLimboResolution",pa.oe))}}async function oi(n,e,t){const r=H(n),i=[],s=[],a=[];r.Fa.isEmpty()||(r.Fa.forEach((l,u)=>{a.push(r.Ka(u,e,t).then(h=>{var f;if((h||t)&&r.isPrimaryClient){const g=h?!h.fromCache:(f=t==null?void 0:t.targetChanges.get(u.targetId))===null||f===void 0?void 0:f.current;r.sharedClientState.updateQueryState(u.targetId,g?"current":"not-current")}if(h){i.push(h);const g=Pa.Wi(u.targetId,h);s.push(g)}}))}),await Promise.all(a),r.Ca.d_(i),await async function(u,h){const f=H(u);try{await f.persistence.runTransaction("notifyLocalViewChanges","readwrite",g=>N.forEach(h,_=>N.forEach(_.$i,T=>f.persistence.referenceDelegate.addReference(g,_.targetId,T)).next(()=>N.forEach(_.Ui,T=>f.persistence.referenceDelegate.removeReference(g,_.targetId,T)))))}catch(g){if(!ni(g))throw g;L("LocalStore","Failed to update sequence numbers: "+g)}for(const g of h){const _=g.targetId;if(!g.fromCache){const T=f.os.get(_),P=T.snapshotVersion,D=T.withLastLimboFreeSnapshotVersion(P);f.os=f.os.insert(_,D)}}}(r.localStore,s))}async function y_(n,e){const t=H(n);if(!t.currentUser.isEqual(e)){L("SyncEngine","User change. New user:",e.toKey());const r=await rh(t.localStore,e);t.currentUser=e,function(s,a){s.ka.forEach(l=>{l.forEach(u=>{u.reject(new O(k.CANCELLED,a))})}),s.ka.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await oi(t,r.hs)}}function v_(n,e){const t=H(n),r=t.Na.get(e);if(r&&r.va)return Y().add(r.key);{let i=Y();const s=t.Ma.get(e);if(!s)return i;for(const a of s){const l=t.Fa.get(a);i=i.unionWith(l.view.Va)}return i}}function Th(n){const e=H(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=_h.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=v_.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=f_.bind(null,e),e.Ca.d_=t_.bind(null,e.eventManager),e.Ca.$a=n_.bind(null,e.eventManager),e}function __(n){const e=H(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=p_.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=m_.bind(null,e),e}class cs{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Ts(e.databaseInfo.databaseId),this.sharedClientState=this.Wa(e),this.persistence=this.Ga(e),await this.persistence.start(),this.localStore=this.za(e),this.gcScheduler=this.ja(e,this.localStore),this.indexBackfillerScheduler=this.Ha(e,this.localStore)}ja(e,t){return null}Ha(e,t){return null}za(e){return Av(this.persistence,new Tv,e.initialUser,this.serializer)}Ga(e){return new Ev(Ra.Zr,this.serializer)}Wa(e){return new Dv}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}cs.provider={build:()=>new cs};class Go{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>cu(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=y_.bind(null,this.syncEngine),await Jv(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new e_}()}createDatastore(e){const t=Ts(e.databaseInfo.databaseId),r=function(s){return new Ov(s)}(e.databaseInfo);return function(s,a,l,u){return new Fv(s,a,l,u)}(e.authCredentials,e.appCheckCredentials,r,t)}createRemoteStore(e){return function(r,i,s,a,l){return new zv(r,i,s,a,l)}(this.localStore,this.datastore,e.asyncQueue,t=>cu(this.syncEngine,t,0),function(){return iu.D()?new iu:new Mv}())}createSyncEngine(e,t){return function(i,s,a,l,u,h,f){const g=new o_(i,s,a,l,u,h);return f&&(g.Qa=!0),g}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(i){const s=H(i);L("RemoteStore","RemoteStore shutting down."),s.L_.add(5),await si(s),s.k_.shutdown(),s.q_.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}Go.provider={build:()=>new Go};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bh{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ya(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ya(this.observer.error,e):Pt("Uncaught Error in snapshot listener:",e.toString()))}Za(){this.muted=!0}Ya(e,t){setTimeout(()=>{this.muted||e(t)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nr{constructor(e){this._byteString=e}static fromBase64String(e){try{return new nr(xe.fromBase64String(e))}catch(t){throw new O(k.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new nr(xe.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xs{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new O(k.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Re(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lh(n){n=Ct(n,je);const e=Ct(n.firestore,cr);return T_(Ps(e),n._key).then(t=>H_(e,n,t))}class Bh extends z_{constructor(e){super(),this.firestore=e}convertBytes(e){return new nr(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new je(this.firestore,null,t)}}function Ns(n){n=Ct(n,rn);const e=Ct(n.firestore,cr),t=Ps(e),r=new Bh(e);return F_(n._query),b_(t,n._query).then(i=>new $_(e,r,n,i))}function Xa(n,e,t){n=Ct(n,je);const r=Ct(n.firestore,cr),i=Qa(n.converter,e,t);return Ja(r,[za(Cs(r),"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,Xe.none())])}function j_(n,e){const t=Ct(n.firestore,cr),r=Hn(n),i=Qa(n.converter,e);return Ja(t,[za(Cs(n.firestore),"addDoc",r._key,i,n.converter!==null,{}).toMutation(r._key,Xe.exists(!1))]).then(()=>r)}function Ja(n,e){return function(r,i){const s=new At;return r.asyncQueue.enqueueAndForget(async()=>h_(await I_(r),i,s)),s.promise}(Ps(n),e)}function H_(n,e,t){const r=t.docs.get(e._key),i=new Bh(n);return new Oh(n,i,e._key,r,new kr(t.hasPendingWrites,t.fromCache),e.converter)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function ds(n){return Ps(n=Ct(n,cr)),new W_(n,e=>Ja(n,e))}(function(e,t=!0){(function(i){sr=i})(rr),Yn(new En("firestore",(r,{instanceIdentifier:i,options:s})=>{const a=r.getProvider("app").getImmediate(),l=new cr(new Hy(r.getProvider("auth-internal")),new Ky(r.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new O(k.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new qr(h.options.projectId,f)}(a,i),a);return s=Object.assign({useFetchStreams:t},s),l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),Kt(Nc,"4.7.3",e),Kt(Nc,"4.7.3","esm2017")})();const Fh={apiKey:"AIzaSyBdbve0H70D-Ch69WlaxEly7PVBFVRB5p0",authDomain:"pensiontools-4b237.firebaseapp.com",projectId:"pensiontools-4b237",storageBucket:"pensiontools-4b237.firebasestorage.app",messagingSenderId:"760877353696",appId:"1:760877353696:web:2d6f7173c8d7fab6fd9e85",measurementId:"G-80XX542QZE"};function ge(){return Fh.apiKey!=="YOUR_API_KEY"}let Eo=null,Je=null,qe=null;try{ge()?(Eo=Nu(Fh),Je=zy(Eo),qe=x_(Eo)):console.warn("Firebase not configured. Login required to save data.")}catch(n){console.error("Firebase initialization error:",n)}const G_=new Et;let qt=null,Br=[];function Y_(){if(!ge()||!Je){console.warn("Firebase not configured - auth disabled");return}xg(Je,n=>{console.log("onAuthStateChanged fired:",n?n.email:"null"),qt=n,console.log("Notifying",Br.length,"listeners"),Br.forEach(e=>e(n))})}function K_(n){return console.log("onAuthStateChange: adding listener, currentUser is:",qt&&qt.email),Br.push(n),qt&&(console.log("onAuthStateChange: immediately calling listener with user"),n(qt)),()=>{Br=Br.filter(e=>e!==n)}}function li(){return qt}function sn(){return qt!==null}async function Q_(n,e,t=null){if(!ge()||!Je)throw new Error("Firebase not configured");const r=await Tg(Je,n,e);return t&&r.user&&await Sg(r.user,{displayName:t}),r}async function X_(n,e){if(!ge()||!Je)throw new Error("Firebase not configured");return bg(Je,n,e)}async function J_(){if(!ge()||!Je)throw new Error("Firebase not configured");console.log("Initiating Google sign-in popup...");try{const n=await Qg(Je,G_);return console.log("Google sign-in successful:",n.user.email),n}catch(n){throw console.error("signInWithPopup error:",n.code,n.message),n}}async function Z_(){if(!ge()||!Je)throw new Error("Firebase not configured");return Cg(Je)}async function eE(n){if(!ge()||!Je)throw new Error("Firebase not configured");return Ig(Je,n)}Y_();function Vs(n,e="settings"){const t=li();return!t||!qe?null:Hn(qe,"users",t.uid,n,e)}function Os(n){const e=li();return!e||!qe?null:P_(qe,"users",e.uid,n)}async function Uh(){if(!ge())return null;const n=Vs("decision");if(!n)return null;try{const e=await Lh(n);return e.exists()?e.data():null}catch(e){return console.error("Error loading decision data:",e),null}}async function tE(n){if(!ge())return;const e=Vs("decision");if(e)try{await Xa(e,{...n,lastModified:new Date().toISOString()},{merge:!0})}catch(t){throw console.error("Error saving decision data:",t),t}}async function Za(n={}){if(!ge())return[];const e=Os("history");if(!e)return[];try{let t=Lr(e,yu("date",n.sortDesc?"desc":"asc"));n.taxYear&&(t=Lr(e,Wa("taxYear","==",n.taxYear),yu("date",n.sortDesc?"desc":"asc"))),n.limit&&(t=Lr(t,U_(n.limit)));const r=await Ns(t),i=[];return r.forEach(s=>{i.push({id:s.id,...s.data()})}),i}catch(t){return console.error("Error loading decision history:",t),[]}}async function nE(n){if(!ge())return null;const e=Os("history");if(!e)return null;try{const t=Lr(e,Wa("date","==",n.date)),r=await Ns(t);if(!r.empty){const s=r.docs[0].id;return await Xa(Hn(qe,"users",li().uid,"history",s),{...n,updatedAt:new Date().toISOString()}),s}return(await j_(e,{...n,createdAt:new Date().toISOString()})).id}catch(t){throw console.error("Error adding history record:",t),t}}async function rE(n){if(!ge())return;const e=Os("history");if(e)try{const t=Lr(e,Wa("date","==",n)),r=await Ns(t),i=ds(qe);r.forEach(s=>{i.delete(s.ref)}),await i.commit()}catch(t){throw console.error("Error deleting history record:",t),t}}async function iE(){if(!ge())return;const n=Os("history");if(n)try{const e=await Ns(n),t=500,r=[];let i=ds(qe),s=0;e.forEach(a=>{i.delete(a.ref),s++,s>=t&&(r.push(i),i=ds(qe),s=0)}),s>0&&r.push(i),await Promise.all(r.map(a=>a.commit()))}catch(e){throw console.error("Error clearing history:",e),e}}async function sE(){if(!ge())return null;const n=Vs("stress");if(!n)return null;try{const e=await Lh(n);return e.exists()?e.data():null}catch(e){return console.error("Error loading stress data:",e),null}}async function zh(n){if(!ge())return;const e=Vs("stress");if(e)try{await Xa(e,{...n,lastModified:new Date().toISOString()},{merge:!0})}catch(t){throw console.error("Error saving stress data:",t),t}}async function oE(){if(!ge())return;const n=li();if(!(!n||!qe))try{await iE();const e=ds(qe);e.delete(Hn(qe,"users",n.uid,"decision","settings")),e.delete(Hn(qe,"users",n.uid,"stress","settings")),e.delete(Hn(qe,"users",n.uid,"profile","settings")),await e.commit(),console.log("All user data wiped successfully")}catch(e){throw console.error("Error wiping user data:",e),e}}async function aE(){if(!ge())return!1;const n=await Uh(),e=await Za({limit:1});return n!==null||e.length>0}let Fe=null,vn=null;const $h=5e3;function Hi(){return{settings:{equityMin:ze.EQUITY_MIN,bondMin:ze.BOND_MIN,cashTarget:ze.CASH_TARGET,duration:ze.DURATION_YEARS,baseSalary:ze.BASE_SALARY,protectionFactor:ze.PROTECTION_FACTOR,recoveryBuffer:ze.RECOVERY_BUFFER,consecutiveLimit:ze.CONSECUTIVE_LIMIT,startDate:null,statePension:12e3,statePensionYear:12},taxYears:{"25/26":{pa:12570,brl:50270,hrl:125140,cpi:.04,other:0}},history:[],lastModified:null,checksum:null}}function ci(){return ge()&&sn()}function lE(){Fe=null,vn=null}function qh(){return Fe&&vn&&Date.now()-vn<$h?Fe:Hi()}async function ur(){if(Fe&&vn&&Date.now()-vn<$h)return Fe;if(!ci())return console.warn("Firebase not available - returning defaults"),Hi();try{const n=await Uh(),e=await Za();if(n){const t={settings:n.settings||Hi().settings,taxYears:n.taxYears||{},history:e||[],lastModified:n.lastModified,checksum:n.checksum};return Fe=t,vn=Date.now(),t}}catch(n){console.error("Error loading from Firebase:",n)}return Hi()}async function el(n){if(!ci())throw new Error("Must be logged in to save data");try{n.lastModified=new Date().toISOString(),n.checksum=cE(n),await tE({settings:n.settings,taxYears:n.taxYears,lastModified:n.lastModified,checksum:n.checksum}),Fe=n,vn=Date.now()}catch(e){throw console.error("Error saving to Firebase:",e),new Error("Failed to save decision data")}}function cE(n){const e={settings:n.settings,taxYears:n.taxYears,historyCount:n.history.length,lastHistoryDate:n.history.length>0?n.history[n.history.length-1].date:null};return Au(e)}async function Ls(){return(await ur()).settings}async function tl(n){const e=await ur();e.settings={...e.settings,...n},await el(e)}function jh(){return{pa:Ke.PERSONAL_ALLOWANCE,brl:Ke.BASIC_RATE_LIMIT,hrl:Ke.HIGHER_RATE_LIMIT,cpi:.04,other:0}}function uE(n){const t=qh().taxYears[n];return t||jh()}async function dE(n){const t=(await ur()).taxYears[n];return t||jh()}async function nl(n,e){const t=await ur();t.taxYears[n]={...uE(n),...e},await el(t)}async function Hh(){return(await ur()).taxYears}function hE(n={}){let t=[...qh().history];return n.taxYear&&(t=t.filter(r=>r.taxYear===n.taxYear)),n.startDate&&(t=t.filter(r=>r.date>=n.startDate)),n.endDate&&(t=t.filter(r=>r.date<=n.endDate)),n.sortDesc?t.sort((r,i)=>i.date.localeCompare(r.date)):t.sort((r,i)=>r.date.localeCompare(i.date)),n.limit&&(t=t.slice(0,n.limit)),t}async function Wh(n={}){if(ci())try{return await Za(n)}catch(e){console.error("Error loading history from Firebase:",e)}return hE(n)}async function fE(n){if(!ci())throw new Error("Must be logged in to save history");if(await nE(n),Fe){const e=Fe.history.findIndex(t=>t.date===n.date);e>=0?Fe.history[e]=n:Fe.history.push(n),Fe.history.sort((t,r)=>t.date.localeCompare(r.date))}}async function pE(n){if(!ci())throw new Error("Must be logged in to delete history");await rE(n),Fe&&(Fe.history=Fe.history.filter(e=>e.date!==n))}async function mE(n){const e=Nf(n);e.stdSipp=n.sippDraw-(n.boostAmount||0),await fE(e)}function rl(n,e,t=0){const r=bu(t);let i=n.equityStart,s=n.bondStart,a=n.cashStart,l=n.hodlEnabled?n.hodlStart!==void 0?n.hodlStart:n.hodlValue:0,u=0,h=null,f=0,g=0,_=0,T=0,P=!1,D=!1,S=null,x=0,C=-1;const M=[],B=[];let G=1,W=.025;M.push({year:0,month:0,equity:i,bond:s,cash:a,hodl:l,total:i+s+a,draw:0,source:"None",inProtection:!1,equityMin:n.equityMin,bondMin:n.bondMin,cashMax:n.cashTarget});for(let E=0;E<n.years*12;E++){const m=Math.floor(E/12),y=E%12,w=y>=3?m:m-1;if(w!==C&&(x=0,C=w),E>0&&E%12===0){const ee=e.inflation[m]||.025;B.push(ee),G*=1+ee}const I=e.equity[m]||0,b=e.inflation[m]||.025,v=Un(n.equityMin,m,n.duration,G,!0),Oe=Un(n.bondMin,m,n.duration,G,!0),He=Un(n.cashTarget,m,n.duration,G,!1),an=yE(n,m,G,B),rt=an;let de=P?an*n.protectionMult:an;P&&(x+=rt-de);const lt=Math.pow(1+I,1/12)-1,We=gE(b,I,W,r)/12,Ze=Math.pow(1+Math.max(.005,b+.012),1/12)-1;if(i*=1+lt,s*=1+We,a*=1+Ze,l>0){const ye=(r()-.5)*2*.06;let _e=0;I<-.1?_e=Math.min(.15,Math.abs(I)*.4):I<-.05&&(_e=Math.abs(I)*.2);let Te=.069+ye+_e;Te=Math.max(-.08,Math.min(.18,Te)),l*=1+Math.pow(1+Te,1/12)-1}W=b;const ne=i+s,Ge=v+Oe;P&&ne>Ge+5e3&&(P=!1,T=0,g=Math.max(g,_),_=0),P&&(f++,_++);let Ue=0;if(!P&&x>0&&ne>Ge+15e3){let ee=y>=3?15-y:3-y;ee<1&&(ee=1);const tt=ne-Ge-15e3,ye=Math.min(x/ee,tt/ee),_e=rt*.5;Ue=Math.min(ye,_e),Ue>50&&(de+=Ue,x-=Ue)}let et="Growth";if(!P&&ne>=Ge+de){const ee=Math.max(0,i-v),tt=Math.max(0,s-Oe),ye=ee+tt;if(ye>0){if(i-=de*ee/ye,s-=de*tt/ye,T=0,et="Growth",a<He){const _e=ne-Ge-de;if(_e>5e3){const Te=Math.min((He-a)*.3,_e*.5);i-=Te*ee/ye,s-=Te*tt/ye,a+=Te}}}else a-=de,et="Cash"}else if(a>=de)a-=de,T++,et="Cash",!n.disableProtection&&T>=n.consecutiveLimit&&(P=!0);else{const ee=de-a;a=0,s>ee?(s-=ee,et="Bond"):i>ee?(i-=ee,et="Equity"):l>ee?(l-=ee,u+=ee,h===null&&(h=E),et="HODL"):(D=!0,S=E)}if(i=Math.max(0,i),s=Math.max(0,s),a=Math.max(0,a),(y===0||E===n.years*12-1||D)&&M.push({year:m+y/12,month:E,equity:i,bond:s,cash:a,hodl:l,total:i+s+a,draw:de,boostAmount:Ue,source:et,inProtection:P,equityMin:v,bondMin:Oe,cashMax:He}),D)break}return g=Math.max(g,_),{failed:D,years:D?S/12:n.years,failMonth:S,final:i+s+a,finalEquity:i,finalBond:s,finalCash:a,finalHodl:l,protMonths:f,maxConsec:g,hodlUsed:u,hodlUsedMonth:h,hist:M,seed:t}}function gE(n,e,t,r){let i=.15,s=.3,a=.2,l=.1,u=.1,h=.15;const f=t!==void 0?t:n,g=f>.045,_=f>.07;if(g){const M=r()>.3?1:.5;_?(i=.15+.35*M,s=.3-.2*M,h=.15-.1*M,l=.1+.05*M):(i=.15+.2*M,s=.3-.1*M,h=.15-.05*M)}g&&r()<.15&&(i=.2,s=.25,h=.12);const T=n+.005+br(0,.03,r),P=.04-(n>.04?(n-.04)*.5:0)+br(0,.05,r),D=.03+n*.3+br(0,.08,r),S=n*.8+br(0,.15,r),x=Math.max(.005,n+.005),C=e*.5+br(0,.02,r);return i*T+s*P+a*D+l*S+u*x+h*C}function yE(n,e,t,r){n.taxMode==="frozen"?n.pa:n.pa*t;const i=n.taxMode==="frozen"?n.brl:n.brl*t,s=n.baseSalary*t;let a=n.other;for(const f of r)a*=1+Math.min(f,.04);const l=e>=n.statePensionYear?n.statePension*t:0,u=a+l;return Math.max(0,Math.min(i,s)-u)/12}function vE(n,e=1e3){const t=Object.keys(Wi).map(Number).sort((i,s)=>i-s),r=[];for(let i=0;i<e;i++){const s=bu(i*12345),a={equity:{},inflation:{}};for(let l=0;l<n.years;l++){const u=t[Math.floor(s()*t.length)];a.equity[l]=Wi[u],a.inflation[l]=Tu[u]||.025}r.push(rl(n,a,i))}return r}function _E(n){const e=Object.keys(Wi).map(Number).sort((i,s)=>i-s),t=Math.max(...e),r=[];for(const i of e){if(i+n.years-1>t)continue;const s={equity:{},inflation:{}};for(let l=0;l<n.years;l++)s.equity[l]=Wi[i+l]||0,s.inflation[l]=Tu[i+l]||.025;const a=rl(n,s,i);a.startYear=i,r.push(a)}return r}function EE(n,e){const t={equity:{},inflation:{}};for(let r=0;r<n.years;r++)t.equity[r]=e.equity[r%e.equity.length],t.inflation[r]=e.inflation[r%e.inflation.length];return rl(n,t,999)}function wE(n){const e=n.filter(t=>t.failed).length;return(n.length-e)/n.length*100}function Gh(n){const e=n.filter(l=>!l.failed),t=n.filter(l=>l.failed),r=n.map(l=>l.years).sort((l,u)=>l-u),i=e.map(l=>l.final).sort((l,u)=>l-u),s=n.map(l=>l.protMonths).sort((l,u)=>l-u),a=(l,u)=>l[Math.floor(l.length*u)]||0;return{total:n.length,successCount:e.length,failCount:t.length,successRate:wE(n),survival:{p5:a(r,.05),p10:a(r,.1),p25:a(r,.25),p50:a(r,.5),p75:a(r,.75),p90:a(r,.9),p95:a(r,.95),min:r[0],max:r[r.length-1]},finalValue:{p5:a(i,.05),p10:a(i,.1),p25:a(i,.25),p50:a(i,.5),p75:a(i,.75),p90:a(i,.9),p95:a(i,.95),min:i[0]||0,max:i[i.length-1]||0,avg:e.reduce((l,u)=>l+u.final,0)/(e.length||1)},minYears:r[0],p10Years:a(r,.1),medianYears:a(r,.5),medianFinal:a(i,.5),p10Final:a(i,.1),p90Final:a(i,.9),avgFinal:e.reduce((l,u)=>l+u.final,0)/(e.length||1),protection:{runsWithProtection:n.filter(l=>l.protMonths>0).length,pctWithProtection:n.filter(l=>l.protMonths>0).length/n.length*100,avgMonths:s.reduce((l,u)=>l+u,0)/n.length,maxMonths:Math.max(...s),maxConsecutive:Math.max(...n.map(l=>l.maxConsec)),avgConsecutive:n.reduce((l,u)=>l+u.maxConsec,0)/n.length,p50Months:a(s,.5),p90Months:a(s,.9),p95Months:a(s,.95)},runsWithProtection:n.filter(l=>l.protMonths>0).length,avgProtMonths:s.reduce((l,u)=>l+u,0)/n.length,maxProtMonths:Math.max(...s),maxConsecutive:Math.max(...n.map(l=>l.maxConsec)),avgConsecutive:n.reduce((l,u)=>l+u.maxConsec,0)/n.length,hodl:{runsUsingHodl:n.filter(l=>l.hodlUsed>0).length,pctUsingHodl:n.filter(l=>l.hodlUsed>0).length/n.length*100,avgUsed:n.filter(l=>l.hodlUsed>0).length>0?n.filter(l=>l.hodlUsed>0).reduce((l,u)=>l+u.hodlUsed,0)/n.filter(l=>l.hodlUsed>0).length:0,maxUsed:Math.max(...n.map(l=>l.hodlUsed||0))},runsUsingHodl:n.filter(l=>l.hodlUsed>0).length,avgHodlUsed:n.filter(l=>l.hodlUsed>0).length>0?n.filter(l=>l.hodlUsed>0).reduce((l,u)=>l+u.hodlUsed,0)/n.filter(l=>l.hodlUsed>0).length:0,maxHodlUsed:Math.max(...n.map(l=>l.hodlUsed||0)),failures:t.map(l=>({seed:l.seed,startYear:l.startYear,years:l.years,failMonth:l.failMonth,protMonths:l.protMonths}))}}let Wt=null,_n=null;const Yh=5e3;function Wn(){return{settings:{equityMin:ze.EQUITY_MIN,bondMin:ze.BOND_MIN,cashTarget:ze.CASH_TARGET,duration:ze.DURATION_YEARS,baseSalary:ze.BASE_SALARY,other:0,statePension:12e3,statePensionYear:12,pa:Ke.PERSONAL_ALLOWANCE,brl:Ke.BASIC_RATE_LIMIT,hrl:Ke.HIGHER_RATE_LIMIT,taxMode:"inflates",protectionMult:oo.PROTECTION_MULTIPLIER,consecutiveLimit:ze.CONSECUTIVE_LIMIT,disableProtection:!1,hodlEnabled:oo.HODL_ENABLED,hodlValue:oo.HODL_VALUE},lastModified:null,checksum:null}}function il(){return ge()&&sn()}function IE(){Wt=null,_n=null}function TE(){return Wt&&_n&&Date.now()-_n<Yh?Wt:Wn()}async function Kh(){if(Wt&&_n&&Date.now()-_n<Yh)return Wt;if(!il())return console.warn("Firebase not available - returning defaults"),Wn();try{const n=await sE();if(n){const e={settings:n.settings||Wn().settings,lastModified:n.lastModified,checksum:n.checksum};return Wt=SE(e),_n=Date.now(),Wt}}catch(n){console.error("Error loading stress data from Firebase:",n)}return Wn()}async function bE(n){if(!il())throw new Error("Must be logged in to save data");try{n.lastModified=new Date().toISOString(),n.checksum=AE(n),await zh({settings:n.settings,lastModified:n.lastModified,checksum:n.checksum}),Wt=n,_n=Date.now()}catch(e){throw console.error("Error saving stress data to Firebase:",e),new Error("Failed to save stress data")}}function AE(n){return Au(n.settings)}function SE(n){const e={...Wn()};return n.settings&&(e.settings={...e.settings,...n.settings},n.settings.pacwMin!==void 0&&n.settings.equityMin===void 0&&(e.settings.equityMin=n.settings.pacwMin),n.settings.cgtMin!==void 0&&n.settings.bondMin===void 0&&(e.settings.bondMin=n.settings.cgtMin),n.settings.csh2Target!==void 0&&n.settings.cashTarget===void 0&&(e.settings.cashTarget=n.settings.csh2Target),e.settings.hodlEnabled===void 0&&(e.settings.hodlEnabled=!1),e.settings.hodlValue===void 0&&(e.settings.hodlValue=25e3)),e.lastModified=n.lastModified,e.checksum=n.checksum,e}function RE(){return TE().settings}async function on(){return(await Kh()).settings}async function sl(n){const e=await Kh();e.settings={...e.settings,...n},await bE(e)}async function PE(){if(!il())throw new Error("Must be logged in to reset settings");const n=Wn();await zh({settings:n.settings,lastModified:new Date().toISOString()}),IE()}function ol(n={},e=null){const t=e||RE();return{equityStart:n.equityStart??t.equityMin,bondStart:n.bondStart??t.bondMin,cashStart:n.cashStart??t.cashTarget,equityMin:t.equityMin,bondMin:t.bondMin,cashTarget:t.cashTarget,years:n.years??t.duration,duration:t.duration,baseSalary:t.baseSalary,other:t.other,statePension:t.statePension,statePensionYear:t.statePensionYear,pa:t.pa,brl:t.brl,hrl:t.hrl,taxMode:t.taxMode,protectionMult:t.protectionMult,consecutiveLimit:t.consecutiveLimit,disableProtection:t.disableProtection,hodlEnabled:t.hodlEnabled,hodlValue:t.hodlValue}}function F(n,e=null){const t=Math.abs(n),r=e!==null?e:t<100,i=Math.abs(n).toLocaleString("en-GB",{minimumFractionDigits:r?2:0,maximumFractionDigits:r?2:0});return n<0?`-£${i}`:`£${i}`}function xE(n,e){const t=CE(n);e.innerHTML=t}function CE(n){const e=n,t=e.calculationDetails||{};let r="";const i=e.taxEfficient?"success":"warning",s=e.taxEfficient?"Tax-Efficient Mode":"Standard Mode",a=e.taxEfficient?"✓":"!";if(r+=`<div class="decision-mode ${i}">
  ...
  `}function Fs(){const e=getComputedStyle(document.documentElement).getPropertyValue("--bg").trim()==="#0d1117"||document.documentElement.classList.contains("dark")||window.matchMedia("(prefers-color-scheme: dark)").matches;return{primary:"#6366f1",success:"#22c55e",warning:"#f59e0b",danger:"#ef4444",muted:e?"#8b949e":"#6b7280",grid:e?"#30363d":"#e5e7eb",bg:e?"#161b22":"#ffffff",text:e?"#c9d1d9":"#1f2937",cardBg:e?"#21262d":"#ffffff",cone:e?"rgba(99, 102, 241, 0.25)":"rgba(99, 102, 241, 0.15)",coneBorder:"rgba(99, 102, 241, 0.4)",trajectory:e?"rgba(99, 102, 241, 0.4)":"rgba(99, 102, 241, 0.3)",trajectoryFailed:e?"rgba(239, 68, 68, 0.5)":"rgba(239, 68, 68, 0.4)",trajectoryHover:"#6366f1",trajectoryFailedHover:"#ef4444"}}const Yr=new Map;function ZE(n,e,t={}){const r=Fs(),i=n.getContext("2d"),{width:s,height:a}=n,l={top:50,right:30,bottom:60,left:80},u=s-l.left-l.right,h=a-l.top-l.bottom;i.fillStyle=r.bg,i.fillRect(0,0,s,a);const f=t.years||35,g={};for(let x=0;x<=f;x++)g[x]=[];e.forEach(x=>{x.hist.forEach(C=>{const M=Math.floor(C.year);g[M]!==void 0&&g[M].push(C.total)})});const _=[];for(let x=0;x<=f;x++){const C=g[x].sort((B,G)=>B-G);if(C.length===0)continue;const M=B=>C[Math.floor(C.length*B)]||0;_.push({year:x,p5:M(.05),p10:M(.1),p25:M(.25),p50:M(.5),p75:M(.75),p90:M(.9),p95:M(.95)})}if(_.length===0)return;const T=Math.max(..._.map(x=>x.p95))*1.1,P=x=>l.left+x/f*u,D=x=>l.top+h-x/T*h;Us(i,l,u,h,f,T,t.title||"Cone of Uncertainty",r),[{upper:"p95",lower:"p5",color:r.cone},{upper:"p90",lower:"p10",color:r.cone.replace("0.25","0.35").replace("0.15","0.25")},{upper:"p75",lower:"p25",color:r.cone.replace("0.25","0.45").replace("0.15","0.35")}].forEach(x=>{i.beginPath(),i.fillStyle=x.color,_.forEach((C,M)=>{const B=P(C.year),G=D(C[x.upper]);M===0?i.moveTo(B,G):i.lineTo(B,G)});for(let C=_.length-1;C>=0;C--){const M=_[C];i.lineTo(P(M.year),D(M[x.lower]))}i.closePath(),i.fill()}),i.beginPath(),i.strokeStyle=r.primary,i.lineWidth=3,_.forEach((x,C)=>{const M=P(x.year),B=D(x.p50);C===0?i.moveTo(M,B):i.lineTo(M,B)}),i.stroke(),rw(i,s-l.right-160,l.top+10,r),Yr.set(n.id,{percentiles:_,xScale:P,yScale:D,padding:l,chartWidth:u,chartHeight:h,years:f,maxValue:T,type:"cone"}),iw(n)}function ew(n,e,t={}){const r=Fs(),i=n.getContext("2d"),{width:s,height:a}=n,l={top:50,right:30,bottom:60,left:80},u=s-l.left-l.right,h=a-l.top-l.bottom;i.fillStyle=r.bg,i.fillRect(0,0,s,a);const f=t.years||35,g=5e6,_=g,T=S=>l.left+S/f*u,P=S=>l.top+h-Math.min(S,g)/_*h;Us(i,l,u,h,f,_,t.title||"Sample Trajectories",r);const D=e.slice(0,100);D.filter(S=>S.failed).forEach(S=>{i.beginPath(),i.strokeStyle=r.trajectoryFailed,i.lineWidth=1.5,S.hist.forEach((x,C)=>{const M=T(x.year),B=P(x.total);C===0?i.moveTo(M,B):i.lineTo(M,B)}),i.stroke()}),D.filter(S=>!S.failed).forEach(S=>{i.beginPath(),i.strokeStyle=r.trajectory,i.lineWidth=1.5,S.hist.forEach((x,C)=>{const M=T(x.year),B=P(x.total);C===0?i.moveTo(M,B):i.lineTo(M,B)}),i.stroke()}),i.font="12px system-ui, sans-serif",i.fillStyle=r.trajectory.replace("0.4","1").replace("0.3","1"),i.fillRect(s-l.right-130,l.top+10,20,4),i.fillStyle=r.text,i.textAlign="left",i.fillText("Successful",s-l.right-105,l.top+16),i.fillStyle=r.trajectoryFailed.replace("0.5","1").replace("0.4","1"),i.fillRect(s-l.right-130,l.top+30,20,4),i.fillStyle=r.text,i.fillText("Failed",s-l.right-105,l.top+36),Yr.set(n.id,{results:D,xScale:T,yScale:P,padding:l,chartWidth:u,chartHeight:h,years:f,maxValue:_,type:"trajectory"}),sw(n,r)}function tw(n,e,t={}){const r=Fs(),i=n.getContext("2d"),{width:s,height:a}=n,l={top:50,right:30,bottom:60,left:60},u=s-l.left-l.right,h=a-l.top-l.bottom;i.fillStyle=r.bg,i.fillRect(0,0,s,a);const f=e.map(C=>C.protMonths),g=Math.max(...f),_=Math.max(1,Math.ceil(g/20)),T={};for(let C=0;C<=g;C+=_)T[C]=0;f.forEach(C=>{const M=Math.floor(C/_)*_;T[M]=(T[M]||0)+1});const P=Object.keys(T).map(Number).sort((C,M)=>C-M),D=Math.max(...Object.values(T));i.font="bold 14px system-ui, sans-serif",i.fillStyle=r.text,i.textAlign="center",i.fillText(t.title||"Protection Months Distribution",s/2,l.top-20),i.strokeStyle=r.grid,i.lineWidth=1,i.beginPath(),i.moveTo(l.left,l.top),i.lineTo(l.left,l.top+h),i.lineTo(l.left+u,l.top+h),i.stroke();const S=u/P.length*.8,x=u/P.length*.2;P.forEach((C,M)=>{const G=T[C]/D*h,W=l.left+M*(S+x)+x/2,E=l.top+h-G,m=C/g;C===0?i.fillStyle=r.success:m<.3?i.fillStyle=r.warning:i.fillStyle=r.danger,i.fillRect(W,E,S,G),(M%3===0||M===P.length-1)&&(i.font="10px system-ui, sans-serif",i.fillStyle=r.muted,i.textAlign="center",i.fillText(C.toString(),W+S/2,l.top+h+15))}),i.textAlign="right",i.fillStyle=r.muted;for(let C=0;C<=4;C++){const M=Math.round(D*C/4),B=l.top+h-h*C/4;i.fillText(M.toString(),l.left-10,B+4)}i.font="12px system-ui, sans-serif",i.textAlign="center",i.fillText("Protection Months",s/2,a-10),i.save(),i.translate(15,a/2),i.rotate(-Math.PI/2),i.fillText("Number of Runs",0,0),i.restore()}function nw(n,e,t={}){const r=Fs(),i=n.getContext("2d"),{width:s,height:a}=n,l={top:50,right:180,bottom:60,left:80},u=s-l.left-l.right,h=a-l.top-l.bottom;i.fillStyle=r.bg,i.fillRect(0,0,s,a);const f=Object.keys(e),g=t.years||35;let _=0;f.forEach(S=>{const x=e[S].result;x&&x.hist&&x.hist.forEach(C=>{C.total>_&&(_=C.total)})}),_*=1.1;const T=S=>l.left+S/g*u,P=S=>l.top+h-S/_*h;Us(i,l,u,h,g,_,t.title||"Scenario Comparison",r);const D=["#6366f1","#22c55e","#f59e0b","#ef4444","#8b5cf6","#06b6d4","#ec4899","#84cc16"];f.forEach((S,x)=>{const C=e[S].result;if(!C||!C.hist)return;i.beginPath(),i.strokeStyle=D[x%D.length],i.lineWidth=2.5,C.hist.forEach((G,W)=>{const E=T(G.year),m=P(G.total);W===0?i.moveTo(E,m):i.lineTo(E,m)}),i.stroke();const M=l.top+15+x*24;i.fillStyle=D[x%D.length],i.fillRect(s-l.right+15,M,20,4),i.font="11px system-ui, sans-serif",i.fillStyle=r.text,i.textAlign="left",i.fillText(e[S].name||S,s-l.right+40,M+5);const B=C.final/1e3;i.fillStyle=r.muted,i.fillText(`£${B.toFixed(0)}k`,s-l.right+40,M+18)})}function Us(n,e,t,r,i,s,a,l){n.font="bold 14px system-ui, sans-serif",n.fillStyle=l.text,n.textAlign="center",n.fillText(a,e.left+t/2,e.top-20),n.strokeStyle=l.grid,n.lineWidth=1;for(let u=0;u<=5;u++){const h=e.top+r*u/5;n.beginPath(),n.moveTo(e.left,h),n.lineTo(e.left+t,h),n.stroke();const f=s*(5-u)/5;n.font="11px system-ui, sans-serif",n.fillStyle=l.muted,n.textAlign="right",n.fillText(jt(f),e.left-10,h+4)}for(let u=0;u<=i;u+=5){const h=e.left+u/i*t;n.beginPath(),n.moveTo(h,e.top),n.lineTo(h,e.top+r),n.stroke(),n.textAlign="center",n.fillText(`Y${u}`,h,e.top+r+20)}n.font="12px system-ui, sans-serif",n.textAlign="center",n.fillText("Years",e.left+t/2,e.top+r+45),n.save(),n.translate(20,e.top+r/2),n.rotate(-Math.PI/2),n.fillText("Fund Value",0,0),n.restore()}function rw(n,e,t,r){const i=[{label:"Median (50th)",color:r.primary,type:"line"},{label:"25th-75th %ile",color:r.cone.replace("0.25","0.45").replace("0.15","0.35"),type:"band"},{label:"10th-90th %ile",color:r.cone.replace("0.25","0.35").replace("0.15","0.25"),type:"band"},{label:"5th-95th %ile",color:r.cone,type:"band"}];n.font="11px system-ui, sans-serif",i.forEach((s,a)=>{const l=t+a*20;s.type==="line"?(n.strokeStyle=s.color,n.lineWidth=3,n.beginPath(),n.moveTo(e,l),n.lineTo(e+25,l),n.stroke()):(n.fillStyle=s.color,n.fillRect(e,l-7,25,14)),n.fillStyle=r.text,n.textAlign="left",n.fillText(s.label,e+30,l+4)})}function jt(n){return n>=1e6?`£${(n/1e6).toFixed(1)}M`:n>=1e3?`£${(n/1e3).toFixed(0)}k`:`£${n.toFixed(0)}`}function iw(n,e){const t=n._coneHoverListener;t&&n.removeEventListener("mousemove",t);const r=i=>{const s=Yr.get(n.id);if(!s||s.type!=="cone")return;const a=n.getBoundingClientRect(),l=n.width/a.width,u=(i.clientX-a.left)*l;(i.clientY-a.top)*l;const{percentiles:h,xScale:f,yScale:g,padding:_,chartWidth:T,years:P}=s,D=(u-_.left)/T*P,S=Math.round(D);if(S<0||S>P){Gn();return}const x=h.find(C=>C.year===S);if(!x){Gn();return}ef(i.clientX,i.clientY,`
      ...
      25th: ${jt(x.p25)}<br>
      5th: ${jt(x.p5)}
    `)};n._coneHoverListener=r,n.addEventListener("mousemove",r),n.addEventListener("mouseleave",Gn)}function sw(n,e){const t=n._trajHoverListener;t&&n.removeEventListener("mousemove",t);const r=i=>{const s=Yr.get(n.id);if(!s||s.type!=="trajectory")return;const a=n.getBoundingClientRect(),l=n.width/a.width,u=n.height/a.height,h=(i.clientX-a.left)*l,f=(i.clientY-a.top)*u,{results:g,xScale:_,yScale:T,padding:P,chartWidth:D,chartHeight:S}=s;if(h<P.left||h>P.left+D||f<P.top||f>P.top+S){Gn(),Vi(n,s,e,null);return}let x=null,C=1/0;if(g.forEach(M=>{M.hist.forEach(B=>{const G=_(B.year),W=T(B.total),E=Math.sqrt(Math.pow(h-G,2)+Math.pow(f-W,2));E<C&&E<30&&(C=E,x=M)})}),x){const M=x.failed?"FAILED":"Survived",B=x.failed?"#ef4444":"#22c55e";ef(i.clientX,i.clientY,`
        <strong style="color: ${B}">${M}</strong><br>
        Years: ${x.years.toFixed(1)}<br>
        Final Value: ${jt(x.final)}<br>
        Protection Months: ${x.protMonths}<br>
        Max Consecutive: ${x.maxConsec}<br>
        ${x.hodlUsed>0?`HODL Used: ${jt(x.hodlUsed)}`:""}
        ${x.startYear?`<br>Start Year: ${x.startYear}`:""}
      `),Vi(n,s,e,x)}else Gn(),Vi(n,s,e,null)};n._trajHoverListener=r,n.addEventListener("mousemove",r),n.addEventListener("mouseleave",()=>{Gn();const i=Yr.get(n.id);i&&Vi(n,i,e,null)})}function Vi(n,e,t,r){const i=n.getContext("2d"),{width:s,height:a}=n,l={top:50,right:30,bottom:60,left:80},u=s-l.left-l.right,h=a-l.top-l.bottom;i.fillStyle=t.bg,i.fillRect(0,0,s,a),Us(i,l,u,h,e.years,e.maxValue,"Sample Trajectories",t);const{results:f,xScale:g,yScale:_}=e;f.forEach(T=>{T!==r&&(i.beginPath(),i.strokeStyle=T.failed?t.trajectoryFailed:t.trajectory,i.lineWidth=1.5,T.hist.forEach((P,D)=>{const S=g(P.year),x=_(P.total);D===0?i.moveTo(S,x):i.lineTo(S,x)}),i.stroke())}),r&&(i.beginPath(),i.strokeStyle=r.failed?t.trajectoryFailedHover:t.trajectoryHover,i.lineWidth=4,r.hist.forEach((T,P)=>{const D=g(T.year),S=_(T.total);P===0?i.moveTo(D,S):i.lineTo(D,S)}),i.stroke(),i.fillStyle=r.failed?t.trajectoryFailedHover:t.trajectoryHover,r.hist.forEach(T=>{const P=g(T.year),D=_(T.total);i.beginPath(),i.arc(P,D,4,0,Math.PI*2),i.fill()})),i.font="12px system-ui, sans-serif",i.fillStyle=t.trajectory.replace("0.4","1").replace("0.3","1"),i.fillRect(s-l.right-130,l.top+10,20,4),i.fillStyle=t.text,i.textAlign="left",i.fillText("Successful",s-l.right-105,l.top+16),i.fillStyle=t.trajectoryFailed.replace("0.5","1").replace("0.4","1"),i.fillRect(s-l.right-130,l.top+30,20,4),i.fillStyle=t.text,i.fillText("Failed",s-l.right-105,l.top+36)}function ef(n,e,t){let r=document.getElementById("chartTooltip");r||(r=document.createElement("div"),r.id="chartTooltip",document.body.appendChild(r)),r.innerHTML=t,r.style.display="block",r.style.left=n+15+"px",r.style.top=e+15+"px"}function Gn(){const n=document.getElementById("chartTooltip");n&&(n.style.display="none")}function ow(){return`
    .chart-container {
      background: var(--card);
      border: 1px solid var(--border);
      border-radius: 8px;
...
• `));return}try{hs=await pw(e,t,r,i);const a=document.getElementById("decisionOutput");xE(hs,a),document.getElementById("saveBtn").disabled=!1}catch(a){console.error("Decision error:",a),alert("Error calculating decision: "+a.message)}};window.saveCurrentDecision=async function(){if(!hs){alert("No decision to save");return}if(!sn()){alert("Please sign in to save decisions");return}try{await mE(hs),alert("Decision saved to history"),document.getElementById("saveBtn").disabled=!0,await $s()}catch(n){console.error("Save error:",n),alert("Error saving: "+n.message)}};window.runMonteCarloUI=async function(){const n={equityStart:parseFloat(document.getElementById("mcEquity").value)||25e4,bondStart:parseFloat(document.getElementById("mcBond").value)||2e5,cashStart:parseFloat(document.getElementById("mcCash").value)||5e4,years:parseInt(document.getElementById("mcYears").value)||35};document.getElementById("mcResults").innerHTML='<div class="loading"><div class="spinner"></div>Running simulation...</div>',await on(),setTimeout(()=>{try{const{results:e,stats:t}=Qh(n);aw=e,of(t,e,"Monte Carlo (1000 runs)","mcResults",n.years)}catch(e){console.error("Simulation error:",e),document.getElementById("mcResults").innerHTML=`<div class="alert alert-danger">Error: ${e.message}</div>`}},50)};window.runHistoricalUI=async function(){const n={equityStart:parseFloat(document.getElementById("histEquity").value)||25e4,bondStart:parseFloat(document.getElementById("histBond").value)||2e5,cashStart:parseFloat(document.getElementById("histCash").value)||5e4,years:parseInt(document.getElementById("histYears").value)||35};document.getElementById("histResults").innerHTML='<div class="loading"><div class="spinner"></div>Running simulation...</div>',await on(),setTimeout(()=>{try{const{results:e,stats:t}=Xh(n);lw=e,of(t,e,"Historical Analysis","histResults",n.years)}catch(e){console.error("Simulation error:",e),document.getElementById("histResults").innerHTML=`<div class="alert alert-danger">Error: ${e.message}</div>`}},50)};window.runScenariosUI=async function(){const n={equityStart:parseFloat(document.getElementById("scenEquity").value)||25e4,bondStart:parseFloat(document.getElementById("scenBond").value)||2e5,cashStart:parseFloat(document.getElementById("scenCash").value)||5e4,years:35};document.getElementById("scenResults").innerHTML='<div class="loading"><div class="spinner"></div>Running scenarios...</div>',await on(),setTimeout(()=>{try{const e=ME(n);vw(e,"scenResults")}catch(e){console.error("Scenario error:",e),document.getElementById("scenResults").innerHTML=`<div class="alert alert-danger">Error: ${e.message}</div>`}},50)};let Ao=!1;window.runOptimisationUI=async function(n){if(Ao)return;Ao=!0;const e=document.getElementById("optimiseBtn"+n),t=document.getElementById("optimiseResults"+n);e&&(e.disabled=!0),e&&(e.textContent="Optimising...");let r,i,s,a;n==="MC"?(r=document.getElementById("mcEquity"),i=document.getElementById("mcBond"),s=document.getElementById("mcCash"),a=document.getElementById("mcYears")):(r=document.getElementById("histEquity"),i=document.getElementById("histBond"),s=document.getElementById("histCash"),a=document.getElementById("histYears"));const l=+r.value,u=+i.value,h=+s.value,f=+a.value,g=l+u+h;t.innerHTML='<div class="loading"><div class="spinner"></div>Testing allocations...</div>';const _=await on();setTimeout(()=>{try{const T=[];for(let x=5;x<=30;x+=5)for(let C=20;C<=95-x;C+=5){const M=100-x-C;M>=0&&T.push({equity:Math.round(g*C/100),bond:Math.round(g*M/100),cash:Math.round(g*x/100)})}const P=x=>{const C={equityStart:x.equity,bondStart:x.bond,cashStart:x.cash,years:f};let M;return n==="MC"?M=Qh(C,_):M=Xh(C,_),{...x,rate:M.stats.successRate,avgProt:M.stats.avgProtMonths,medianFinal:M.stats.medianFinal}},D=P({equity:l,bond:u,cash:h});let S=null;T.forEach(x=>{const C=P(x);C.avgProt<=D.avgProt&&(!S||C.rate>S.rate)&&(S=C)}),mw(n,D,S,g,T.length,t)}catch(T){console.error("Optimisation error:",T),t.innerHTML=`<div class="alert alert-danger">Error: ${T.message}</div>`}finally{Ao=!1,e&&(e.disabled=!1,e.textContent="Optimise Allocation")}},50)};function mw(n,e,t,r,i,s){let a="";if(t&&t.rate>e.rate){const l=t.medianFinal-e.medianFinal,u=e.medianFinal>0?l/e.medianFinal*100:0;a=`
      ...
      </p>`,n.innerHTML=l}window.updateTaxYear=async function(n,e,t){try{const r=await dE(n);r[e]=parseFloat(t),await nl(n,r)}catch(r){console.error("Error updating tax year:",r),alert("Error saving: "+r.message)}};window.deleteTaxYear=async function(n){if(confirm("Delete tax year "+n+"?"))try{const e=await ur();delete e.taxYears[n],await el(e),await qs()}catch(e){console.error("Error deleting tax year:",e),alert("Error deleting: "+e.message)}};window.addTaxYear=async function(){if(!sn()){alert("Please sign in to add tax years");return}const n=prompt("Enter tax year (e.g., 25/26):");if(!n||!/^\d{2}\/\d{2}$/.test(n)){alert("Invalid format. Use YY/YY (e.g., 25/26)");return}try{await nl(n,{}),await qs()}catch(e){console.error("Save error:",e),alert("Error saving: "+e.message)}};console.log("Pension Planner v"+wu+" loaded");
